  ...
  try {
    ...
    for (let name in global.plugins) {
      ...
      if (isAcc) {
        ...
        if (plugin.rowner && !(isROwner || isOwner) && (fail("owner", m, this), true) || plugin.rowner && !isROwner && (fail("rowner", m, this), true) || plugin.owner && !isOwner && (fail("owner", m, this), true) || plugin.mods && !isMods && (fail("mods", m, this), true) || plugin.premium && !isPrems && (fail("premium", m, this), true) || plugin.group && !m.isGroup && (fail("group", m, this), true) || plugin.botAdmin && !isBotAdmin && (fail("botAdmin", m, this), true) || plugin.admin && !isAdmin && (fail("admin", m, this), true) || plugin.private && m.isGroup && (fail("private", m, this), true) || plugin.register && !_user.registered && (fail("unreg", m, this), true) || plugin.nsfw && db.data?.chats[m.chat]?.nsfw && (fail("nsfw", m, this), true) || global.plugins[name]?.error && (fail("error", m, this), true) || opts["antirpg"] && db.data?.settings[this.user.jid]?.antirpg && plugin.tags && plugin.tags?.includes("rpg") && (fail("rpg", m, this), true) || opts["restrict"] && db.data
          ?.settings[this.user.jid]?.restrict && plugin.tags && plugin.tags?.includes("admin") && (fail("restrict", m, this), true)) return false;
        m.isCommand = true;
