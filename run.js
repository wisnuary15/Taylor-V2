...
const displayWelcomeMessage = () => {
  ...
  process.stdout.write(
    `${cyanColor}   ${greenColor}Welcome to Taylor-V2 Terminal${cyanColor}                                \n`);
  process.stdout.write(`${cyanColor}╰───────────────────────────────────────────────────────╯\n${resetColor}`);
};
const displayTable = () => {
  const cyanColor = '\x1b[36m';
  ...
  process.stdout.write(`${cyanColor}───────────────────────────────────────────────────────\n`);
  process.stdout.write(
    `${cyanColor}   ${redColor}Informasi Terminal yang Berjalan${cyanColor}                         \n`);
  process.stdout.write(`${cyanColor}╰───────────────────────────────────────────────────────╯\n${resetColor}`);
};
const startBash = () => {
  ...
  bashProcess.on('exit', () => {
    ...
    process.stdout.write(`${cyanColor}───────────────────────────────────────────────────────\n`);
    process.stdout.write(
      `${cyanColor}   ${redColor}Informasi Terminal telah Ditutup${cyanColor}                             \n`);
    process.stdout.write(`${cyanColor}╰───────────────────────────────────────────────────────╯\n${resetColor}`);
  });
};
