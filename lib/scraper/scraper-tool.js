...
async function tanggal_pernikahan(tgl, bln, thn) {
  return new Promise(((resolve, reject) => {
    axios.get("https://primbon.com/tanggal_jadian_pernikahan.php?tgl=" + tgl + "&bln=" + bln + "&thn=" + thn + "&proses=+Submit%21+").then((({ data: data }) => {
      let hasil, fetchText = cheerio.load(data)("#body").text();
      try {
        hasil = {
          status: !0,
...
async function kecocokan(nama1, nama2) {
  return new Promise(((resolve, reject) => {
    axios.get("https://primbon.com/kecocokan_nama_pasangan.php?nama1=" + nama1 + "&nama2=" + nama2 + "&proses=+Submit%21+").then((({ data: data }) => {
      let hasil, fetchText = cheerio.load(data)("#body").text();
      try {
        hasil = {
          status: !0,
...
async function tafsir_mimpi(value) {
  return new Promise(((resolve, reject) => {
    axios.get("https://primbon.com/tafsir_mimpi.php?mimpi=" + value + "&submit=+Submit+").then((({ data: data }) => {
      let hasil, fetchText = cheerio.load(data)("#body").text();
      try {
        hasil = {
          status: !0,
...
async function artinama(value) {
  return new Promise(((resolve, reject) => {
    axios.get("https://primbon.com/arti_nama.php?nama1=" + value + "&proses=+Submit%21+").then((({ data: data }) => {
      let hasil, fetchText = cheerio.load(data)("#body").text();
      try {
        hasil = {
          status: !0,
...
export { artinama, tiktok, cariresep, detailresep, ttslide, wiki, cerpen, stalkff, stalkml, soundcloud, nhentai, remini, tafsir_mimpi, kecocokan, tanggal_pernikahan, rejeki_hoki_weton, sifat_usaha_bisnis };