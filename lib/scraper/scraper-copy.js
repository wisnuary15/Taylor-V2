...
function quotesAnime() {
  return new Promise(((resolve, reject) => {
    ...
    axios.get("https://otakotaku.com/quote/feed/" + page).then((({ data: data }) => {
      const $ = cheerio.load(data),
        hasil = [];
...
function nhentaisearch(query) {
  return new Promise(((resolve, reject) => {
    axios.get(`https://nhentai.to/search?q=${query}`).then((({ data: data }) => {
      const $ = cheerio.load(data),
        hasil = [];
...
function doujindesusearch(query) {
  return new Promise(((resolve, reject) => {
    axios.get(`https://212.32.226.234/?s=${query}`).then((({ data: data }) => {
      const $ = cheerio.load(data),
        hasil = [];
...
function doujindesulatest() {
  return new Promise(((resolve, reject) => {
    axios.get("https://212.32.226.234").then((({ data: data }) => {
      const $ = cheerio.load(data),
        hasil = [];
      $("#archives > div > article").each((function(a, b) {
        result = {
...
function playstore(query) {
  return new Promise(((resolve, reject) => {
    axios.get(`https://play.google.com/store/search?q=${query}&c=apps`).then((({ data: data }) => {
      const $ = cheerio.load(data),
        hasil = [];
...
function sektekomiksearch(query) {
  return new Promise(((resolve, reject) => {
    axios.get(`https://sektekomik.xyz/manga?search=${query}`).then((({ data: data }) => {
      const $ = cheerio.load(data),
        hasil = [];
...
function nekopoisearch(query) {
  return new Promise(((resolve, reject) => {
    axios.get(`https://nekopoi.care/search/${query}`).then((({ data: data }) => {
      const $ = cheerio.load(data),
        hasil = [];
...
function kusonimelatest() {
  return new Promise(((resolve, reject) => {
    axios.get("https://kusonime.com").then((({ data: data }) => {
      const $ = cheerio.load(data),
        hasil = [];
...
function nekopoilatest() {
  return new Promise(((resolve, reject) => {
    axios.get("https://nekopoi.care").then((({ data: data }) => {
      const $ = cheerio.load(data),
        hasil = [];
...
function mangatoons(query) {
  return new Promise(((resolve, reject) => {
    axios.get(`https://mangatoon.mobi/en/search?word=${query}`).then((({ data: data }) => {
      const $ = cheerio.load(data),
        hasil = [];
...
function webtoons(query) {
  return new Promise(((resolve, reject) => {
    axios.get(`https://www.webtoons.com/id/search?keyword=${query}`).then((({ data: data }) => {
      const $ = cheerio.load(data),
        hasil = [];
...
function otakudesu(query) {
  return new Promise(((resolve, reject) => {
    axios.get(`https://otakudesu.video=/?s=${query}&post_type=anime`).then((({ data: data }) => {
      const hasil = [],
        $ = cheerio.load(data);
...
function ttdown(url) {
  try {
    ...
    const param = {
      ...
      { data: data } = axios.request("https://downvideo.quora-wiki.com/system/action.php", {
        method: "post",
...
function otakudesuongoing() {
  return new Promise(((resolve, reject) => {
    axios.get("https://otakudesu.bid").then((({ data: data }) => {
      const hasil = [],
        $ = cheerio.load(data);
...
function komikindosearch(query) {
  return new Promise(((resolve, reject) => {
    axios.get(`https://komikindo.id/?s=${query}`).then((({ data: data }) => {
      const $ = cheerio.load(data),
        hasil = [];
...
function pin(url) {
  return new Promise(((resolve, reject) => {
    ...
    params.append("url", url), fetch("https://www.expertsphp.com/facebook-video-downloader.php", {
      ...
      const $ = cheerio.load(res);
      if (y = `pinterest_${Math.floor(1e6 * Math.random())}.mp4`, x = $("video").find("source").attr("src"),
        data = {
          file: y,
          url: x
...
export { facebook, nkpepsddl, komikindogetch, komikindosearch, otakudesugetepsddl, dojindsgetimg, nhgetimg, nhentai, nhentaisearch, kusonimelatest, kusonimeinfo, otakudesuongoing, otakudesuinfo, sektekomiksearch, nekopoisearch, nekopoi, nekopoilatest, porno, doujindesuch, doujindesu, doujindesusearch, mangatoons, webtoons, ssweb, ssweb2, otakudesu, gore, hentai, quotes, doujindesulatest, quotesAnime, igdl, textpro, igstory, tiktok, ttdown, twitter, joox, pin };