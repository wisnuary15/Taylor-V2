...
async function sjoox(query) {
  return new Promise(((resolve, reject) => {
    ...
    axios.get("http://api.joox.com/web-fcgi-bin//web_search?lang=id&country=id&type=0&search_input=" + query + "&pn=1&sin=0&ein=29&_=" + time).then((({ data: data }) => {
      let hasil = [],
        promoses = [],
        ids = [];
...
async function srexdl(query) {
  return new Promise((resolve => {
    axios.get("https://rexdl.com/?s=" + query).then((({ data: data }) => {
      const $ = cheerio.load(data),
        judul = [],
        jenis = [],
        date = [],
...
async function srexdldown(link) {
  return new Promise((resolve => {
    axios.get(link).then((({ data: data }) => {
      ...
      axios.get(plink).then((({ data: data }) => {
        const $$ = cheerio.load(data);
...
async function smerdekanews() {
  return new Promise((resolve => {
    axios.get("https://www.merdeka.com/peristiwa/").then((({ data: data }) => {
      const $ = cheerio.load(data),
        judul = [],
        upload = [],
        link = [],
...
async function smetronews() {
  return new Promise((resolve => {
    axios.get("https://www.metrotvnews.com/news").then((({ data: data }) => {
      const $ = cheerio.load(data),
        judul = [],
        desc = [],
        link = [],
...
async function sasupanfilm(query) {
  return new Promise((resolve => {
    axios.get(`https://asupanfilm.link/?search=${query}`).then((({ data: data }) => {
      const $ = cheerio.load(data),
        judul = [],
        desc = [],
        thumb = [],
...
async function sstickersearch(query) {
  return new Promise((resolve => {
    axios.get(`https://getstickerpack.com/stickers?query=${query}`).then((({ data: data }) => {
      const $ = cheerio.load(data),
        link = [];
...
async function srandomtt(query) {
  return new Promise(((resolve, reject) => {
    axios.get("https://brainans.com/search?query=" + query).then((({ data: data }) => {
      const luser = cheerio.load(data)("#search-container > div:nth-child(1) > div.content__text > a").attr("href");
      axios.get("https://brainans.com/" + luser).then((({ data: data }) => {
        const $$ = cheerio.load(data);
        let vlink = [];
...
async function strendtwit(country) {
  return new Promise(((resolve, reject) => {
    axios.get(`https://getdaytrends.com/${country}/`).then((({ data: data }) => {
      const $ = cheerio.load(data),
        hastag = [],
        tweet = [],
        result = [];
...
async function szerochan(query) {
  return new Promise(((resolve, reject) => {
    axios.get("https://www.zerochan.net/search?q=" + query).then((({ data: data }) => {
      const $ = cheerio.load(data),
        judul = [],
        result = [],
        id = [];
...
async function sanoboys(query) {
  return new Promise(((resolve, reject) => {
    axios.get("https://anoboy.media/?s=" + query).then((({ data: data }) => {
      const $ = cheerio.load(data),
        format = [],
        link = [],
        judul = [],
...
async function sigstalk(username) {
  return new Promise((async (resolve, reject) => {
    let { data: data } = await axios("https://www.instagram.com/" + username + "/?__a=1", {
      method: "GET",
      headers: {
...
async function sgempa() {
  return new Promise((async (resolve, reject) => {
    axios.get("https://www.bmkg.go.id/gempabumi/gempabumi-dirasakan.bmkg").then((({ data: data }) => {
      const $ = cheerio.load(data),
        drasa = [];
...
async function scariresep(query) {
  return new Promise((async (resolve, reject) => {
    axios.get("https://resepkoki.id/?s=" + query).then((({ data: data }) => {
      const $ = cheerio.load(data),
        link = [],
        judul = [],
        format = [];
...
async function ssearchgore(query) {
  return new Promise((async (resolve, reject) => {
    axios.get("https://seegore.com/?s=" + query).then((dataa => {
      ...
      axios.get(slink).then((({ data: data }) => {
        const $ = cheerio.load(data),
          link = [],
          judul = [],
          uploader = [],
...
async function srandomgore() {
  return new Promise((async (resolve, reject) => {
    ...
    axios.get("https://seegore.com/gore/").then((({ data: data }) => {
      const $ = cheerio.load(data),
      ...
      axios.get(linkp).then((({ data: data }) => {
        const $$ = cheerio.load(data),
          format = {
            judul: $$("div.single-main-container > div > div.bb-col.col-content > div > div > div > div > header > h1").text(),
            views: $$("div.single-main-container > div > div.bb-col.col-content > div > div > div > div > div.s-post-meta-block.bb-mb-el > div > div > div.col-r.d-table-cell.col-md-6.col-sm-6.text-right-sm > div > span > span.count").text(),
...
async function sapkmirror(query) {
  return new Promise(((resolve, reject) => {
    axios.get("https://www.apkmirror.com/?post_type=app_release&searchtype=apk&s=" + query).then((({ data: data }) => {
      const $ = cheerio.load(data),
        nama = [],
        developer = [],
        lupdate = [],
...
async function sandroid1(query) {
  return new Promise(((resolve, reject) => {
    axios.get("https://an1.com/tags/MOD/?story=" + query + "&do=search&subaction=search").then((({ data: data }) => {
      const $ = cheerio.load(data),
        nama = [],
        link = [],
        rating = [],
...
async function sapkmody(query) {
  return new Promise(((resolve, reject) => {
    axios.get("https://apkmody.io/?s=" + query).then((({ data: data }) => {
      const $ = cheerio.load(data),
        nama = [],
        link = [],
        mod = [],
...
async function shappymod(query) {
  return new Promise(((resolve, reject) => {
    axios.get("https://www.happymod.com/search.html?q=" + query).then((({ data: data }) => {
      const $ = cheerio.load(data),
        nama = [],
        link = [],
        rating = [],
...
async function sghuser(query) {
  return new Promise(((resolve, reject) => {
    axios.get("https://github.com/search?q=" + query + "&type=users").then((({ data: data }) => {
      const $ = cheerio.load(data),
        username = [],
        link = [],
        result = [],
...
async function sghfollower(query) {
  return new Promise(((resolve, reject) => {
    axios.get("https://github.com/" + query + "?tab=followers").then((({ data: data }) => {
      const $ = cheerio.load(data),
        link = [],
        result = [],
        username = [];
...
async function sghfollowing(query) {
  return new Promise(((resolve, reject) => {
    axios.get("https://github.com/" + query + "?tab=following").then((({ data: data }) => {
      const $ = cheerio.load(data),
        link = [],
        result = [],
        username = [];
...
async function scorona(country) {
  ...
  try {
    ...
    return result.status = res.status, result.negara = $("div").find("h1").text().slice(3).split(/ /g)[0],
      ...
      result.informasi = $("div.content-inner > div").eq(1).text(), result.informasi_lengkap = "https://www.worldometers.info/coronavirus/country/" + country,
      "" === result.negara && (result.status = "error"), result;
  } catch (error404) {
...
async function smediafire(query) {
  return new Promise(((resolve, reject) => {
    axios.get(query).then((({ data: data }) => {
      const $ = cheerio.load(data),
        size = ($("body > div.mf-dlr.page.ads-alternate > div.content > div.center > div > div.dl-btn-cont > div.dl-btn-labelWrap > div.promoDownloadName.notranslate > div").text(),
          $("body > div.mf-dlr.page.ads-alternate > div.content > div.center > div > div.dl-info > ul > li:nth-child(1) > span").text()),
...
async function sartinama(query) {
  return new Promise(((resolve, reject) => {
    queryy = query.replace(/ /g, "+"), axios.get("https://www.primbon.com/arti_nama.php?nama1=" + query + "&proses=+Submit%21+").then((({ data: data }) => {
...
async function sdrakor(query) {
  return new Promise(((resolve, reject) => {
    ...
    axios.get("https://drakorasia.net/?s=" + queryy + "&post_type=post").then((({ data: data }) => {
      const $ = cheerio.load(data),
        result = [],
        link = [],
        judul = [],
...
async function swattpad(query) {
  return new Promise(((resolve, reject) => {
    axios.get("https://www.wattpad.com/search/" + query).then((({ data: data }) => {
      const $ = cheerio.load(data),
        result = [],
        linkk = [],
        judull = [],
...
async function sdewabatch(query) {
  return new Promise(((resolve, reject) => {
    axios.get("https://dewabatch.com/?s=" + query).then((({ data: data }) => {
      const $ = cheerio.load(data),
        result = [],
        linkk = [],
        judull = [],
...
async function skiryu(query) {
  return new Promise(((resolve, reject) => {
    axios.get("https://kiryuu.id/?s=" + query).then((({ data: data }) => {
      const $ = cheerio.load(data),
        result = [],
        linkk = [],
        judull = [],
...
async function ssfilesearch(query) {
  return new Promise(((resolve, reject) => {
    axios.get("https://sfile.mobi/search.php?q=" + query + "&search=Search").then((({ data: data }) => {
      const $ = cheerio.load(data),
        result = [],
        link = [],
        neme = [],
...
async function scarigc(nama) {
  return new Promise(((resolve, reject) => {
    axios.get("http://ngarang.com/link-grup-wa/daftar-link-grup-wa.php?search=" + nama + "&searchby=name").then((({ data: data }) => {
      const $ = cheerio.load(data),
        result = [],
        lnk = [],
        nm = [];
...
async function sdevianart(query) {
  return new Promise(((resolve, reject) => {
    axios.get("https://www.deviantart.com/search?q=" + query).then((({ data: data }) => {
      const $$ = cheerio.load(data);
...
async function skonachan(chara) {
  return new Promise(((resolve, reject) => {
    ...
    axios.get("https://konachan.net/post?tags=" + text + "+").then((({ data: data }) => {
      const $$ = cheerio.load(data),
        no = [];
      ...
      axios.get("https://konachan.net/post?page=" + mat + "&tags=" + text + "+").then((({ data: data }) => {
        const $ = cheerio.load(data),
          result = [];
...
async function swallpapercave(query) {
  return new Promise(((resolve, reject) => {
    axios.get("https://wallpapercave.com/search?q=" + query).then((({ data: data }) => {
      const $ = cheerio.load(data),
        result = [];
...
async function swallpapercraft(query) {
  return new Promise(((resolve, reject) => {
    axios.get("https://wallpaperscraft.com/search/?query=" + query).then((({ data: data }) => {
      const $ = cheerio.load(data),
        result = [];
...
async function swallpaperhd(chara) {
  return new Promise(((resolve, reject) => {
    axios.get("https://wall.alphacoders.com/search.php?search=" + chara + "&filter=4K+Ultra+HD").then((({ data: data }) => {
      const $ = cheerio.load(data),
        result = [];
...
export { sandroid1, sanime, sanoboydl, sanoboys, sapkmirror, sapkmody, sartinama, sasupanfilm, sasupanfilminfo, sbacaresep, scarigc, scariresep, schara, scorona, sdevianart, sdewabatch, sdrakor, sfacebook, sfilm, sgempa, sghfollower, sghfollowing, sghuser, sgoredl, shappymod, shappymoddl, sigdl, sigdl2, sigstalk, sigstory, sjob, sjoox, skiryu, skonachan, smanga, smangatoon, smediafire, smerdekanews, smetronews, spalingmurah, spin, spinterest2, squotes, srandomgore, srandomtt, srexdl, srexdldown, ssearchgore, ssfiledown, ssfilesearch, ssoundcloud, sstickersearch, stextmakervid, stiktok, strendtwit, stwitter, swallpapercave, swallpapercraft, swallpaperhd, swattpad, swebtoons, swikisearch, szerochan, szippydl };