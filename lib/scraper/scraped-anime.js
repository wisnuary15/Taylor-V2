...
async function scrapKiryuuSearch(t) {
  return new Promise(((i, e) => {
    axios.get(`${urlKiryuu}?s=${t}`).then((({ data: t }) => {
...
function scrapMangatoonRead(t) {
  return new Promise(((i, e) => /mangatoon.mobi/g.test(t) ? /watch/g.test(t) ? void axios.get(t).then((({ data: t }) => {
    const e = cheerio.load(t),
...
function scrapKusonime(t) {
  return new Promise(((i, e) => {
    const n = t;
    axios.get(`https://kusonime.com/?s=${n}&post_type=post`).then((({ data: t }) => {
      const e = cheerio.load(t);
      let n = [];
...
function animeIdLatest() {
  return new Promise(((t, i) => {
    axios.get("https://nontonanimeid.com/").then((({ data: i }) => {
...
function animeIdSr(t) {
  return new Promise(((i, e) => {
    axios.get(`https://nontonanimeid.com/?s=${t}`).then((async ({ data: t }) => {
      const e = cheerio.load(t);
      let n = [];
...
async function manga(t) {
  return new Promise(((i, e) => {
    axios.get(`https://www.anime-planet.com/manga/all?name=${t}`).then((({ data: t }) => {
      const e = [],
        n = cheerio.load(t);
...
async function chara(t) {
  return new Promise(((i, e) => {
    axios.get(`https://www.anime-planet.com/characters/all?name=${t}`).then((({ data: t }) => {
      const e = [],
        n = cheerio.load(t);
...
export { scrapKiryuuSearch, scrapKiryuuGet, scrapMangatoonSearch, scrapMangatoonGet, scrapMangatoonRead, scrapKusonime, animeIdLatest, animeIdSr, animeIdGet, manga, chara, Otakudesu };