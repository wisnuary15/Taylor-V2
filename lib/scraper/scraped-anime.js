...
async function scrapKiryuuSearch(t) {
  return new Promise((i, e) => {
    axios.get(`${urlKiryuu}?s=${t}`).then(({
      ...
      let l = [];
      e("div.listupd > div > div > a > div:nth-child(2) > div > div:nth-child(2) > div > div:nth-child(2)")
        .get().map((t) => {
          l.push(e(t).text());
        });
      let h = [];
      ...
      let c = h.filter(
        (t) => null != t.name && null != t.thumb && null != t.type && null != t.chapter && null != t
        .rating && null != t.url);
      i(c);
    }).catch(e);
  });
    ...
    axios.get(`https://kusonime.com/?s=${n}&post_type=post`).then(({
      ...
      e("div.content > h2 > a").get().map((t) => {
        ...
        axios.get(n[0]).then(({
          ...
          let g = [];
          e('div[class="venser"]').find('div[class="lexot"]').children('div[class="dlbod"]').children(
              'div[class="smokeddl"]').first().children('div[class="smokeurl"]').each((t, i) => {
              const n = [],
    ...
    axios.get(`https://www.anime-planet.com/characters/all?name=${t}`).then(({
      ...
      n("#siteContainer > table > tbody > tr").each(function(t, i) {
          (result = {
            ...
            thumbnail: n(i).find("> td.tableAvatar > a > img").attr("src").startsWith("https://") ? n(i)
              .find("> td.tableAvatar > a > img").attr("src") : "https://www.anime.planet.com" + n(i)
              .find("> td.tableAvatar > a > img").attr("src"),
          }),
          e.push(result);
        }),
        i(e);
...
async function Otakudesu(t) {
  try {
    ...
    let e = cheerio.load(i.data)("#venkonten > div > div.venser > div > div > ul > li:nth-child(1) > h2 > a").attr(
      "href");
    const n = await axios.get(e),
      a = cheerio.load(n.data);
    let s = a("#venkonten").find("div.venser > div.fotoanime > div.infozin > div > p:nth-child(1) > span").text()
      .trim(),
      d = a("#venkonten").find("div.venser > div.fotoanime > div.infozin > div > p:nth-child(2) > span").text()
    .trim(),
      r = a("#venkonten").find("div.venser > div.fotoanime > div.infozin > div > p:nth-child(3) > span").text()
    .trim(),
      o = a("#venkonten").find("div.venser > div.fotoanime > div.infozin > div > p:nth-child(4) > span").text()
    .trim(),
      l = a("#venkonten").find("div.venser > div.fotoanime > div.infozin > div > p:nth-child(5) > span").text()
    .trim(),
      h = a("#venkonten").find("div.venser > div.fotoanime > div.infozin > div > p:nth-child(6) > span").text()
    .trim(),
      c = a("#venkonten").find("div.venser > div.fotoanime > div.infozin > div > p:nth-child(7) > span").text()
    .trim(),
      p = a("#venkonten").find("div.venser > div.fotoanime > div.infozin > div > p:nth-child(8) > span").text()
    .trim(),
      m = a("#venkonten").find("div.venser > div.fotoanime > div.infozin > div > p:nth-child(9) > span").text()
    .trim(),
      u = a("#venkonten").find("div.venser > div.fotoanime > div.infozin > div > p:nth-child(10) > span").text()
      .trim(),
      v = a("#venkonten").find("div.venser > div.fotoanime > div.infozin > div > p:nth-child(11) > span").text()
      .trim(),
      ...
      x = a("#venkonten").find("div.venser > div:nth-child(8) > ul > li:nth-child(4) > span:nth-child(1) > a").attr(
        "href");
    return {
      status: !0,
      judul: s,
