...
async function ceritahntu() {
  return new Promise(((t, e) => {
    axios.get("https://cerita-hantu.com/list-cerita-hantu-a-z/").then((({ data: e }) => {
      ...
      n("div > div > ul:nth-child(7) > li > a").each((function(t, e) {
        ...
        null != n(e).attr("href") && a.push(n(e).attr("href"));
      })), axios.get(a[Math.floor(Math.random() * a.length)]).then((({ data: e }) => {
        const n = cheerio.load(e),
          a = [];
        n("div > div > a").each((function(t, e) {
          n(e).attr("href").startsWith("https:") && a.push(n(e).attr("href"));
        })), rand = a[Math.floor(Math.random() * a.length)], axios.get(rand).then((({ data: e }) => {
          const n = cheerio.load(e);
          t({
