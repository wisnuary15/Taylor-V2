...
function XPanas(search = "indonesia") {
  return new Promise((async (resolve, reject) => {
    try {
      const { data: data } = await axios.get("http://164.68.127.15/?id=" + search), $ = cheerio.load(data), ajg = [];
...
function WikiMedia(search) {
  return new Promise((async (resolve, reject) => {
    try {
      const { data: data } = await axios.get(`https://commons.wikimedia.org/w/index.php?search=${search}&title=Special:MediaSearch&go=Go&type=image`), $ = cheerio.load(data), hasil = [];
...
function SoundCloudeS(search) {
  return new Promise((async (resolve, reject) => {
    try {
      const { data: data, status: status } = await axios.get(`https://soundcloud.com/search?q=${search}`), $ = cheerio.load(data), ajg = [];
...
function RingTone(search) {
  return new Promise((async (resolve, reject) => {
    try {
      const { data: data } = await axios.get("https://meloboom.com/en/search/" + search);
...
function PlayStore(search) {
  return new Promise((async (resolve, reject) => {
    try {
      const { data: data, status: status } = await axios.get(`https://play.google.com/store/search?q=${search}&c=apps`), hasil = [], $ = cheerio.load(data);
...
function TixID() {
  return new Promise((async (resolve, reject) => {
    try {
      const { data: data } = await axios.get("https://www.tix.id/tix-now/"), $ = cheerio.load(data), hasil = [];
...
function BukaLapak(search) {
  return new Promise((async (resolve, reject) => {
    try {
      const { data: data } = await axios.get(`https://www.bukalapak.com/products?from=omnisearch&from_keyword_history=false&search[keywords]=${search}&search_source=omnisearch_keyword&source=navbar`, {
        headers: {
...
function AcaraNow() {
  return new Promise((async (resolve, reject) => {
    try {
      const { data: data } = await axios.get("https://www.jadwaltv.net/channel/acara-tv-nasional-saat-ini"), $ = cheerio.load(data);
      let tv = [];
...
function Jadwal_Sepakbola() {
  return new Promise((async (resolve, reject) => {
    try {
      const { data: data } = await axios.get("https://www.jadwaltv.net/jadwal-sepakbola"), $ = cheerio.load(data);
      let tv = [];
...
function JadwalTV(query) {
  return new Promise((async (resolve, reject) => {
    try {
      const { data: data } = await axios.get("https://www.jadwaltv.net/channel/" + query), $ = cheerio.load(data), tv = [];
      if ($("table.table.table-bordered > tbody > tr.jklIv").each(((u, i) => {
          let an = $(i).text().split("WIB");
          tv.push(`${an[0]} - ${an[1]}`);
        })), tv.every((x => void 0 === x))) return resolve({
...
function Steam(search) {
  return new Promise((async (resolve, reject) => {
    try {
      const { data: data, status: status } = await axios.get("https://store.steampowered.com/search/?term=" + search), $ = cheerio.load(data), hasil = [];
...
function Steam_Detail(url) {
  return new Promise((async (resolve, reject) => {
    try {
      const { data: data, status: status } = await axios.get(url), $ = cheerio.load(data), xorizn = [], img = $("#gameHeaderImageCtn > img").attr("src");
...
function WattPad(judul) {
  return new Promise((async (resolve, reject) => {
    try {
      const { data: data } = await axios.get("https://www.wattpad.com/search/" + judul, {
        headers: {
...
function LinkWa(query) {
  return new Promise((async (resolve, reject) => {
    try {
      const { data: data } = await axios.get("http://ngarang.com/link-grup-wa/daftar-link-grup-wa.php?search=" + query + "&searchby=name"), $ = cheerio.load(data), _title = [], _link = [], result = [];
...
function Lirik2(judul) {
  return new Promise((async (resolve, reject) => {
    try {
      const { data: data } = await axios.get("https://www.musixmatch.com/search/" + judul), $ = cheerio.load(data), hasil = {}, link = "https://www.musixmatch.com" + $("div.media-card-body > div > h2").find("a").attr("href");
      await axios.get(link).then((({ data: data }) => {
...
function KBBI(query) {
  return new Promise((async (resolve, reject) => {
    try {
      const { data: data } = await axios.get("https://kbbi.kemdikbud.go.id/entri/" + query), $ = cheerio.load(data);
      let _kata = [],
        _arti = [],
        _ol = [];
...
function Nomina(query) {
  return new Promise((async (resolve, reject) => {
    try {
      const { data: data } = await axios.get("https://tesaurus.kemdikbud.go.id/tematis/lema/" + query + "/nomina"), $ = cheerio.load(data);
      let _arti = [];
...
function KodePos(query) {
  return new Promise((async (resolve, reject) => {
    try {
      const { data: data } = await axios.get("https://nomorkodepos.com/?s=" + query), $ = cheerio.load(data);
      let _data = [];
...
function ListHero() {
  return new Promise((async (resolve, reject) => {
    try {
      const { data: data } = await axios.get("https://mobile-legends.fandom.com/wiki/List_of_heroes"), $ = cheerio.load(data);
      let _data = [];
...
function Hero(querry) {
  return new Promise((async (resolve, reject) => {
    try {
      ...
      const { data: data, status: status } = await axios.get("https://mobile-legends.fandom.com/wiki/" + upper);
      if (200 === status) {
        const $ = cheerio.load(data);
        let atributes = [],
          rill = [],
...
export { XPanas, WikiMedia, SoundCloudeS, RingTone, PlayStore, BukaLapak, TixID, AcaraNow, Jadwal_Sepakbola, JadwalTV, Steam, Steam_Detail, WattPad, LinkWa, Lirik2, KBBI, Nomina, KodePos, ListHero, Hero, emojiGraph, searchEmoji, emojiPedia, NotoEmoji, EmojiGG };