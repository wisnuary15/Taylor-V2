...
async function GDriveDl(url) {
  ...
  try {
    ...
    let { fileName: fileName, sizeBytes: sizeBytes, downloadUrl: downloadUrl } = JSON.parse((await res.text()).slice(4));
...
export { GDriveDl, capitalizeFirstLetter, cerpen, delay, generate, getBuffer, getRandom, isNumber, isUrl, linkwa, lirik, niceBytes, padLead, pickRandom, playstore, quotesAnime, ranNumb, readMore, runtime, runtimes, someincludes, somematch, wallpaper, summarize, detectText };