...
class Primbon {
        ...
        try {
          n = {
            ...
            message: {
              ...
              result: i.split("begitu pula sebaliknya.")[1].split("Konsultasi Hari Baik Akad Nikah >>>")[0]
                .trim(),
        ...
        try {
          n = {
            ...
            message: {
              ...
              result: i.split("HASILNYA MENURUT PAL SRI SEDANAI. ")[1].split(
                "Konsultasi Hari Baik Akad Nikah >>>")[0],
              catatan: "Untuk melihat kecocokan jodoh dengan pasangan, dapat dikombinasikan dengan Ramalan Jodoh (Jawa), numerologi Kecocokan Cinta, tingkat keserasian Nama Pasangan, Ramalan Perjalanan Hidup Suami Istri, dan makna dari Tanggal Jadian/Pernikahan.",
            },
          };
        } catch {
        ...
        try {
          n = {
            ...
            message: {
              ...
              result: i.split("HASIL RAMALAN MENURUT USIA PERNIKAHAN")[1].split(
                "Konsultasi Hari Baik Akad Nikah >>>")[0],
  ...
  async kecocokan_nama_pasangan(a, t) {
    return new Promise((n, i) => {
      axios.get("https://primbon.com/kecocokan_nama_pasangan.php?nama1=" + a + "&nama2=" + t +
        "&proses=+Submit%21+").then(({
        data: i
      }) => {
        let e,
  ...
  async tanggal_jadian_pernikahan(a, t, n) {
    return new Promise((i, e) => {
      axios.get("https://primbon.com/tanggal_jadian_pernikahan.php?tgl=" + a + "&bln=" + t + "&thn=" + n +
        "&proses=+Submit%21+").then(({
        data: a
      }) => {
        let t,
        ...
        try {
          t = {
            ...
            message: {
              ...
              sifat: "Anda Adalah Orang yang" + n.split("Anda adalah orang yang")[1].split(
                "Dalam numerologi Pitagoras,")[0],
              elemen: "Dalam numerologi Pitagoras" + n.split("Dalam numerologi Pitagoras")[1].split(
                "Angka Kombinasi")[0].trim(),
              angka_keberuntungan: "Angka Kombinasi" + n.split("Angka Kombinasi")[1].split("Tgl. Lahir")[0]
                ?.trim(),
      ...
      axios({
        ...
        try {
          t = {
            status: !0,
            message: {
              analisa: n.split("CEK POTENSI PENYAKIT (METODE PITAGORAS)")[1].split("Sektor yg dianalisa:")[
                0].trim(),
              sektor: n.split("Sektor yg dianalisa:")[1].split("Anda tidak memiliki elemen")[0].trim(),
              elemen: "Anda tidak memiliki elemen " + n.split("Anda tidak memiliki elemen")[1].split("*")[0]
                ?.trim(),
        ...
        try {
          t = {
            ...
            message: {
              ...
              kelompok: n.split("Anda termasuk kelompok")[1].split(
                "Orang dalam kelompok ini mempunyai karakter:")[0],
              karakter: n.split("Orang dalam kelompok ini mempunyai karakter: ")[1].split(
                "SEKTOR/ARAH BAIK")[0].trim(),
      ...
      axios({
        ...
        try {
          t = {
            status: !0,
            message: {
              tgl_lahir: n.split("Primbon Hari Larangan (Tanggal Sangar, Bangas Padewan, Taliwangke)")[1]
                .split("Termasuk hari BIASA")[0],
              result: "Termasuk hari BIASA" + n.split("Termasuk hari BIASA")[1].split(
                "Untuk mengetahui watak hari, masukkan:")[0],
      ...
      axios({
        ...
        try {
          t = {
            status: !0,
            message: {
              result: n.split("KALKULATOR MASA SUBUR")[1].split("Menentukan Ovulasi & Masa Subur")[0]
              .trim(),
              catatan: "Menentukan Ovulasi & Masa Subur\n" + n.split("Menentukan Ovulasi & Masa Subur")[1]
                .trim(),
            },
          };
        } catch {
