...
class Primbon {
  ...
  async tafsir_mimpi(a) {
    return new Promise(((t, n) => {
      axios.get("https://primbon.com/tafsir_mimpi.php?mimpi=" + a + "&submit=+Submit+").then((({ data: n }) => {
  ...
  async arti_nama(a) {
    return new Promise(((t, n) => {
      axios.get("https://primbon.com/arti_nama.php?nama1=" + a + "&proses=+Submit%21+").then((({ data: n }) => {
        let i, e = cheerio.load(n)("#body").text();
        try {
          i = {
            status: !0,
  ...
  async kecocokan_nama_pasangan(a, t) {
    return new Promise(((n, i) => {
      axios.get("https://primbon.com/kecocokan_nama_pasangan.php?nama1=" + a + "&nama2=" + t + "&proses=+Submit%21+").then((({ data: i }) => {
  ...
  async tanggal_jadian_pernikahan(a, t, n) {
    return new Promise(((i, e) => {
      axios.get("https://primbon.com/tanggal_jadian_pernikahan.php?tgl=" + a + "&bln=" + t + "&thn=" + n + "&proses=+Submit%21+").then((({ data: a }) => {
