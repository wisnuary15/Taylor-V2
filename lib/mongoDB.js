...
export class mongoDB {
  ...
  async read() {
    try {
      ...
      if (this._model = this.db.model("data", schema), this._data = await this._model.findOne({}), this.data = this._data?.data ?? {}, !this._data) {
...
export class mongoDBV2 {
  ...
  async write(data) {
    try {
      ...
      return console.log(chalk.bgGreen.black(" MongoDB \n"), chalk.yellow(">>\n"), chalk.bgYellow.black("Write successful")), !0;
    } catch (error) {
      throw console.log(chalk.bgRed.black(" MongoDB \n"), chalk.yellow(">>\n"), chalk.bgRed.black(`Write error: ${error}`)),
        error;
    }
