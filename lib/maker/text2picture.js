...
async function raterian(inp) {
    try {
        return `https://raterian.sirv.com/New%20Project.png?text.0.text=${id}&text.0.position.y=-35%25&text.0.color=ffffff&text.0.font.family=Poppins&text.0.font.weight=800&text.0.outline.color=000000&text.0.outline.width=1`
    } catch (error) {
        console.error('Error:', error);
        return [];
    }
