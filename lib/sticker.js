...
async function sticker(media, url, args) {
  const functionsToTry = [sticker5, sticker10, sticker2, sticker6, sticker11, sticker12, sticker13, sticker3, sticker4, sticker1, sticker7, sticker9, sticker8].filter(Boolean);
