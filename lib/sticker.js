...
async function sticker(media, url, args) {
  ...
  const functionsToTry = [sticker5, global.support.ffmpeg && (global.support.convert || global.support.magick || global.support.gm) ? sticker2 : null, global.support.ffmpeg ? sticker6 : null, sticker10, sticker11, sticker12, sticker13, sticker3, global.support.ffmpeg && global.support.ffmpegWebp ? sticker4 : null, sticker1, sticker7, sticker9, sticker8].filter(Boolean);
