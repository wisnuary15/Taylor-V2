...
class FlyApi {
  ...
  handleError(error, context) {
    const errors = error?.response?.data ? JSON.stringify(error.response.data) : error?.message || "Unknown Error";
