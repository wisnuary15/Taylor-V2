  ...
  try {
    ...
    detailElement.find(".infozin").filter(function() {
      ...
      $(this).find("p").children().eq(10).find("span > a").each(function() {
        genre_name = $(this).text();
        genre_id = $(this).attr("href").replace(`https://otakudesu.cloud/genres/`, "");
        genre_link = $(this).attr("href");
        genreList.push({
          genre_name,
          genre_id,
    ...
    const batch_link = {
      id: $("div.venser > div:nth-child(6) > ul").text().length !== 0 ? $(
        "div.venser > div:nth-child(6) > ul > li > span:nth-child(1) > a").attr("href").replace(
        `https://otakudesu.cloud/batch/`, "") : "Maaf, masih kosong bro",
      link: $("div.venser > div:nth-child(6) > ul").text().length !== 0 ? $(
          "div.venser > div:nth-child(6) > ul > li > span:nth-child(1) > a").attr(
        "href") : "Maaf, masih kosong bro",
    };
    const empty_link = {
      id: "Maaf, masih kosong bro",
      link: "Maaf, masih kosong bro",
