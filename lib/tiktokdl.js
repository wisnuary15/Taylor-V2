...
const UserAgent = () => (ossss = ["Macintosh; Intel Mac OS X 10_15_7", "Macintosh; Intel Mac OS X 10_15_5", "Macintosh; Intel Mac OS X 10_11_6", "Macintosh; Intel Mac OS X 10_11_5", "Windows NT 10.0; Win64; x64", "Windows NT 10.0"],
  `Mozilla/5.0 (${ossss[Math.floor(Math.random() * ossss.length)]}) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/${Math.floor(3 * Math.random()) + 87}.0.${Math.floor(190 * Math.random()) + 4100}.${Math.floor(50 * Math.random()) + 140} Safari/537.36`);
