...
class ApiGratis {
  ...
  async getStatus() {
    try {
      ...
      throw console.error(chalk.red("Error fetching status:", error.message)),
        error;
    }
  }
  async searchCharacters(query) {
    try {
      ...
      throw console.error(chalk.red("Error searching characters:", error.message)),
        error;
    }
  }
  ...
  async sendMessage(externalId, message) {
    try {
      ...
      throw console.error(chalk.red("Error sending message:", error.message)),
        error;
    }
  }
}
