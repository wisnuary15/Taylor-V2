...
class Hat {
  ...
  getSources = async (question) => await this.fetchData('getSources', { question });
  getSimilarQuestions = async (question) => await this.fetchData('getSimilarQuestions', { question });
  getAnswer = async (question, sources) => await this.fetchData('getAnswer', { question, sources });
  ...
  main = async (question) => {
    try {
      ...
      return { similarQuestions, sources, chatResult };
    } catch (error) {
      throw error;
    }
  }
