    ...
    try {
      return await new Promise(((resolve, reject) => {
        ...
        chat.onopen = () => {
          ...
          if ("{}" === message && (chat.send('{"type":6}' + this.EOL), chat.send(JSON.stringify(this.json) + this.EOL),
              this.json.invocationId = (parseInt(this.json.invocationId) + 1).toString(), this.json.arguments[0].isStartOfSession = !1),
            2 === json.type) {
