...
async function synthesize(ttsOptions) {
  try {
    ...
    "free" === tierLevel && "mp3_44100_192" === ttsOptions.output_format && (console.log("Free tier is limited to mp3_44100_128 format."),
...
export { LABSURL, LABSKEY, FORMATS, DEFAULT_VOICE, PAULCA_VOICE, YOUTUBE_VOICE, labsVoiceID, init, getUser, getUserInfo, isValidVoice, listVoices, synthesize };