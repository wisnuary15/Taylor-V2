...
const referer = "https://krakenfiles.com",
  ...
  createFormData = async (content, fieldName) => {
    ...
    text: text,
    spinner: "moon"
  }), Provider = ["Catbox", "Discord", "Doodstream", "Fexnet", "FileDitch", "Filebin", "Fileio", "Filezone", "FreeImage", "Gofile", "Gozic", "Hostfile", "Imgbb", "Kitc", "Kraken", "MediaUpload", "Nullbyte", "Pixeldrain", "Pomf2", "Sazumi", "Sohu", "Gizai", "Sojib", "Knowee", "Puticu", "Stylar", "Telegraph", "Tmpfiles", "Babup", "Transfersh", "Ucarecdn", "Uguu", "UploadEE", "Uploadify", "Videy", "ZippyShare"];
class Uploader {
  constructor() {
  ...
  async Discord(content) {
    ...
    try {
      const {
        formData
      } = await createFormData(content, "files[0]"), res = await fetch("https://discord.com/api/v9/channels/1180731738176094228/messages", {
        method: "POST",
        headers: {
