...
class Typecast {
  constructor() {
    this.tokenUrl = "https://securetoken.googleapis.com/v1/token?key=AIzaSyBJN3ZYdzTmjyQJ-9TdpikbsZDT9JUAYFk";
    ...
    try {
      const response = await fetch(this.tokenUrl, {
        ...
        body: new URLSearchParams({
          ...
          refresh_token: "AMf-vBwlkMpj1jPO3Et_yA6g5Kxbl_U2WyVjJGmRdmlXtVJ49vTqxQeH0ZlDLlRJ_uNSJaRywUKCIcaGe7BnNH0oJDNZX6enKeFZqShPqejfuHAhqyGgOS4V2M6DE04dKBbmRgfBvWubYSE7Dgc8uVGIPhBpGlkEatvQM_9V2C6IM8lNNCyKXApHAs_N1Bk5K42VE4gJ5X2ELNOjjO64GEleBPoMykUiM6SgHgHqSf4Exgi8VjsngxwNV6_Hw_eVEw1a1T-Xb2-OHdf_K5qDmLpNtIcNNVFNvMYYKwhwbNY5lbhgNLO_V8s-puHNVqLLRrw26mmoNeK5"
        })
      });
