...
class NeoxrApi {
  ...
  rexdl = async (str) => {
    let json = str.match('rexdl.com') ? await fetch(this.baseUrl + '/rexdl-get?url=' + str + '&apikey=' + this
      .apiKey) : await fetch(this.baseUrl + '/rexdl?q=' + encodeURIComponent(str) + '&apikey=' + this.apiKey)
    return await json.json()
  }
  ...
  soundcloud = async (str) => {
    let json = str.match('soundcloud.com') ? await fetch(this.baseUrl + '/soundcloud?url=' + str + '&apikey=' + this
      .apiKey) : await fetch(this.baseUrl + '/soundcloud-search?q=' + str + '&apikey=' + this.apiKey)
    return await json.json()
  }
  apk = async (query, no) => {
    if (query && no) {
  ...
  sticker = async (str) => {
    let json = str.match('getstickerpack.com') ? await fetch(this.baseUrl + '/sticker-get?url=' + str + '&apikey=' +
      this.apiKey) : await fetch(this.baseUrl + '/sticker?q=' + encodeURIComponent(str) + '&apikey=' + this
      .apiKey)
    return await json.json()
  }
  tm = (style, text) => {
  ...
  google = async (query, image = false) => {
    let json = await fetch(this.baseUrl + '/' + (image ? 'goimg' : 'google') + '?q=' + query + '&apikey=' + this
      .apiKey)
    return await json.json()
  }
  nama = async (query) => {
  ...
  cnn = async (url) => {
    let json = url ? await fetch(this.baseUrl + '/cnn?url=' + url + '&apikey=' + this.apiKey) : await fetch(this
      .baseUrl + '/cnn?apikey=' + this.apiKey)
    return await json.json()
  }
  gempa = async () => {
  ...
  youtube = async (url, type = 'video', quality = '480p') => {
    let json = await fetch(this.baseUrl + '/youtube?url=' + url + '&type=' + type + '&quality=' + quality +
      '&apikey=' + this.apiKey)
    return await json.json()
  }
