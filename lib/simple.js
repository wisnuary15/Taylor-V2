        ...
        getFile: {
            ...
            async value(PATH, saveToFile = false) {
                ...
                const data = isBuffer ?
                    ...
                    await (res = getDataBuffer(PATH)) :
                    fs.existsSync(PATH) ?
                    ((filename = PATH), fs.readFileSync(PATH)) :
                    fs.readFileSync('./thumbnail.jpg') || Buffer.alloc(0);
...
async value(jid, messages, quoted, options) {
    ...
    await conn.sendLists(jid, title, text, footer, buffer, buttonText, sections, quoted, {
        ...options
    });
}
},
...
const sectionses = listSections.map(([title, rows]) => ({
    ...
    await conn.sendButtonMessages(jid, [[text, footer, buffer || null, [
    ], null, null, [
        [buttonText, sections]
    ]]], quoted, {
        ...Object.assign({
        ...
        */
         ...
         */
            async value(jid, text = '', footer = '', buffer, buttons, quoted, options = {}) {
                await conn.sendButtonMessages(jid, [[text, footer, buffer, buttons, null, null, null]], quoted, {
            ...options
        })
            },
            enumerable: true
