...
`
        conn.sendFile(m.chat, v.src.original || v.src['large2x'] || v.src.large || v.src.medium || v.src.small || v.src.portrait || v.src.landscape || v.src.tiny, v.alt || 'Tidak diketahui', teks, m)
    } catch (e) {
        throw eror
    }
}
