...
🛡️ *MOD:* ${infoData.MOD}
`;
        conn.sendFile(m.chat, data.ogImageUrl, "", formattedInfo, m)
        conn.sendFile(m.chat, data.downloadInfo.data.link, data.title, null, m, true, {
          quoted: m,
    ...
    if (feature === "mod") {
      ...
      try {
        ...
        conn.sendFile(m.chat, urls, resl.downloadText, null, m, true, {
          quoted: m,
          mimetype: "application/vnd.android.package-archive"
        })
      } catch (e) {
