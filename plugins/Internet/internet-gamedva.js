...
`
        conn.sendFile(m.chat, item.detail.image, "", cap, m)
        conn.sendFile(m.chat, item.link, item.detail.title, null, m, true, {
          quoted: m,
...
async function searchApp(query) {
  const response = await fetch('https://gamedva.com/?s=' + query +
    '&asl_active=1&p_asl_data=1&customset[]=post&asl_gen[]=title&polylang_lang=en&qtranslate_lang=0&filters_initial=1&filters_changed=0'
