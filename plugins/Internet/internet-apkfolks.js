  ...
  if (lister.includes(feature)) {
    ...
    if ("app" === feature) {
      ...
      try {
        ...
        0 === !Object.keys(item.download).length && !item.download.constructor === Object ? (await conn.sendFile(m.chat, item.image || logo, "", cap, m),
          await conn.sendFile(m.chat, dlnow || logo, item.title || "Tidak diketahui", null, m, !0, {
            quoted: m,
