...
`
    ...
    return conn.sendList(m.chat, htki + ' 📺 Github Search 🔎 ' + htka,
      `⚡ Total ${sul.total_count} Code, Silakan pilih Github Search di tombol di bawah...\n*Teks yang anda kirim:* ${text}\n\nKetik ulang *${usedPrefix + command}* teks anda untuk mengubah teks lagi`,
      author, `☂️ Github Search Disini ☂️`, listSections, m)
  }
