...
const handler = async (m, {
  ...
  let res = await fetch('https://api.unsplash.com/search/photos?query=' + text +
    '&client_id=STxusJIgGSHWruiaq77WMAbMXmXRXAFr0JQQq3FY9v8')
  let listSections = []
  ...
  return conn.sendList(m.chat, htki + ' 📺 Unsplash Search 🔎 ' + htka,
    `⚡ Silakan pilih Unsplash Search di tombol di bawah...\n*Teks yang anda kirim:* ${text}\n\nKetik ulang *${usedPrefix + command}* teks anda untuk mengubah teks lagi`,
    author, `☂️ Unsplash Search Disini ☂️`, listSections, m)
}
