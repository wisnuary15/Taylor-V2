...
async function ytmp3(url) {
  try {
    const { videoDetails: videoDetails } = await ytdl.getInfo(url, {
      lang: "id"
    }), stream = ytdl(url, {
      filter: "audioonly",
      quality: 140
