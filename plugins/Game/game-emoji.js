...
const handler = async (m, {
  ...
  let src = await (await fetch('https://emoji-api.com/emojis?access_key=b7e74af2d49675275c934455de1ef48fe8b6c0a3'))
    .json()
...
Bonus: ${poin} XP
    `.trim()
  conn.tebakemoji[id] = [
    conn.sendFile(m.chat, imgr + json.codePoint.toLowerCase() + ".png", '', caption, m),
    json, poin,
    setTimeout(() => {
