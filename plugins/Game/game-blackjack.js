class Blackjack {
  ...
  hit() {
    if ("waiting" === this.state) {
      ...
      return playerSum === sumCards(this.dealer) ? (this.state = "draw", this.emitEndEvent()) : 21 === playerSum ? (this.state = "player_blackjack", this.emitEndEvent()) : playerSum > 21 && (this.state = "dealer_win", this.emitEndEvent()),
        this.table;
    }
  }
  stand() {
