const sentences = {
  ...
  easy: ["pagi semuanya", "terima kasih bantuanmu", "saya suka dirimu", "pohon memberikan teduh", "buah segar lezat",
    "warna bunga taman", "lautan biru tenang",
  ],
  normal: ["hujan turun langit", "burung terbang indah", "rumah sangat kecil", "laut warna biru indah",
    "pohon tinggi berdiri kokoh", "mobil besar warna merah", "pisang kuning rasanya manis", "sungai mengalir deras",
    "ayam bakar harum selera", "kapal layar laut luas",
  ],
  hard: ["bunga di kebun cantik", "pohon tinggi tepi sungai", "mobil sport melaju cepat",
    "pulau indah dikelilingi laut biru", "sungai mengalir hutan belantara", "matahari terbenam ufuk barat",
    "gunung tinggi menantang pendaki", "pantai eksotis berada selatan", "perpustakaan sangat besar lengkap",
    "taman dipenuhi bunga indah",
  ],
  extreme: ["pemandangan alam mengesankan hati", "gajah besar berjalan perlahan savana", "suasana malam gelap sepi",
    "burung hantu terbang malam hari", "rumah adat tradisional berdiri megah desa",
    "pulau terpencil tengah lautan luas", "gunung berapi meletus dahsyat", "air terjun tinggi jatuh gemuruh",
    "taman bermain tempat anak-anak riang", "kuda poni berlari padang rumput luas",
    "hutan tropis menyimpan flora fauna unik", "sungai jernih mengalir tengah lembah hijau",
  ],
};
...
handler.before = async (m, {
  ...
  if (isAnswerCorrect) {
    ...
    conn.reply(m.chat,
      `✨ *Selamat*, @${m.sender.split('@')[0]}! Kamu berhasil menyusun kalimat dengan benar pada *level ${level.toUpperCase()}*!`,
      m, {
        mentions: [m.sender]
      });
    conn.sendMessage(m.chat, {
