...
export async function before(m, {
  ...
  if (chat.antiToxic && isAntiToxic) {
    ...
    var shipverdict = ["❤️  ❤️  ❤️  ❤️  ❤️", //1-20
      "☠️  ❤️  ❤️  ❤️  ❤️", //21-40
      "☠️  ☠️  ❤️  ❤️  ❤️", "☠️  ☠️  ☠️  ❤️  ❤️", "☠️  ☠️  ☠️  ☠️  ❤️", "☠️  ☠️  ☠️  ☠️  ☠️"
    ];
    var shipfooter = ["You are so friendly. Very welcoming to know you!", "You are not too toxic, is it fun?",
      "You appear to be toxic. Calm down!", "Don't be so toxic. You can relax!",
...
${shipfooter[sIndexer]}
`
    this.reply(m.chat, `*Kata Aneh Terdeteksi!* ${isBotAdmin ? '' : '\n\n_Bot bukan atmin_'}`, m)
...
async function Analyze(teks) {
  try {
    ...
    return {
      ...
      combined: (result.data.attributeScores.SEVERE_TOXICITY.summaryScore.value + result.data.attributeScores.INSULT
        .summaryScore.value) / 2
    };
  } catch (e) {
    console.error(e);
    return {
