...
function mcskin(teks, atas, bawah) {
  let link;
  return "stone" === teks && (link = `https://minecraftskinstealer.com/achievement/20/${atas}/${bawah}`),
    "grass" === teks && (link = `https://minecraftskinstealer.com/achievement/1/${atas}/${bawah}`),
    "craftingtable" === teks && (link = `https://minecraftskinstealer.com/achievement/13/${atas}/${bawah}`),
    "furnace" === teks && (link = `https://minecraftskinstealer.com/achievement/18/${atas}/${bawah}`),
    "coal" === teks && (link = `https://minecraftskinstealer.com/achievement/31/${atas}/${bawah}`),
    "iron" === teks && (link = `https://minecraftskinstealer.com/achievement/22/${atas}/${bawah}`),
    "gold" === teks && (link = `https://minecraftskinstealer.com/achievement/23/${atas}/${bawah}`),
    "diamond" === teks && (link = `https://minecraftskinstealer.com/achievement/2/${atas}/${bawah}`),
    "redstone" === teks && (link = `https://minecraftskinstealer.com/achievement/14/${atas}/${bawah}`),
    "diamond-sword" === teks && (link = `https://minecraftskinstealer.com/achievement/3/${atas}/${bawah}`),
    "tnt" === teks && (link = `https://minecraftskinstealer.com/achievement/6/${atas}/${bawah}`),
    "cookie" === teks && (link = `https://minecraftskinstealer.com/achievement/7/${atas}/${bawah}`),
    "cake" === teks && (link = `https://minecraftskinstealer.com/achievement/10/${atas}/${bawah}`),
    "creeper" === teks && (link = `https://minecraftskinstealer.com/achievement/4/${atas}/${bawah}`),
    "pig" === teks && (link = `https://minecraftskinstealer.com/achievement/5/${atas}/${bawah}`),
    "heart" === teks && (link = `https://minecraftskinstealer.com/achievement/8/${atas}/${bawah}`),
    link;
}