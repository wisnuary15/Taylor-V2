...
const handler = async (m, {
  ...
  if ("emojimix3" === command) {
    ...
    m.react(wait);
    let anu = await fetchJson(`https://tenor.googleapis.com/v2/featured?key=${googlekey.getRandom()}&contentfilter=high&media_filter=png_transparent&component=proactive&collection=emoji_kitchen_v5&q=${encodeURIComponent(args[0])}`);
