...
*result:* ${x.result}`.trim()
    ...
    conn.reply(m.chat, caption, m, frep)
  }
  if (command === 'fotoduck') {
...
handler.command = handler.help = ['urlscan', 'fotoduck', 'fotobear', 'fotodog', 'fotodog2', 'fotodog3', 'fotofox',
  'fotoshibe', 'kitten', 'drinks', 'rules', 'say', 'repeat', 'repeat2', 'dmpsearch', 'dmpdown'
]
handler.tags = ['random']
