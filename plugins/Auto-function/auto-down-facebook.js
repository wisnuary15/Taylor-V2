...
*HD:* ${results.isHdAvailable}
	`
        ...
        m.react(wait)
        this.sendFile(m.chat, out, "", caption, m)
      } catch (e) {
        m.react(eror)
      }
    }
...
*Title:* ${results.title}`
        ...
        if (quality.toLowerCase() === "hd") {
          out = results.find(video => video.quality === "hd") ? results.find(video => video.quality === "hd") : (
            results.find(video => video.quality === "sd") ? results.find(video => video.quality === "sd") : giflogo)
        }
        if (quality.toLowerCase() === "sd") {
          out = results.find(video => video.quality === "sd") ? results.find(video => video.quality === "sd") : (
            results.find(video => video.quality === "hd") ? results.find(video => video.quality === "hd") : giflogo)
        }
        m.react(wait)
        this.sendFile(m.chat, out, "", caption, m)
      } catch (e) {
