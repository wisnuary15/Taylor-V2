...
`.trim();
    await conn.reply(m.chat, txt, m, {
      contextInfo: {
        ...
        externalAdReply: {
          title: "Daftar Terbanned",
          body: `Tanggal: ${botdate}\nWaktu: ${bottime}`,
          mediaType: 1,
          previewType: 0,
          renderLargerThumbnail: true,
          thumbnailUrl: "https://thumbs.dreamstime.com/z/user-accepted-deleted-icons-set-78373435.jpg?w=992",
          sourceUrl: ""
        }
      }
    });
    ...
    console.error(error);
    await conn.reply(m.chat, "❌ *Terjadi kesalahan:* Tidak dapat memuat daftar terbanned.", m);
  }
};
