  ...
  try {
    ...
    switch (command) {
      case "e621":
        ...
        break;
      case "gelbooru":
        result = new Search("gelbooru"), output = await result.search(text),
          m.reply(JSON.stringify(output, null, 4));
        break;
      case "rule34":
        result = new Search("rule34"), output = await result.search(text), m.reply(JSON.stringify(output, null, 4));
        break;
      case "danbooru":
        result = new Search("danbooru"), output = await result.search(text),
          m.reply(JSON.stringify(output, null, 4));
        break;
      case "konachan":
        result = new Search("konachan"), output = await result.search(text),
          m.reply(JSON.stringify(output, null, 4));
        break;
      case "konachan18":
        result = new Search("konachan18"), output = await result.search(text),
          m.reply(JSON.stringify(output, null, 4));
        break;
      case "hypnohub":
        result = new Search("hypnohub"), output = await result.search(text),
          m.reply(JSON.stringify(output, null, 4));
        break;
      case "xbooru":
        ...
        break;
      case "realbooru":
        result = new Search("realbooru"), output = await result.search(text),
          m.reply(JSON.stringify(output, null, 4));
        break;
      case "furrybooru":
        result = new Search("furrybooru"), output = await result.search(text),
          m.reply(JSON.stringify(output, null, 4));
    }
  } catch (error) {
    m.reply(error);
