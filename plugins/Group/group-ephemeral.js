...
const { WA_DEFAULT_EPHEMERAL: WA_DEFAULT_EPHEMERAL, groupToggleEphemeral: groupToggleEphemeral } = pkg, options = {
  on: WA_DEFAULT_EPHEMERAL,
  off: 0,
  "1d": 86400,
  "7d": 604800,
  "90d": 7776e3
}, handler = async (m, { conn: conn, text: text, usedPrefix: usedPrefix, isAdmin: isAdmin, isOwner: isOwner, command: command }) => {
