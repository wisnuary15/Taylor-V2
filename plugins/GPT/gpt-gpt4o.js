...
const handler = async (m, {
  ...
  m.react("wait");
  const providers = [aiService.fetchGPT4o.bind(aiService), aiService.fetchGPT4ov1.bind(aiService), aiService.fetchGPT4ov2.bind(aiService), aiService.fetchGPT4ov3.bind(aiService)];
