...
handler.help = ["chatgpt5free"], handler.tags = ["gpt"], handler.command = /^(chatgpt5free)$/i;
export default handler;
async function generate(q) {
  try {
    const response = await fetch("https://chatgpt5free.com/wp-json/mwai-ui/v1/chats/submit", {
      method: "POST",
      headers: {
