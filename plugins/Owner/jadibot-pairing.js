  ...
  async function reloadHandler(restartConn) {
    ...
    if (restartConn) {
      ...
      return connection = {
        ...
        connection.onDelete = handler.deleteUpdate.bind(connection), connection.connectionUpdate = connectionUpdate.bind(connection),
        connection.credsUpdate = saveCreds.bind(connection), connection.ev.on("messages.upsert", connection.handler),
