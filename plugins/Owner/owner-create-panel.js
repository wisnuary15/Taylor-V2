...
> Perintah :\n${_p + command} nomor/tag`);
      //let password
      let u = m.quoted ? m.quoted?.sender : t[0] ? t[0]?.replace(/[^0-9]/g, "") + "@s.whatsapp.net" : m
        .mentionedJid[0];
...
handler.help = ["addusr", "delusr", "listusr", "detusr", "addsrv", "delsrv", "listsrv", "detsrv", "reinstall",
  "updatesrv", "startsrv", "stopsrv", "restartsrv"
];
handler.command = ["addusr", "delusr", "listusr", "detusr", "addsrv", "delsrv", "listsrv", "detsrv", "reinstall",
  "updatesrv", "startsrv", "stopsrv", "restartsrv"
];
handler.tags = ["owner"]
handler.owner = true
