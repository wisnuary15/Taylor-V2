...
const handler = async (m, {
  ...
  if (!querys[0]) {
    ...
    m.reply(
      '*Format perintah tidak valid.* Gunakan "gp" untuk menampilkan list kategori, "gp 1" untuk menampilkan list file dalam kategori, atau "gp 1 2" untuk menjalankan operasi tertentu.'
      );
  }
}
