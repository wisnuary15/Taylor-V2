...
const handler = async (m, {
    ...
    if (!querys[0]) {
        ...
        m.reply('*Format perintah tidak valid.* Gunakan "df" untuk menampilkan list kategori, "df 1" untuk menampilkan list file dalam kategori, atau "df 1 2" untuk menjalankan operasi tertentu.');
    }
}
