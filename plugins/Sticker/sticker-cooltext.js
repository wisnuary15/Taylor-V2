...
const handler = async (m, {
  ...
  return m.reply("Input tidak valid. Gunakan format: " + usedPrefix +
  "cooltext [teks] | [style/id] | [indeks/URL]");
};
...
async function getImageUrl(textStyleId, text) {
  ...
  try {
    ...
    const body = [`LogoID=${textStyleId}`, `Text=${encodeURIComponent(text)}`, `FontSize=${FONT_SIZE}`,
      `FileFormat=6`, `Integer5=0`, `Integer7=0`, `Integer8=0`, `Integer6=0`, `Integer9=0`, `Integer13=on`,
      `Integer12=on`,
    ].join("&");
