...
const effects = ['greyscale', 'invert', 'brightness', 'threshold', 'sepia', 'red', 'green', 'blue', 'blurple',
  'pixelate', 'blur'
]
...
`.trim()
  ...
  try {
    ...
    conn.sendFile(m.chat, stiker, '', '', m, 0, {
      asSticker: true
    })
  } catch (e) {
    conn.sendFile(m.chat, apiUrl, 'image.png', null, m, 0, {
