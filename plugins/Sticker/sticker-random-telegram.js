...
const handler = async (m, {
  ...
  var list_input = ["awoawo", "chat", "dbfly", "dino-kuning", "doge", "gojosatoru", "hope-boy", "jisoo",
    "kawan-sponsbob", "kr-robot", "kucing", "lonte", "manusia-lidi", "menjamet", "meow", "nicholas", "patrick",
    "popoci", "sponsbob", "tyni"
  ]
