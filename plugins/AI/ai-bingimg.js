...
const handler = async (m, {
  ...
  try {
    const res = new BingImageCreator({
      cookie: "1SNnCuhjo5tbaHnBKjTgSzCW0j_M1OSnEOaAD7BjMX9qgjZl7p1KlLQx53ys5rVmuFZ4pacA3NQLHzlwZd71cBCWSPza76FQV6znG2TtkiZ00hoWKXCK0PYuLKDrabO6Kjmqs7lLUdU1RfckReddpY3ajmc5cU-QI2OIbD7IeE8ZlgcDUVQcyZiahXE7dLqj6lyfZBbmTKijtmyLKONFAbQ"
    });
    let data;
    try {
    ...
    const filteredData = data ? data.filter(file => file.startsWith("http") && !file.endsWith(".svg") && !file.endsWith(".js")) : [];
