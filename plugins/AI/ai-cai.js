...
function formatCharacterInfo(character) {
  const { title: title, name: name, visibility: visibility, greeting: greeting, avatar_file_name: avatar_file_name, participant__num_interactions: participant__num_interactions, user__username: user__username, priority: priority, search_score: search_score } = character;
...
function formatStatus(status) {
  const { version: version, cai_status: cai_status } = status;
