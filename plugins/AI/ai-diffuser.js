...
const handler = async (m, {
  ...
  const modelName = ["Daniil-plotnikov/realism-diffusion", "aipicasso/manga-diffusion-poc", "Envvi/Inkpunk-Diffusion", "tensor-diffusion/AsianRealistic_SDLife_ChiasedammeV9.0", "hakurei/waifu-diffusion", "nitrosocke/mo-di-diffusion", "nitrosocke/Ghibli-Diffusion"];
  ...
  try {
    ...
    const openAIResponse = await HuggingFaceBuffer(models, encodeURIComponent(query));
    if (openAIResponse) {
