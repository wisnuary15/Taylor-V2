  ...
  try {
    ...
    if (command === 'hcr') {
      ...
      if (!text) {
        ...
        const hcrList = ["stablediffusion15", "stablediffusion21", "stablediffusionXL", "pixartA", "pixartLcm",
          "dalle", "dalleMini", "prodia", "prodiaStablediffusion", "prodiaStablediffusionXL", "emi", "chatGPT",
          "chatComplements", "translate"
        ];
