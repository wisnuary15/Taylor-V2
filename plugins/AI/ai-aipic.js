...
handler.help = ["aipic", "aiflux", "flux1ai", "fluxpro", "animagine", "gen", "prodia", "prodiagen", "tensor", "aquarelle"];
handler.tags = ["ai"];
handler.command = /^(aipic|aiflux|flux1ai|fluxpro|animagine|gen|prodia|prodiagen|tensor|aquarelle)$/i;
