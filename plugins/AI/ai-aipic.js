...
handler.help = ["aipic", "aiflux", "flux1ai", "animagine", "gen", "prodia", "prodiagen", "tensor"];
handler.tags = ["ai"];
handler.command = /^(aipic|aiflux|flux1ai|animagine|gen|prodia|prodiagen|tensor)$/i;
