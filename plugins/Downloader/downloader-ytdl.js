const handler = async (m, {
  ...
  try {
    ...
    const buttons = conn.ctaButton.setBody(`📥 𝗬𝗧 𝗗𝗢𝗪𝗡𝗟𝗢𝗔𝗗𝗘𝗥\n\nᴩʟᴇᴀꜱᴇ ꜱᴇʟᴇᴄᴛ yᴏᴜʀ ᴍᴇᴅɪᴀ ᴛyᴩᴇ...`).setFooter(wm).addSelection("Click Here !").makeSections("Media Type", "Select Media Type");
