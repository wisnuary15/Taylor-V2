const handler = async (m, { conn: conn, args: args, usedPrefix: usedPrefix, command: command, isPrems: isPrems, isOwner: isOwner }) => {
...
handler.help = ["ytd"], handler.tags = ["downloader"], handler.command = /^ytd(mp[34]|[av])?$/i,
  handler.exp = 3;
