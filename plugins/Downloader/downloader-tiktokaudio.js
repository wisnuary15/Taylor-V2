...
const handler = async (m, {
    ...
    try {
        ...
        let url = `https://api.lolhuman.xyz/api/tiktokwm?apikey=${lolkey}&url=${args[0]}`
        let txt = `🚀 *Link:* ${await(await axios.get(`https://tinyurl.com/api-create.php?url=${args[0]}`)).data}`
        conn.sendFile(m.chat, `https://api.lolhuman.xyz/api/tiktokwm?apikey=${lolkey}&url=${args[0]}`, 'tiktokaudio.mp3', `
┏┉━━━━━━━━━━━❏
┆ *YOUTUBE MP3*
├┈┈┈┈┈┈┈┈┈┈┈
┆• *Judul:* 
...
`
        conn.sendFile(m.chat, cer.music.play_url, 'tiktokaudio.mp3', cap, m, null, {
            document: {
