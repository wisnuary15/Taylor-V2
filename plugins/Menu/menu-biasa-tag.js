    ...
    if (teks === "404") {
      ...
      switch (id) {
        ...
        case 10: {
          ...
          }).addReply("Menu List", _p + "menulist").addUrl("Official Group", sgc).addSelection(listMessage.buttonText).makeSections(listMessage.text, "").contextInfo({
        ...
        break;
        case 11: {
          const btn = conn.ctaButton.setBody(caption).setFooter(author).addReply("Menu List", _p + "menulist").addUrl("Official Group", sgc).contextInfo({
            ...[adReply.contextInfo, adReplyS.contextInfo].getRandom(),
            mentionedJid: [m.sender]
          });
          return await btn.run(m.chat, conn, m);
