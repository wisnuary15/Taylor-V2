...
const handler = async (m, { conn: conn, args: args, text: text, usedPrefix: usedPrefix, command: command }) => {
  let who = m.mentionedJid && m.mentionedJid[0] ? m.mentionedJid[0] : m.fromMe ? conn.user.jid : m.sender,
    urut = (await conn.getName(who),
      flaaa.getRandom(), text.split("|")),
    one = urut[1],
    two = urut[2],
    template = (urut[3],
      (args[0] || "").toLowerCase());
  ...
  try {
    if (command) switch (template) {
      case "listsurah":
        axios.get(`https://api.lolhuman.xyz/api/quran?apikey=${global.lolkey}`).then((async ({ data: data }) => {
          var teks = "List Surah:\n";
      ...
      case "alquran":
        ...
        axios.get(`https://api.lolhuman.xyz/api/quran/${one}?apikey=${global.lolkey}`).then((async ({ data: data }) => {
      ...
      case "alquranaudio":
        ...
        break;
      case "asmaulhusna":
        axios.get(`https://api.lolhuman.xyz/api/asmaulhusna?apikey=${global.lolkey}`).then((async ({ data: data }) => {
      ...
      case "kisahnabi":
        ...
        axios.get(`https://api.lolhuman.xyz/api/kisahnabi/${one}?apikey=${global.lolkey}`).then((async ({ data: data }) => {
      ...
      case "jadwalsholat":
        ...
        axios.get(`https://api.lolhuman.xyz/api/sholat/${one}?apikey=${global.lolkey}`).then((async ({ data: data }) => {
      ...
      case "ytplay":
        ...
        axios.get(`https://api.lolhuman.xyz/api/ytsearch?apikey=${global.lolkey}&query=${one}`).then((async ({ data: data }) => {
          axios.get(`https://api.lolhuman.xyz/api/ytaudio2?apikey=${global.lolkey}&url=https://www.youtube.com/watch?v=${data.result[0]?.videoId}`).then((async ({ data: data }) => {
      ...
      case "ytmp3":
        ...
        axios.get(`https://api.lolhuman.xyz/api/ytaudio2?apikey=${global.lolkey}&url=${one}`).then((async ({ data: data }) => {
          var caption = `❖ Title    : *${data.result.title}*\n`;
          caption += `❖ Size     : *${data.result.size}*`, conn.sendMessage(m.chat, {
            image: {
              url: data.result.thumbnail
      ...
      case "ytmp4":
        if (!one) return m.reply(`Example: ${usedPrefix + command} ${template} |https://www.youtube.com/watch?v=qZIQAk-BUEc`);
        axios.get(`https://api.lolhuman.xyz/api/ytmp4?apikey=${global.lolkey}&url=${one}`).then((async ({ data: data }) => {
          var caption = `❖ Title    : *${data.result.title}*\n`;
          caption += `❖ Size     : *${data.result.size}*`, conn.sendMessage(m.chat, {
            image: {
              url: data.result.thumbnail
      ...
      case "telesticker":
        ...
        axios.get(`https://api.lolhuman.xyz/api/telestick?apikey=${global.lolkey}&url=${one}`).then((async ({ data: data }) => {
          conn.sendMessage(m.chat, {
            sticker: {
      ...
      case "tiktoknowm":
        ...
        axios.get(`https://api.lolhuman.xyz/api/tiktok?apikey=${global.lolkey}&url=${one}`).then((async ({ data: data }) => {
          conn.sendMessage(m.chat, {
            video: {
              url: data.result.link
            },
      ...
      case "spotify":
        ...
        axios.get(`https://api.lolhuman.xyz/api/spotify?apikey=${global.lolkey}&url=${one}`).then((async ({ data: data }) => {
          var caption = `Title : ${data.result.title}\n`;
      ...
      case "spotifysearch":
        if (!one) return m.reply(`Example: ${usedPrefix + command} ${template} |Melukis Senja`);
        axios.get(`https://api.lolhuman.xyz/api/spotifysearch?apikey=${global.lolkey}&query=${one}`).then((async ({ data: data }) => {
          var teks = "";
      ...
      case "jooxplay":
        if (!one) return m.reply(`Example: ${usedPrefix + command} ${template} |Melukis Senja`);
        axios.get(`https://api.lolhuman.xyz/api/jooxplay?apikey=${global.lolkey}&query=${one}`).then((async ({ data: data }) => {
      ...
      case "igdl":
        ...
        axios.get(`https://api.lolhuman.xyz/api/instagram?apikey=${global.lolkey}&url=${one}`).then((async ({ data: data }) => {
          var url = data.result;
      ...
      case "igdl2":
        if (!one) return m.reply(`Example: ${usedPrefix + command} ${template} |https://www.instagram.com/p/CJ8XKFmJ4al/?igshid=1acpcqo44kgkn`);
        axios.get(`https://api.lolhuman.xyz/api/instagram2?apikey=${global.lolkey}&url=${one}`).then((async ({ data: data }) => {
      ...
      case "twtdl":
        ...
        axios.get(`https://api.lolhuman.xyz/api/twitter?apikey=${global.lolkey}&url=${one}`).then((async ({ data: data }) => {
          conn.sendMessage(m.chat, {
            video: {
      ...
      case "fbdl":
        ...
        axios.get(`https://api.lolhuman.xyz/api/facebook?apikey=${global.lolkey}&url=${one}`).then((async ({ data: data }) => {
          conn.sendMessage(m.chat, {
            video: {
              url: data.result
            },
      ...
      case "zippyshare":
        ...
        axios.get(`https://api.lolhuman.xyz/api/zippyshare?apikey=${global.lolkey}&url=${one}`).then((async ({ data: data }) => {
      ...
      case "pinterest":
        ...
        axios.get(`https://api.lolhuman.xyz/api/pinterest?apikey=${global.lolkey}&query=${one}`).then((async ({ data: data }) => {
          conn.sendMessage(m.chat, {
            image: {
              url: data.result
            }
      ...
      case "pinterest2":
        if (!one) return m.reply(`Example: ${usedPrefix + command} ${template} |loli kawaii`);
        axios.get(`https://api.lolhuman.xyz/api/pinterest2?apikey=${global.lolkey}&query=${one}`).then((async ({ data: data }) => {
      ...
      case "pinterestdl":
        ...
        axios.get(`https://api.lolhuman.xyz/api/pinterestdl?apikey=${global.lolkey}&url=${one}`).then((async ({ data: data }) => {
          conn.sendMessage(m.chat, {
            image: {
              url: data.result[0]
            }
      ...
      case "character":
        ...
        axios.get(`https://api.lolhuman.xyz/api/character?apikey=${global.lolkey}&query=${one}`).then((async ({ data: data }) => {
      ...
      case "manga":
        ...
        axios.get(`https://api.lolhuman.xyz/api/manga?apikey=${global.lolkey}&query=${one}`).then((async ({ data: data }) => {
          var caption = `Id : ${data.result.id}\n`;
      ...
      case "anime":
        if (!one) return m.reply(`Example: ${usedPrefix + command} ${template} |Gotoubun No Hanayome`);
        axios.get(`https://api.lolhuman.xyz/api/anime?apikey=${global.lolkey}&query=${one}`).then((async ({ data: data }) => {
          var caption = `Id : ${data.result.id}\n`;
          for (var x of (caption += `Id MAL : ${data.result.idMal}\n`, caption += `Title : ${data.result.title.romaji}\n`,
              caption += `English : ${data.result.title.english}\n`, caption += `Native : ${data.result.title.native}\n`,
      ...
      case "kusonime":
        ...
        axios.get(`https://api.lolhuman.xyz/api/kusonime?apikey=${global.lolkey}&url=${one}`).then((async ({ data: data }) => {
          var caption = `Title : ${data.result.title}\n`;
      ...
      case "kusonimesearch":
        if (!one) return m.reply(`Example: ${usedPrefix + command} ${template} |Gotoubun No Hanayome`);
        axios.get(`https://api.lolhuman.xyz/api/kusonimesearch?apikey=${global.lolkey}&query=${one}`).then((async ({ data: data }) => {
          var caption = `Title : ${data.result.title}\n`;
          for (var x in caption += `Japanese : ${data.result.japanese}\n`, caption += `Genre : ${data.result.genre}\n`,
              caption += `Seasons : ${data.result.seasons}\n`, caption += `Producers : ${data.result.producers}\n`,
              caption += `Type : ${data.result.type}\n`, caption += `Status : ${data.result.status}\n`,
      ...
      case "otakudesu":
        ...
        axios.get(`https://api.lolhuman.xyz/api/otakudesu?apikey=${global.lolkey}&url=${one}`).then((async ({ data: data }) => {
      ...
      case "otakudesusearch":
        if (!one) return m.reply(`Example: ${usedPrefix + command} ${template} |Gotoubun No Hanayome`);
        axios.get(`https://api.lolhuman.xyz/api/otakudesusearch?apikey=${global.lolkey}&query=${one}`).then((async ({ data: data }) => {
          var teks = `Title : ${data.result.title}\n`;
          for (var x in teks += `Japanese : ${data.result.japanese}\n`, teks += `Judul : ${data.result.judul}\n`,
              teks += `Type : ${data.result.type}\n`, teks += `Episode : ${data.result.episodes}\n`,
              teks += `Aired : ${data.result.aired}\n`, teks += `Producers : ${data.result.producers}\n`,
      ...
      case "kbbi":
        ...
        var { data: data } = await axios.get(`https://api.lolhuman.xyz/api/kbbi?apikey=${global.lolkey}&query=${one}`), teks = `\`\`\`Kata : ${data.result[0]?.nama}\`\`\`\n`;
      ...
      case "brainly":
        ...
        var { data: data } = await axios.get(`https://api.lolhuman.xyz/api/brainly?apikey=${global.lolkey}&query=${one}`);
      ...
      case "jarak":
        ...
        var { data: data } = await axios.get(`https://api.lolhuman.xyz/api/jaraktempuh?apikey=${global.lolkey}&kota1=${one}&kota2=${two}`);
      ...
      case "urbandictionary":
        var { data: data } = await axios.get(`http://api.lolhuman.xyz/api/urdict?apikey=${global.lolkey}&query=${one}`);
      ...
      case "chord":
        if (!one) return m.reply(`Example: ${usedPrefix + command} ${template} |Melukis senja`);
        var { data: data } = await axios.get(`https://api.lolhuman.xyz/api/chord?apikey=${global.lolkey}&query=${one}`);
      ...
      case "heroml":
        ...
        var { data: data } = await axios.get(`https://api.lolhuman.xyz/api/heroml/${one}?apikey=${global.lolkey}`), caption = `Name : ${data.result.hero_name}\n`;
      ...
      case "mlstalk":
        ...
        var { data: data } = await axios.get(`https://api.lolhuman.xyz/api/mobilelegend/${one}?apikey=${global.lolkey}`);
        m.reply(data.result);
        break;
      case "genshin":
        if (!one) return m.reply(`Example: ${usedPrefix + command} ${template} |jean`);
        var { data: data } = await axios.get(`https://api.lolhuman.xyz/api/genshin/${one}?apikey=${global.lolkey}`);
      ...
      case "wikipedia":
        ...
        var { data: data } = await axios.get(`https://api.lolhuman.xyz/api/wiki?apikey=${global.lolkey}&query=${one}`);
        m.reply(data.result);
        break;
      case "translate":
        if (!one) return m.reply(`Example: ${usedPrefix + command} ${template} |en|Tahu Bacem`);
        var { data: data } = await axios.get(`https://api.lolhuman.xyz/api/translate/auto/${one}?apikey=${global.lolkey}&text=${two}`);
      ...
      case "jadwaltv":
        ...
        var { data: data } = await axios.get(`https://api.lolhuman.xyz/api/jadwaltv/${one}?apikey=${global.lolkey}`);
        teks = `Jadwal TV ${args[0]?.toUpperCase()}\n`;
        for (var x in data.result) teks += `${x} - ${data.result[x]}\n`;
        await conn.reply(m.chat, teks, m);
        break;
      case "jadwaltvnow":
        var { data: data } = await axios.get(`https://api.lolhuman.xyz/api/jadwaltv/now?apikey=${global.lolkey}`);
        teks = "Jadwal TV Now :\n";
        for (var x in data.result) teks += `${x.toUpperCase()}${data.result[x]}\n\n`;
        await conn.reply(m.chat, teks, m);
        break;
      case "newsinfo":
        var { data: data } = await axios.get(`https://api.lolhuman.xyz/api/newsinfo?apikey=${global.lolkey}`);
        teks = "Result :\n";
        for (var x of data.result) teks += `Title : ${x.title}\n`, teks += `Author : ${x.author}\n`,
        ...
        break;
      case "cnnindonesia":
        var { data: data } = await axios.get(`https://api.lolhuman.xyz/api/cnnindonesia?apikey=${global.lolkey}`);
        teks = "Result :\n";
        ...
        break;
      case "cnnnasional":
        var { data: data } = await axios.get(`https://api.lolhuman.xyz/api/cnnindonesia/nasional?apikey=${global.lolkey}`);
        teks = "Result :\n";
        for (var x of data.result) teks += `Judul : ${x.judul}\n`, teks += `Link : ${x.link}\n`,
          teks += `Tipe : ${x.tipe}\n`, teks += `Published : ${x.waktu}\n\n`;
        await conn.reply(m.chat, teks, m);
      ...
      case "cnninternasional":
        var { data: data } = await axios.get(`https://api.lolhuman.xyz/api/cnnindonesia/internasional?apikey=${global.lolkey}`);
        teks = "Result :\n";
        for (var x of data.result) teks += `Judul : ${x.judul}\n`, teks += `Link : ${x.link}\n`,
          teks += `Tipe : ${x.tipe}\n`, teks += `Published : ${x.waktu}\n\n`;
        await conn.reply(m.chat, teks, m);
        break;
      case "infogempa":
        var { data: data } = await axios.get(`https://api.lolhuman.xyz/api/infogempa?apikey=${global.lolkey}`);
      ...
      case "lirik":
        if (!one) return m.reply(`Example: ${usedPrefix + command} ${template} |Melukis Senja`);
        var { data: data } = await axios.get(`https://api.lolhuman.xyz/api/lirik?apikey=${global.lolkey}&query=${one}`);
        m.reply(data.result);
        break;
      case "cuaca":
        if (!one) return m.reply(`Example: ${usedPrefix + command} ${template} |Yogyakarta`);
        var { data: data } = await axios.get(`https://api.lolhuman.xyz/api/cuaca/${one}?apikey=${global.lolkey}`);
        ...
        break;
      case "covidindo":
        var { data: data } = await axios.get(`https://api.lolhuman.xyz/api/corona/indonesia?apikey=${global.lolkey}`);
        ...
        break;
      case "covidglobal":
        var { data: data } = await axios.get(`https://api.lolhuman.xyz/api/corona/global?apikey=${global.lolkey}`);
        teks = `Positif : ${data.result.positif}\n`;
        teks += `Sembuh : ${data.result.sembuh}\n`, teks += `Dirawat : ${data.result.dirawat}\n`,
          teks += `Meninggal : ${data.result.meninggal}`, await conn.reply(m.chat, teks, m);
        break;
      case "kodepos":
        ...
        var { data: data } = await axios.get(`https://api.lolhuman.xyz/api/kodepos?apikey=${global.lolkey}&query=${one}`);
        ...
        break;
      case "jadwalbola":
        var { data: data } = await axios.get(`https://api.lolhuman.xyz/api/jadwalbola?apikey=${global.lolkey}`);
        teks = "Jadwal Bola :\n";
        ...
        break;
      case "indbeasiswa":
        var { data: data } = await axios.get(`https://api.lolhuman.xyz/api/indbeasiswa?apikey=${global.lolkey}`);
        teks = "Info Beasiswa :\n";
        for (var x of data.result) teks += `Title : ${x.title}\n`, teks += `Link : ${x.link}\n\n`;
        await conn.reply(m.chat, teks, m);
        break;
      case "hoax":
        var { data: data } = await axios.get(`https://api.lolhuman.xyz/api/turnbackhoax?apikey=${global.lolkey}`);
        teks = "Info Hoax :\n";
        for (var x of data.result) teks += `Title : ${x.title}\n`, teks += `Link : ${x.link}\n`,
      ...
      case "lk21":
        ...
        var { data: data } = await axios.get(`https://api.lolhuman.xyz/api/lk21?apikey=${global.lolkey}&query=${one}`);
        ...
        break;
      case "drakorongoing":
        var { data: data } = await axios.get(`https://api.lolhuman.xyz/api/drakorongoing?apikey=${global.lolkey}`);
        teks = "Ongoing Drakor\n\n";
        for (var x of data.result) teks += `Title : ${x.title}\n`, teks += `Link : ${x.link}\n`,
      ...
      case "wattpad":
        ...
        var { data: data } = await axios.get(`https://api.lolhuman.xyz/api/wattpad?apikey=${global.lolkey}&url=${one}`);
        caption = `Title : ${data.result.title}\n`;
      ...
      case "wattpadsearch":
        ...
        var { data: data } = await axios.get(`https://api.lolhuman.xyz/api/wattpadsearch?apikey=${global.lolkey}&query=${one}`);
        teks = "Wattpad Seach : \n";
        for (var x of data.result) teks += `Title : ${x.title}\n`, teks += `Url : ${x.url}\n`,
        ...
        break;
      case "cerpen":
        var { data: data } = await axios.get(`https://api.lolhuman.xyz/api/cerpen?apikey=${global.lolkey}`);
        teks = `Title : ${data.result.title}\n`;
        teks += `Creator : ${data.result.creator}\n`, teks += `Story :\n${data.result.cerpen}`,
          await conn.reply(m.chat, teks, m);
        break;
      case "ceritahoror":
        var { data: data } = await axios.get(`https://api.lolhuman.xyz/api/ceritahoror?apikey=${global.lolkey}`);
        caption = `Title : ${data.result.title}\n`;
        caption += `Desc : ${data.result.desc}\n`, caption += `Story :\n${data.result.story}\n`,
          conn.sendMessage(m.chat, {
            image: {
      ...
      case "gimage2":
        if (!one) return m.reply(`Example: ${usedPrefix + command} ${template} |loli kawaii`);
        axios.get(`https://api.lolhuman.xyz/api/gimage2?apikey=${global.lolkey}&query=${one}`).then((async ({ data: data }) => {
          for (var x of data.result.slice(0, 5)) conn.sendMessage(m.chat, {
            image: {
              url: x
            }
      ...
      case "wallpapersearch2":
        if (!one) return m.reply(`Example: ${usedPrefix + command} ${template} |loli kawaii`);
        axios.get(`https://api.lolhuman.xyz/api/wallpaper2?apikey=${global.lolkey}&query=${one}`).then((async ({ data: data }) => {
          conn.sendMessage(m.chat, {
            image: {
              url: data.result
            }
      ...
      case "playstore":
        ...
        var { data: data } = await axios.get(`https://api.lolhuman.xyz/api/playstore?apikey=${global.lolkey}&query=${one}`);
      ...
      case "shopee":
        ...
        var { data: data } = await axios.get(`https://api.lolhuman.xyz/api/shopee?apikey=${global.lolkey}&query=${one}`);
        teks = "Shopee Search : \n";
      ...
      case "google":
        if (!one) return m.reply(`Example: ${usedPrefix + command} ${template} |loli kawaii`);
        var { data: data } = await axios.get(`https://api.lolhuman.xyz/api/gsearch?apikey=${global.lolkey}&query=${one}`);
        teks = "Google Search : \n";
        for (var x of data.result) teks += `Title : ${x.title}\n`, teks += `Link : ${x.link}\n`,
          teks += `Desc : ${x.desc}\n\n`;
        await conn.reply(m.chat, teks, m);
        break;
      case "quotes":
        var { data: data } = await axios.get(`https://api.lolhuman.xyz/api/random/quotes?apikey=${global.lolkey}`);
        m.reply(`_${data.result.quote}_\n\n*― ${data.result.by}*`);
        break;
      case "quotesanime":
        var { data: data } = await axios.get(`https://api.lolhuman.xyz/api/random/quotesnime?apikey=${global.lolkey}`);
      ...
      case "pantun":
      case "bucin":
        var { data: data } = await axios.get(`https://api.lolhuman.xyz/api/random/${teks}?apikey=${global.lolkey}`);
        m.reply(data.result);
        break;
      case "randomnama":
        var { data: data } = await axios.get(`https://api.lolhuman.xyz/api/random/nama?apikey=${global.lolkey}`);
        m.reply(data.result);
        break;
      case "asupan":
        axios.get(`https://api.lolhuman.xyz/api/asupan?apikey=${global.lolkey}`).then((async ({ data: data }) => {
          conn.sendMessage(m.chat, {
            video: {
              url: data.result
            },
      ...
      case "artinama":
        ...
        axios.get(`https://api.lolhuman.xyz/api/artinama?apikey=${global.lolkey}&nama=${one}`).then((async ({ data: data }) => {
          m.reply(data.result);
        }));
        break;
      case "jodoh":
        if (!one) return m.reply(`Example: ${usedPrefix + command} ${template} |Tahu|Bacem`);
        axios.get(`https://api.lolhuman.xyz/api/jodoh/${one}/${two}?apikey=${global.lolkey}`).then((async ({ data: data }) => {
      ...
      case "weton":
        ...
        axios.get(`https://api.lolhuman.xyz/api/weton/${args[1]}/${args[2]}/${args[3]}?apikey=${global.lolkey}`).then((async ({ data: data }) => {
      ...
      case "jadian":
        if (!args[1]) return m.reply(`Example: ${usedPrefix + command} ${template} |12 12 2020`);
        axios.get(`https://api.lolhuman.xyz/api/jadian/${args[1]}/${args[2]}/${args[3]}?apikey=${global.lolkey}`).then((async ({ data: data }) => {
      ...
      case "tebakumur":
        if (!one) return m.reply(`Example: ${usedPrefix + command} ${template} |Taylor MD`);
        axios.get(`https://api.lolhuman.xyz/api/tebakumur?apikey=${global.lolkey}&name=${one}`).then((async ({ data: data }) => {
      ...
      case "stalkig":
        ...
        axios.get(`https://api.lolhuman.xyz/api/stalkig/${one}?apikey=${global.lolkey}`).then((async ({ data: data }) => {
      ...
      case "stalkgithub":
        ...
        axios.get(`https://api.lolhuman.xyz/api/github/${one}?apikey=${global.lolkey}`).then((async ({ data: data }) => {
      ...
      case "stalktwitter":
        ...
        axios.get(`https://api.lolhuman.xyz/api/twitter/${one}?apikey=${global.lolkey}`).then((async ({ data: data }) => {
      ...
      case "stalktiktok":
        ...
        axios.get(`https://api.lolhuman.xyz/api/stalktiktok/${one}?apikey=${global.lolkey}`).then((async ({ data: data }) => {
          var caption = `Username : ${data.result.username}\n`;
      ...
      case "shortlink":
        if (!one) return m.reply(`Example: ${usedPrefix + command} ${template} |https://api.lolhuman.xyz`);
        axios.get(`https://api.lolhuman.xyz/api/ouoshortlink?apikey=${global.lolkey}&url=${one}`).then((async ({ data: data }) => {
          m.reply(data.result);
        }));
        break;
      case "art":
