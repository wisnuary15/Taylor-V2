  ...
  try {
    if (command) {
      switch (template) {
        // Islami //
        case 'listsurah':
          axios.get(`https://api.lolhuman.xyz/api/quran?apikey=${global.lolkey}`).then(({
            data
          }) => {
            var teks = 'List Surah:\n'
          ...
          break
        case 'alquran':
          if (!one) return m.reply(
            `Example: ${usedPrefix + command} ${template} |18 or ${usedPrefix + command} ${template} |18/10 or ${usedPrefix + command} ${template} |18/1-10`
            )
          axios.get(`https://api.lolhuman.xyz/api/quran/${one}?apikey=${global.lolkey}`).then(({
            data
          }) => {
        ...
        case 'alquranaudio':
          if (!one) return m.reply(
            `Example: ${usedPrefix + command} ${template} |18 or ${usedPrefix + command} ${template} |18/10`)
          conn.sendMessage(m.chat, {
            audio: {
              url: `https://api.lolhuman.xyz/api/quran/audio/${one}?apikey=${global.lolkey}`
            },
            mimetype: 'audio/mp4'
          })
          break
        case 'asmaulhusna':
          axios.get(`https://api.lolhuman.xyz/api/asmaulhusna?apikey=${global.lolkey}`).then(({
            data
          }) => {
        ...
        case 'kisahnabi':
          ...
          axios.get(`https://api.lolhuman.xyz/api/kisahnabi/${one}?apikey=${global.lolkey}`).then(({
            data
          }) => {
        ...
        case 'jadwalsholat':
          ...
          axios.get(`https://api.lolhuman.xyz/api/sholat/${one}?apikey=${global.lolkey}`).then(({
            data
          }) => {
        ...
        case 'ytplay':
          ...
          axios.get(`https://api.lolhuman.xyz/api/ytsearch?apikey=${global.lolkey}&query=${one}`).then(({
            data
          }) => {
            axios.get(
              `https://api.lolhuman.xyz/api/ytaudio2?apikey=${global.lolkey}&url=https://www.youtube.com/watch?v=${data.result[0]?.videoId}`
              ).then(({
              data
            }) => {
        ...
        case 'ytmp3':
          if (!one) return m.reply(
            `Example: ${usedPrefix + command} ${template} |https://www.youtube.com/watch?v=qZIQAk-BUEc`)
          axios.get(`https://api.lolhuman.xyz/api/ytaudio2?apikey=${global.lolkey}&url=${one}`).then(({
            data
          }) => {
            var caption = `❖ Title    : *${data.result.title}*\n`
            caption += `❖ Size     : *${data.result.size}*`
        ...
        case 'ytmp4':
          if (!one) return m.reply(
            `Example: ${usedPrefix + command} ${template} |https://www.youtube.com/watch?v=qZIQAk-BUEc`)
          axios.get(`https://api.lolhuman.xyz/api/ytmp4?apikey=${global.lolkey}&url=${one}`).then(({
            data
          }) => {
            var caption = `❖ Title    : *${data.result.title}*\n`
            caption += `❖ Size     : *${data.result.size}*`
        ...
        case 'telesticker':
          if (!one) return m.reply(
            `Example: ${usedPrefix + command} ${template} |https://t.me/addstickers/LINE_Menhera_chan_ENG`)
          axios.get(`https://api.lolhuman.xyz/api/telestick?apikey=${global.lolkey}&url=${one}`).then(({
            data
          }) => {
            conn.sendMessage(m.chat, {
              sticker: {
        ...
        case 'tiktoknowm':
          ...
          axios.get(`https://api.lolhuman.xyz/api/tiktok?apikey=${global.lolkey}&url=${one}`).then(({
            data
          }) => {
            conn.sendMessage(m.chat, {
              video: {
        ...
        case 'tiktokmusic':
          ...
          conn.sendMessage(m.chat, {
            audio: {
              url: `https://api.lolhuman.xyz/api/tiktokmusic?apikey=${global.lolkey}&url=${one}`
            },
            mimetype: 'audio/mp4',
            fileName: `${data.result.title}.mp3`,
            ptt: true
        ...
        case 'spotify':
          if (!one) return m.reply(
            `Example: ${usedPrefix + command} ${template} |https://open.spotify.com/track/0ZEYRVISCaqz5yamWZWzaA`
            )
          axios.get(`https://api.lolhuman.xyz/api/spotify?apikey=${global.lolkey}&url=${one}`).then(({
            data
          }) => {
            var caption = `Title : ${data.result.title}\n`
        ...
        case 'spotifysearch':
          if (!one) return m.reply(`Example: ${usedPrefix + command} ${template} |Melukis Senja`)
          axios.get(`https://api.lolhuman.xyz/api/spotifysearch?apikey=${global.lolkey}&query=${one}`).then(({
            data
          }) => {
            var teks = ''
            for (var x of data.result) {
        ...
        case 'jooxplay':
          if (!one) return m.reply(`Example: ${usedPrefix + command} ${template} |Melukis Senja`)
          axios.get(`https://api.lolhuman.xyz/api/jooxplay?apikey=${global.lolkey}&query=${one}`).then(({
            data
          }) => {
        ...
        case 'igdl':
          if (!one) return m.reply(
            `Example: ${usedPrefix + command} ${template} |https://www.instagram.com/p/CJ8XKFmJ4al/?igshid=1acpcqo44kgkn`
            )
          axios.get(`https://api.lolhuman.xyz/api/instagram?apikey=${global.lolkey}&url=${one}`).then(({
            data
          }) => {
            var url = data.result
            if (url.includes('.mp4')) {
        ...
        case 'igdl2':
          ...
          axios.get(`https://api.lolhuman.xyz/api/instagram2?apikey=${global.lolkey}&url=${one}`).then(({
            data
          }) => {
            for (var x of data.result) {
              if (x.includes('.mp4')) {
        ...
        case 'twtdl':
          if (!one) return m.reply(
            `Example: ${usedPrefix + command} ${template} |https://twitter.com/gofoodindonesia/status/1229369819511709697`
            )
          axios.get(`https://api.lolhuman.xyz/api/twitter?apikey=${global.lolkey}&url=${one}`).then(({
            data
          }) => {
            conn.sendMessage(m.chat, {
              video: {
        ...
        case 'fbdl':
          if (!one) return m.reply(
            `Example: ${usedPrefix + command} ${template} |https://id-id.facebook.com/SamsungGulf/videos/video-bokeh/561108457758458/`
            )
          axios.get(`https://api.lolhuman.xyz/api/facebook?apikey=${global.lolkey}&url=${one}`).then(({
            data
          }) => {
            conn.sendMessage(m.chat, {
              video: {
        ...
        case 'zippyshare':
          if (!one) return m.reply(
            `Example: ${usedPrefix + command} ${template} |https://www51.zippyshare.com/v/5W0TOBz1/file.html`)
          axios.get(`https://api.lolhuman.xyz/api/zippyshare?apikey=${global.lolkey}&url=${one}`).then(({
            data
          }) => {
        ...
        case 'pinterest':
          ...
          axios.get(`https://api.lolhuman.xyz/api/pinterest?apikey=${global.lolkey}&query=${one}`).then(({
            data
          }) => {
            conn.sendMessage(m.chat, {
              image: {
        ...
        case 'pinterest2':
          if (!one) return m.reply(`Example: ${usedPrefix + command} ${template} |loli kawaii`)
          axios.get(`https://api.lolhuman.xyz/api/pinterest2?apikey=${global.lolkey}&query=${one}`).then(({
            data
          }) => {
        ...
        case 'pinterestdl':
          if (!one) return m.reply(
            `Example: ${usedPrefix + command} ${template} |https://id.pinterest.com/pin/696580267364426905/`)
          axios.get(`https://api.lolhuman.xyz/api/pinterestdl?apikey=${global.lolkey}&url=${one}`).then(({
            data
          }) => {
            conn.sendMessage(m.chat, {
              image: {
        ...
        case 'pixiv':
          ...
          conn.sendMessage(m.chat, {
            image: {
              url: `https://api.lolhuman.xyz/api/pixiv?apikey=${global.lolkey}&query=${one}`
            }
          })
          break
        case 'pixivdl':
          ...
          conn.sendMessage(m.chat, {
            image: {
              url: `https://api.lolhuman.xyz/api/pixivdl/${one}?apikey=${global.lolkey}`
            }
          })
          break
          // AniManga //
        case 'character':
          ...
          axios.get(`https://api.lolhuman.xyz/api/character?apikey=${global.lolkey}&query=${one}`).then(({
            data
          }) => {
        ...
        case 'manga':
          ...
          axios.get(`https://api.lolhuman.xyz/api/manga?apikey=${global.lolkey}&query=${one}`).then(({
            data
          }) => {
            var caption = `Id : ${data.result.id}\n`
            ...
            caption +=
              `Start Date : ${data.result.startDate.day} - ${data.result.startDate.month} - ${data.result.startDate.year}\n`
            caption +=
              `End Date : ${data.result.endDate.day} - ${data.result.endDate.month} - ${data.result.endDate.year}\n`
        ...
        case 'anime':
          if (!one) return m.reply(`Example: ${usedPrefix + command} ${template} |Gotoubun No Hanayome`)
          axios.get(`https://api.lolhuman.xyz/api/anime?apikey=${global.lolkey}&query=${one}`).then(({
            data
          }) => {
            var caption = `Id : ${data.result.id}\n`
            caption += `Id MAL : ${data.result.idMal}\n`
        ...
        case 'kusonime':
          if (!one) return m.reply(
            `Example: ${usedPrefix + command} ${template} |https://kusonime.com/nanatsu-no-taizai-bd-batch-subtitle-indonesia/`
            )
          axios.get(`https://api.lolhuman.xyz/api/kusonime?apikey=${global.lolkey}&url=${one}`).then(({
            data
          }) => {
            var caption = `Title : ${data.result.title}\n`
        ...
        case 'kusonimesearch':
          if (!one) return m.reply(`Example: ${usedPrefix + command} ${template} |Gotoubun No Hanayome`)
          axios.get(`https://api.lolhuman.xyz/api/kusonimesearch?apikey=${global.lolkey}&query=${one}`).then(({
            data
          }) => {
            var caption = `Title : ${data.result.title}\n`
            caption += `Japanese : ${data.result.japanese}\n`
        ...
        case 'otakudesu':
          if (!one) return m.reply(
            `Example: ${usedPrefix + command} ${template} |https://otakudesu.tv/lengkap/pslcns-sub-indo/`)
          axios.get(`https://api.lolhuman.xyz/api/otakudesu?apikey=${global.lolkey}&url=${one}`).then(({
            data
          }) => {
        ...
        case 'otakudesusearch':
          if (!one) return m.reply(`Example: ${usedPrefix + command} ${template} |Gotoubun No Hanayome`)
          axios.get(`https://api.lolhuman.xyz/api/otakudesusearch?apikey=${global.lolkey}&query=${one}`).then(({
            data
          }) => {
            var teks = `Title : ${data.result.title}\n`
            teks += `Japanese : ${data.result.japanese}\n`
        ...
        case 'kbbi':
          ...
          var {
            data
          } = await axios.get(`https://api.lolhuman.xyz/api/kbbi?apikey=${global.lolkey}&query=${one}`)
        ...
        case 'brainly':
          ...
          var {
            data
          } = await axios.get(`https://api.lolhuman.xyz/api/brainly?apikey=${global.lolkey}&query=${one}`)
        ...
        case 'jarak':
          ...
          var {
            ...
            `https://api.lolhuman.xyz/api/jaraktempuh?apikey=${global.lolkey}&kota1=${one}&kota2=${two}`)
        ...
        case 'urbandictionary':
          var {
            data
          } = await axios.get(`http://api.lolhuman.xyz/api/urdict?apikey=${global.lolkey}&query=${one}`)
          for (var x of data.result) {
            var teks = `\`\`\`Meaning :\n${x.definition}\`\`\`\n\n`
        ...
        case 'chord':
          ...
          var {
            data
          } = await axios.get(`https://api.lolhuman.xyz/api/chord?apikey=${global.lolkey}&query=${one}`)
          var teks = `Title : ${data.result.title}\n`
          teks += `Chord : \n${data.result.chord}`
          conn.reply(m.chat, teks, m)
          break
        case 'heroml':
          ...
          var {
            data
          } = await axios.get(`https://api.lolhuman.xyz/api/heroml/${one}?apikey=${global.lolkey}`)
        ...
        case 'mlstalk':
          ...
          var {
            data
          } = await axios.get(`https://api.lolhuman.xyz/api/mobilelegend/${one}?apikey=${global.lolkey}`)
          m.reply(data.result)
          break
        case 'genshin':
          ...
          var {
            data
          } = await axios.get(`https://api.lolhuman.xyz/api/genshin/${one}?apikey=${global.lolkey}`)
        ...
        case 'wikipedia':
          ...
          var {
            data
          } = await axios.get(`https://api.lolhuman.xyz/api/wiki?apikey=${global.lolkey}&query=${one}`)
          m.reply(data.result)
          break
        case 'translate':
          ...
          var {
            ...
            `https://api.lolhuman.xyz/api/translate/auto/${one}?apikey=${global.lolkey}&text=${two}`)
        ...
        case 'jadwaltv':
          ...
          var {
            data
          } = await axios.get(`https://api.lolhuman.xyz/api/jadwaltv/${one}?apikey=${global.lolkey}`)
        ...
        case 'jadwaltvnow':
          var {
            data
          } = await axios.get(`https://api.lolhuman.xyz/api/jadwaltv/now?apikey=${global.lolkey}`)
        ...
        case 'newsinfo':
          var {
            data
          } = await axios.get(`https://api.lolhuman.xyz/api/newsinfo?apikey=${global.lolkey}`)
          var teks = 'Result :\n'
          for (var x of data.result) {
            teks += `Title : ${x.title}\n`
            teks += `Author : ${x.author}\n`
        ...
        case 'cnnindonesia':
          var {
            data
          } = await axios.get(`https://api.lolhuman.xyz/api/cnnindonesia?apikey=${global.lolkey}`)
          var teks = 'Result :\n'
          for (var x of data.result) {
            teks += `Judul : ${x.judul}\n`
            teks += `Link : ${x.link}\n`
        ...
        case 'cnnnasional':
          var {
            data
          } = await axios.get(`https://api.lolhuman.xyz/api/cnnindonesia/nasional?apikey=${global.lolkey}`)
          var teks = 'Result :\n'
          for (var x of data.result) {
            teks += `Judul : ${x.judul}\n`
            teks += `Link : ${x.link}\n`
        ...
        case 'cnninternasional':
          var {
            data
          } = await axios.get(`https://api.lolhuman.xyz/api/cnnindonesia/internasional?apikey=${global.lolkey}`)
          var teks = 'Result :\n'
          for (var x of data.result) {
            teks += `Judul : ${x.judul}\n`
            teks += `Link : ${x.link}\n`
        ...
        case 'infogempa':
          var {
            data
          } = await axios.get(`https://api.lolhuman.xyz/api/infogempa?apikey=${global.lolkey}`)
        ...
        case 'lirik':
          ...
          var {
            data
          } = await axios.get(`https://api.lolhuman.xyz/api/lirik?apikey=${global.lolkey}&query=${one}`)
          m.reply(data.result)
          break
        case 'cuaca':
          if (!one) return m.reply(`Example: ${usedPrefix + command} ${template} |Yogyakarta`)
          var {
            data
          } = await axios.get(`https://api.lolhuman.xyz/api/cuaca/${one}?apikey=${global.lolkey}`)
        ...
        case 'covidindo':
          var {
            data
          } = await axios.get(`https://api.lolhuman.xyz/api/corona/indonesia?apikey=${global.lolkey}`)
        ...
        case 'covidglobal':
          var {
            data
          } = await axios.get(`https://api.lolhuman.xyz/api/corona/global?apikey=${global.lolkey}`)
          var teks = `Positif : ${data.result.positif}\n`
          teks += `Sembuh : ${data.result.sembuh}\n`
          teks += `Dirawat : ${data.result.dirawat}\n`
          teks += `Meninggal : ${data.result.meninggal}`
        ...
        case 'kodepos':
          if (!one) return m.reply(
            `Example: ${usedPrefix + command} ${template} |Slemanan or ${usedPrefix + command} ${template} |66154`
            )
          var {
            data
          } = await axios.get(`https://api.lolhuman.xyz/api/kodepos?apikey=${global.lolkey}&query=${one}`)
        ...
        case 'jadwalbola':
          var {
            data
          } = await axios.get(`https://api.lolhuman.xyz/api/jadwalbola?apikey=${global.lolkey}`)
        ...
        case 'indbeasiswa':
          var {
            data
          } = await axios.get(`https://api.lolhuman.xyz/api/indbeasiswa?apikey=${global.lolkey}`)
        ...
        case 'hoax':
          var {
            data
          } = await axios.get(`https://api.lolhuman.xyz/api/turnbackhoax?apikey=${global.lolkey}`)
          var teks = 'Info Hoax :\n'
          for (var x of data.result) {
            teks += `Title : ${x.title}\n`
            teks += `Link : ${x.link}\n`
        ...
        case 'lk21':
          ...
          var {
            data
          } = await axios.get(`https://api.lolhuman.xyz/api/lk21?apikey=${global.lolkey}&query=${one}`)
          var caption = `Title : ${data.result.title}\n`
        ...
        case 'drakorongoing':
          var {
            data
          } = await axios.get(`https://api.lolhuman.xyz/api/drakorongoing?apikey=${global.lolkey}`)
        ...
        case 'wattpad':
          if (!one) return m.reply(
            `Example: ${usedPrefix + command} ${template} |https://www.wattpad.com/707367860-kumpulan-quote-tere-liye-tere-liye-quote-quote`
            )
          var {
            data
          } = await axios.get(`https://api.lolhuman.xyz/api/wattpad?apikey=${global.lolkey}&url=${one}`)
          var caption = `Title : ${data.result.title}\n`
          caption += `Rating : ${data.result.rating}\n`
        ...
        case 'wattpadsearch':
          ...
          var {
            data
          } = await axios.get(`https://api.lolhuman.xyz/api/wattpadsearch?apikey=${global.lolkey}&query=${one}`)
        ...
        case 'cerpen':
          var {
            data
          } = await axios.get(`https://api.lolhuman.xyz/api/cerpen?apikey=${global.lolkey}`)
          var teks = `Title : ${data.result.title}\n`
        ...
        case 'ceritahoror':
          var {
            data
          } = await axios.get(`https://api.lolhuman.xyz/api/ceritahoror?apikey=${global.lolkey}`)
          var caption = `Title : ${data.result.title}\n`
          caption += `Desc : ${data.result.desc}\n`
          caption += `Story :\n${data.result.story}\n`
          conn.sendMessage(m.chat, {
        ...
        case 'wallpapersearch':
          ...
          conn.sendMessage(m.chat, {
            image: {
              url: `https://api.lolhuman.xyz/api/${args[0]}?apikey=${global.lolkey}&query=${one}`
            }
          })
          break
        case 'gimage2':
          if (!one) return m.reply(`Example: ${usedPrefix + command} ${template} |loli kawaii`)
          axios.get(`https://api.lolhuman.xyz/api/gimage2?apikey=${global.lolkey}&query=${one}`).then(({
            data
          }) => {
            for (var x of data.result.slice(0, 5)) {
              conn.sendMessage(m.chat, {
        ...
        case 'wallpapersearch2':
          if (!one) return m.reply(`Example: ${usedPrefix + command} ${template} |loli kawaii`)
          axios.get(`https://api.lolhuman.xyz/api/wallpaper2?apikey=${global.lolkey}&query=${one}`).then(({
            data
          }) => {
            conn.sendMessage(m.chat, {
              image: {
        ...
        case 'playstore':
          ...
          var {
            data
          } = await axios.get(`https://api.lolhuman.xyz/api/playstore?apikey=${global.lolkey}&query=${one}`)
        ...
        case 'shopee':
          ...
          var {
            data
          } = await axios.get(`https://api.lolhuman.xyz/api/shopee?apikey=${global.lolkey}&query=${one}`)
        ...
        case 'google':
          ...
          var {
            data
          } = await axios.get(`https://api.lolhuman.xyz/api/gsearch?apikey=${global.lolkey}&query=${one}`)
        ...
        case 'quotes':
          var {
            data
          } = await axios.get(`https://api.lolhuman.xyz/api/random/quotes?apikey=${global.lolkey}`)
          m.reply(`_${data.result.quote}_\n\n*― ${data.result.by}*`)
          break
        case 'quotesanime':
          var {
            data
          } = await axios.get(`https://api.lolhuman.xyz/api/random/quotesnime?apikey=${global.lolkey}`)
          m.reply(
            `_${data.result.quote}_\n\n*― ${data.result.character}*\n*― ${data.result.anime} ${data.result.episode}*`
            )
          break
        case 'quotesdilan':
        ...
        case 'bucin':
          var {
            data
          } = await axios.get(`https://api.lolhuman.xyz/api/random/${teks}?apikey=${global.lolkey}`)
          m.reply(data.result)
          break
        case 'randomnama':
          var {
            data
          } = await axios.get(`https://api.lolhuman.xyz/api/random/nama?apikey=${global.lolkey}`)
          m.reply(data.result)
          break
          // Entertainment
        case 'asupan':
          axios.get(`https://api.lolhuman.xyz/api/asupan?apikey=${global.lolkey}`).then(({
            data
          }) => {
            conn.sendMessage(m.chat, {
              video: {
        ...
        case 'wancak':
          conn.sendMessage(m.chat, {
            image: {
              url: `https://api.lolhuman.xyz/api/onecak?apikey=${global.lolkey}`
            }
          })
          break
          // Primbon
        case 'artinama':
          ...
          axios.get(`https://api.lolhuman.xyz/api/artinama?apikey=${global.lolkey}&nama=${one}`).then(({
            data
          }) => {
            m.reply(data.result)
          })
        ...
        case 'jodoh':
          ...
          axios.get(`https://api.lolhuman.xyz/api/jodoh/${one}/${two}?apikey=${global.lolkey}`).then(({
            data
          }) => {
            var teks = `Positif : ${data.result.positif}\n`
        ...
        case 'weton':
          ...
          axios.get(`https://api.lolhuman.xyz/api/weton/${args[1]}/${args[2]}/${args[3]}?apikey=${global.lolkey}`)
            .then(({
              data
            }) => {
        ...
        case 'jadian':
          if (!args[1]) return m.reply(`Example: ${usedPrefix + command} ${template} |12 12 2020`)
          axios.get(`https://api.lolhuman.xyz/api/jadian/${args[1]}/${args[2]}/${args[3]}?apikey=${global.lolkey}`)
            .then(({
              data
            }) => {
        ...
        case 'tebakumur':
          if (!one) return m.reply(`Example: ${usedPrefix + command} ${template} |Taylor MD`)
          axios.get(`https://api.lolhuman.xyz/api/tebakumur?apikey=${global.lolkey}&name=${one}`).then(({
            data
          }) => {
        ...
        case 'stalkig':
          ...
          axios.get(`https://api.lolhuman.xyz/api/stalkig/${one}?apikey=${global.lolkey}`).then(({
            data
          }) => {
        ...
        case 'stalkgithub':
          ...
          axios.get(`https://api.lolhuman.xyz/api/github/${one}?apikey=${global.lolkey}`).then(({
            data
          }) => {
        ...
        case 'stalktwitter':
          ...
          axios.get(`https://api.lolhuman.xyz/api/twitter/${one}?apikey=${global.lolkey}`).then(({
            data
          }) => {
        ...
        case 'stalktiktok':
          ...
          axios.get(`https://api.lolhuman.xyz/api/stalktiktok/${one}?apikey=${global.lolkey}`).then(({
            data
          }) => {
            var caption = `Username : ${data.result.username}\n`
        ...
        case 'ssweb':
          ...
          conn.sendMessage(m.chat, {
            image: {
              url: `https://api.lolhuman.xyz/api/ssweb?apikey=${global.lolkey}&url=${one}`
            }
          })
          break
        case 'ssweb2':
          ...
          conn.sendMessage(m.chat, {
            image: {
              url: `https://api.lolhuman.xyz/api/sswebfull?apikey=${global.lolkey}&url=${one}`
            }
          })
          break
        case 'shortlink':
          if (!one) return m.reply(`Example: ${usedPrefix + command} ${template} |https://api.lolhuman.xyz`)
          axios.get(`https://api.lolhuman.xyz/api/ouoshortlink?apikey=${global.lolkey}&url=${one}`).then(({
            data
          }) => {
            m.reply(data.result)
          })
        ...
        case 'quotesimage':
          conn.sendMessage(m.chat, {
            image: {
              url: `https://api.lolhuman.xyz/api/random/${args[0]}?apikey=${global.lolkey}`
            }
          })
          break
        case 'chiisaihentai':
        ...
        case 'hentai4everyone':
          conn.sendMessage(m.chat, {
            image: {
              url: `https://api.lolhuman.xyz/api/random/nsfw/${args[0]}?apikey=${global.lolkey}`
            }
          })
          break
        case 'bj':
        ...
        case 'nsfw_avatar':
          conn.sendMessage(m.chat, {
            image: {
              url: `https://api.lolhuman.xyz/api/random2/${args[0]}?apikey=${global.lolkey}`
            }
          })
          break
          // Textprome //
        ...
        case 'thunder':
          ...
          conn.sendMessage(m.chat, {
            image: {
              url: `https://api.lolhuman.xyz/api/textprome/${args[0]}?apikey=${global.lolkey}&text=${one}`
            }
          })
          break
        case 'pornhub':
        ...
        case 'wallgravity':
          ...
          conn.sendMessage(m.chat, {
            image: {
              url: `https://api.lolhuman.xyz/api/textprome2/${args[0]}?apikey=${global.lolkey}&text1=${one}&text2=${two}`
            }
          })
          break
          // Photo Oxy //
        ...
        case 'carvedwood':
          ...
          conn.sendMessage(m.chat, {
            image: {
              url: `https://api.lolhuman.xyz/api/photooxy1/${args[0]}?apikey=${global.lolkey}&text=${one}`
            }
          })
          break
        case 'tiktok':
        ...
        case 'pubg':
          ...
          conn.sendMessage(m.chat, {
            image: {
              url: `https://api.lolhuman.xyz/api/photooxy2/${args[0]}?apikey=${global.lolkey}&text1=${one}&text2=${two}`
            }
          })
          break
          // Ephoto 360 //
        ...
        case 'freefire':
          ...
          conn.sendMessage(m.chat, {
            image: {
              url: `https://api.lolhuman.xyz/api/ephoto1/${args[0]}?apikey=${global.lolkey}&text=${one}`
            }
          })
          break
      }
