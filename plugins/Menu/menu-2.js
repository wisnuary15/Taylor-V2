...
const handler = async (m, {
  ...
  try {
    if (command) switch (template) {
      case "listsurah":
        axios.get(`https://api.lolhuman.xyz/api/quran?apikey=${global.lolkey}`).then(async ({
          data
        }) => {
          var teks = "List Surah:\n";
      ...
      case "alquran":
        ...
        axios.get(`https://api.lolhuman.xyz/api/quran/${one}?apikey=${global.lolkey}`).then(async ({
          data
        }) => {
      ...
      case "alquranaudio":
        ...
        break;
      case "asmaulhusna":
        axios.get(`https://api.lolhuman.xyz/api/asmaulhusna?apikey=${global.lolkey}`).then(async ({
          data
        }) => {
      ...
      case "kisahnabi":
        ...
        axios.get(`https://api.lolhuman.xyz/api/kisahnabi/${one}?apikey=${global.lolkey}`).then(async ({
          data
        }) => {
      ...
      case "jadwalsholat":
        ...
        axios.get(`https://api.lolhuman.xyz/api/sholat/${one}?apikey=${global.lolkey}`).then(async ({
          data
        }) => {
      ...
      case "ytplay":
        ...
        axios.get(`https://api.lolhuman.xyz/api/ytsearch?apikey=${global.lolkey}&query=${one}`).then(async ({
          data
        }) => {
          axios.get(`https://api.lolhuman.xyz/api/ytaudio2?apikey=${global.lolkey}&url=https://www.youtube.com/watch?v=${data.result[0]?.videoId}`).then(async ({
            data
          }) => {
      ...
      case "ytmp3":
        ...
        axios.get(`https://api.lolhuman.xyz/api/ytaudio2?apikey=${global.lolkey}&url=${one}`).then(async ({
          data
        }) => {
          var caption = `❖ Title    : *${data.result.title}*\n`;
          caption += `❖ Size     : *${data.result.size}*`, conn.sendMessage(m.chat, {
      ...
      case "ytmp4":
        if (!one) return m.reply(`Example: ${usedPrefix + command} ${template} |https://www.youtube.com/watch?v=qZIQAk-BUEc`);
        axios.get(`https://api.lolhuman.xyz/api/ytmp4?apikey=${global.lolkey}&url=${one}`).then(async ({
          data
        }) => {
          var caption = `❖ Title    : *${data.result.title}*\n`;
          caption += `❖ Size     : *${data.result.size}*`, conn.sendMessage(m.chat, {
      ...
      case "telesticker":
        ...
        axios.get(`https://api.lolhuman.xyz/api/telestick?apikey=${global.lolkey}&url=${one}`).then(async ({
          data
        }) => {
          conn.sendMessage(m.chat, {
            sticker: {
      ...
      case "tiktoknowm":
        ...
        axios.get(`https://api.lolhuman.xyz/api/tiktok?apikey=${global.lolkey}&url=${one}`).then(async ({
          data
        }) => {
          conn.sendMessage(m.chat, {
            video: {
      ...
      case "spotify":
        ...
        axios.get(`https://api.lolhuman.xyz/api/spotify?apikey=${global.lolkey}&url=${one}`).then(async ({
          data
        }) => {
          var caption = `Title : ${data.result.title}\n`;
      ...
      case "spotifysearch":
        if (!one) return m.reply(`Example: ${usedPrefix + command} ${template} |Melukis Senja`);
        axios.get(`https://api.lolhuman.xyz/api/spotifysearch?apikey=${global.lolkey}&query=${one}`).then(async ({
          data
        }) => {
          var teks = "";
      ...
      case "jooxplay":
        if (!one) return m.reply(`Example: ${usedPrefix + command} ${template} |Melukis Senja`);
        axios.get(`https://api.lolhuman.xyz/api/jooxplay?apikey=${global.lolkey}&query=${one}`).then(async ({
          data
        }) => {
      ...
      case "igdl":
        ...
        axios.get(`https://api.lolhuman.xyz/api/instagram?apikey=${global.lolkey}&url=${one}`).then(async ({
          data
        }) => {
          var url = data.result;
      ...
      case "igdl2":
        if (!one) return m.reply(`Example: ${usedPrefix + command} ${template} |https://www.instagram.com/p/CJ8XKFmJ4al/?igshid=1acpcqo44kgkn`);
        axios.get(`https://api.lolhuman.xyz/api/instagram2?apikey=${global.lolkey}&url=${one}`).then(async ({
          data
        }) => {
      ...
      case "twtdl":
        ...
        axios.get(`https://api.lolhuman.xyz/api/twitter?apikey=${global.lolkey}&url=${one}`).then(async ({
          data
        }) => {
          conn.sendMessage(m.chat, {
            video: {
      ...
      case "fbdl":
        ...
        axios.get(`https://api.lolhuman.xyz/api/facebook?apikey=${global.lolkey}&url=${one}`).then(async ({
          data
        }) => {
          conn.sendMessage(m.chat, {
            video: {
      ...
      case "zippyshare":
        ...
        axios.get(`https://api.lolhuman.xyz/api/zippyshare?apikey=${global.lolkey}&url=${one}`).then(async ({
          data
        }) => {
      ...
      case "pinterest":
        ...
        axios.get(`https://api.lolhuman.xyz/api/pinterest?apikey=${global.lolkey}&query=${one}`).then(async ({
          data
        }) => {
          conn.sendMessage(m.chat, {
            image: {
      ...
      case "pinterest2":
        if (!one) return m.reply(`Example: ${usedPrefix + command} ${template} |loli kawaii`);
        axios.get(`https://api.lolhuman.xyz/api/pinterest2?apikey=${global.lolkey}&query=${one}`).then(async ({
          data
        }) => {
      ...
      case "pinterestdl":
        ...
        axios.get(`https://api.lolhuman.xyz/api/pinterestdl?apikey=${global.lolkey}&url=${one}`).then(async ({
          data
        }) => {
          conn.sendMessage(m.chat, {
            image: {
      ...
      case "character":
        ...
        axios.get(`https://api.lolhuman.xyz/api/character?apikey=${global.lolkey}&query=${one}`).then(async ({
          data
        }) => {
      ...
      case "anime":
        if (!one) return m.reply(`Example: ${usedPrefix + command} ${template} |Gotoubun No Hanayome`);
        axios.get(`https://api.lolhuman.xyz/api/anime?apikey=${global.lolkey}&query=${one}`).then(async ({
          data
        }) => {
          var caption = `Id : ${data.result.id}\n`;
      ...
      case "kusonime":
        ...
        axios.get(`https://api.lolhuman.xyz/api/kusonime?apikey=${global.lolkey}&url=${one}`).then(async ({
          data
        }) => {
          var caption = `Title : ${data.result.title}\n`;
      ...
      case "kusonimesearch":
        if (!one) return m.reply(`Example: ${usedPrefix + command} ${template} |Gotoubun No Hanayome`);
        axios.get(`https://api.lolhuman.xyz/api/kusonimesearch?apikey=${global.lolkey}&query=${one}`).then(async ({
          data
        }) => {
          var caption = `Title : ${data.result.title}\n`;
          for (var x in caption += `Japanese : ${data.result.japanese}\n`,
      ...
      case "otakudesu":
        ...
        axios.get(`https://api.lolhuman.xyz/api/otakudesu?apikey=${global.lolkey}&url=${one}`).then(async ({
          data
        }) => {
      ...
      case "otakudesusearch":
        if (!one) return m.reply(`Example: ${usedPrefix + command} ${template} |Gotoubun No Hanayome`);
        axios.get(`https://api.lolhuman.xyz/api/otakudesusearch?apikey=${global.lolkey}&query=${one}`).then(async ({
          data
        }) => {
          var teks = `Title : ${data.result.title}\n`;
          for (var x in teks += `Japanese : ${data.result.japanese}\n`, teks += `Judul : ${data.result.judul}\n`,
      ...
      case "kbbi":
        ...
        var {
          data
        } = await axios.get(`https://api.lolhuman.xyz/api/kbbi?apikey=${global.lolkey}&query=${one}`), teks = `\`\`\`Kata : ${data.result[0]?.nama}\`\`\`\n`;
      ...
      case "jarak":
        ...
        var {
          data
        } = await axios.get(`https://api.lolhuman.xyz/api/jaraktempuh?apikey=${global.lolkey}&kota1=${one}&kota2=${two}`);
      ...
      case "heroml":
        ...
        var {
          data
        } = await axios.get(`https://api.lolhuman.xyz/api/heroml/${one}?apikey=${global.lolkey}`), caption = `Name : ${data.result.hero_name}\n`;
      ...
      case "translate":
        ...
        var {
          data
        } = await axios.get(`https://api.lolhuman.xyz/api/translate/auto/${one}?apikey=${global.lolkey}&text=${two}`);
      ...
      case "gimage2":
        if (!one) return m.reply(`Example: ${usedPrefix + command} ${template} |loli kawaii`);
        axios.get(`https://api.lolhuman.xyz/api/gimage2?apikey=${global.lolkey}&query=${one}`).then(async ({
          data
        }) => {
          for (var x of data.result.slice(0, 5)) conn.sendMessage(m.chat, {
            image: {
      ...
      case "wallpapersearch2":
        if (!one) return m.reply(`Example: ${usedPrefix + command} ${template} |loli kawaii`);
        axios.get(`https://api.lolhuman.xyz/api/wallpaper2?apikey=${global.lolkey}&query=${one}`).then(async ({
          data
        }) => {
          conn.sendMessage(m.chat, {
            image: {
      ...
      case "randomnama":
        ...
        break;
      case "asupan":
        axios.get(`https://api.lolhuman.xyz/api/asupan?apikey=${global.lolkey}`).then(async ({
          data
        }) => {
          conn.sendMessage(m.chat, {
            video: {
      ...
      case "artinama":
        ...
        axios.get(`https://api.lolhuman.xyz/api/artinama?apikey=${global.lolkey}&nama=${one}`).then(async ({
          data
        }) => {
          m.reply(data.result);
        });
      ...
      case "jodoh":
        ...
        axios.get(`https://api.lolhuman.xyz/api/jodoh/${one}/${two}?apikey=${global.lolkey}`).then(async ({
          data
        }) => {
      ...
      case "weton":
        ...
        axios.get(`https://api.lolhuman.xyz/api/weton/${args[1]}/${args[2]}/${args[3]}?apikey=${global.lolkey}`).then(async ({
          data
        }) => {
      ...
      case "jadian":
        if (!args[1]) return m.reply(`Example: ${usedPrefix + command} ${template} |12 12 2020`);
        axios.get(`https://api.lolhuman.xyz/api/jadian/${args[1]}/${args[2]}/${args[3]}?apikey=${global.lolkey}`).then(async ({
          data
        }) => {
      ...
      case "tebakumur":
        if (!one) return m.reply(`Example: ${usedPrefix + command} ${template} |Taylor MD`);
        axios.get(`https://api.lolhuman.xyz/api/tebakumur?apikey=${global.lolkey}&name=${one}`).then(async ({
          data
        }) => {
      ...
      case "stalkig":
        ...
        axios.get(`https://api.lolhuman.xyz/api/stalkig/${one}?apikey=${global.lolkey}`).then(async ({
          data
        }) => {
      ...
      case "stalkgithub":
        ...
        axios.get(`https://api.lolhuman.xyz/api/github/${one}?apikey=${global.lolkey}`).then(async ({
          data
        }) => {
      ...
      case "stalktwitter":
        ...
        axios.get(`https://api.lolhuman.xyz/api/twitter/${one}?apikey=${global.lolkey}`).then(async ({
          data
        }) => {
      ...
      case "stalktiktok":
        ...
        axios.get(`https://api.lolhuman.xyz/api/stalktiktok/${one}?apikey=${global.lolkey}`).then(async ({
          data
        }) => {
          var caption = `Username : ${data.result.username}\n`;
      ...
      case "shortlink":
        if (!one) return m.reply(`Example: ${usedPrefix + command} ${template} |https://api.lolhuman.xyz`);
        axios.get(`https://api.lolhuman.xyz/api/ouoshortlink?apikey=${global.lolkey}&url=${one}`).then(async ({
          data
        }) => {
          m.reply(data.result);
        });
