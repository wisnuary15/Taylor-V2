...
const handler = async (m, {
    ...
    let name = await await conn.getName(who)
    ...
    try {
        if (command) {
            ...
            case 'ytplay':
                ...
                axios
                    ...
                    .then(({
                        ...
                        axios.get(`https://api.lolhuman.xyz/api/ytaudio2?apikey=${global.lolkey}&url=https://www.youtube.com/watch?v=${data.result[0]?.videoId}`).then(({
                            data
                        }) => {
            ...
            case 'weton':
                ...
                axios.get(`https://api.lolhuman.xyz/api/weton/${args[1]}/${args[2]}/${args[3]}?apikey=${global.lolkey}`).then(({
                    data
                }) => {
            ...
            case 'jadian':
                if (!args[1]) return m.reply(`Example: ${usedPrefix + command} ${template} |12 12 2020`)
                axios.get(`https://api.lolhuman.xyz/api/jadian/${args[1]}/${args[2]}/${args[3]}?apikey=${global.lolkey}`).then(({
                    data
                }) => {
