...
`
    ...
    case 'fox':
        ...
        let wfox = (new Date - db.data.users[m.sender].foxlastclaim)
    ...
    case 'rhinoceros':
        ...
        let wbadak = (new Date - db.data.users[m.sender].rhinoceroslastclaim)
    ...
    case 'lion':
        ...
        let wlion = (new Date - db.data.users[m.sender].lionlastclaim)
    ...
    case 'horse':
        ...
        let whorse = (new Date - db.data.users[m.sender].horselastclaim)
    ...
    case 'wolf':
        ...
        let wwolf = (new Date - db.data.users[m.sender].wolflastclaim)
    ...
    case 'dragon':
        ...
        let wdragon = (new Date - db.data.users[m.sender].dragonlastclaim)
    ...
    case 'kyubi':
        ...
        let wkyubi = (new Date - db.data.users[m.sender].kyubilastclaim)
    ...
    case 'centaur':
        ...
        let wcentaur = (new Date - db.data.users[m.sender].centaurlastclaim)
    ...
    case 'phonix':
        ...
        let wphonix = (new Date - db.data.users[m.sender].phonixlastclaim)
    ...
    case 'griffin':
        ...
        let wgriffin = (new Date - db.data.users[m.sender].griffinastclaim)
    ...
    case 'cat':
        ...
        let wcat = (new Date - db.data.users[m.sender].catlastclaim)
