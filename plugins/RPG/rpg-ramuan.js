const handler = async (m, {
    ...
    case 'rubah':
        ...
        let __waktur = (new Date - db.data.users[m.sender].ramuanrubahlast)
        let _waktur = (600000 - __waktur)
        let waktur = clockString(_waktur)
        if (new Date - db.data.users[m.sender].ramuanrubahlast > 600000) {
            if (db.data.users[m.sender].ramuan > 0) {
                db.data.users[m.sender].ramuan -= 1
                db.data.users[m.sender].anakrubah += 200
                db.data.users[m.sender].ramuanrubahlast = new Date * 1
                ...
                if (rubah > 0) {
                    ...
                    if (db.data.users[m.sender].anakrubah > naiklvl) {
                        ...
                        db.data.users[m.sender].anakrubah -= (rubah * 1000)
    ...
    case 'kuda':
        ...
        let __waktuk = (new Date - db.data.users[m.sender].ramuankudalast)
        let _waktuk = (600000 - __waktuk)
        let waktuk = clockString(_waktuk)
        if (new Date - db.data.users[m.sender].ramuankudalast > 600000) {
            if (db.data.users[m.sender].ramuan > 0) {
                db.data.users[m.sender].ramuan -= 1
                db.data.users[m.sender].anakkuda += 200
                db.data.users[m.sender].ramuankudalast = new Date * 1
                conn.reply(m.chat, `Berhasil memberi ramuan pet ${type}`, m)
                setTimeout(() => {
                ...
                if (kuda > 0) {
                    ...
                    if (db.data.users[m.sender].anakkuda > naiklvl) {
                        ...
                        db.data.users[m.sender].anakkuda -= (kuda * 1000)
    ...
    case 'serigala':
        ...
        let __waktus = (new Date - db.data.users[m.sender].ramuanserigalalast)
        let _waktus = (600000 - __waktus)
        let waktus = clockString(_waktus)
        if (new Date - db.data.users[m.sender].ramuanserigalalast > 600000) {
            if (db.data.users[m.sender].ramuan > 0) {
                db.data.users[m.sender].ramuan -= 1
                db.data.users[m.sender].anakserigala += 200
                db.data.users[m.sender].ramuanserigalalast = new Date * 1
                conn.reply(m.chat, `Berhasil memberi ramuan pet ${type}`, m)
                setTimeout(() => {
                ...
                if (serigala > 0) {
                    ...
                    if (db.data.users[m.sender].anakserigala > naiklvl) {
                        db.data.users[m.sender].serigala += 1
                        db.data.users[m.sender].anakserigala -= (serigala * 10000)
    ...
    case 'naga':
        ...
        let __waktug = (new Date - db.data.users[m.sender].ramuannagalast)
        let _waktug = (600000 - __waktug)
        let waktug = clockString(_waktug)
        if (new Date - db.data.users[m.sender].ramuannagalast > 600000) {
            if (db.data.users[m.sender].ramuan > 0) {
                db.data.users[m.sender].ramuan -= 1
                db.data.users[m.sender].anaknaga += 200
                db.data.users[m.sender].ramuannagalast = new Date * 1
                conn.reply(m.chat, `Berhasil memberi ramuan pet ${type}`, m)
                setTimeout(() => {
                ...
                if (naga > 0) {
                    ...
                    if (db.data.users[m.sender].anaknaga > naiklvl) {
                        db.data.users[m.sender].naga += 1
                        db.data.users[m.sender].anaknaga -= (naga * 10000)
    ...
    case 'kyubi':
        ...
        let __waktuyu = (new Date - db.data.users[m.sender].ramuankyubilast)
        let _waktuyu = (600000 - __waktuyu)
        let waktuyu = clockString(_waktuyu)
        if (new Date - db.data.users[m.sender].ramuankyubilast > 600000) {
            if (db.data.users[m.sender].ramuan > 0) {
                db.data.users[m.sender].ramuan -= 1
                db.data.users[m.sender].anakkyubi += 200
                db.data.users[m.sender].ramuankyubilast = new Date * 1
                conn.reply(m.chat, `Berhasil memberi ramuan pet ${type}`, m)
                setTimeout(() => {
                ...
                if (kyubi > 0) {
                    ...
                    if (db.data.users[m.sender].anakkyubi > naiklvl) {
                        db.data.users[m.sender].kyubi += 1
                        db.data.users[m.sender].anakkyubi -= (kyubi * 10000)
    ...
    case 'centaur':
        ...
        let __waktuur = (new Date - db.data.users[m.sender].ramuancentaurlast)
        let _waktuur = (600000 - __waktuur)
        let waktuur = clockString(_waktuur)
        if (new Date - db.data.users[m.sender].ramuancentaurlast > 600000) {
            if (db.data.users[m.sender].ramuan > 0) {
                db.data.users[m.sender].ramuan -= 1
                db.data.users[m.sender].anakcentaur += 200
                db.data.users[m.sender].ramuancentaurlast = new Date * 1
                conn.reply(m.chat, `Berhasil memberi ramuan pet ${type}`, m)
                setTimeout(() => {
                ...
                if (centaur > 0) {
                    ...
                    if (db.data.users[m.sender].anakcentaur > naiklvl) {
                        db.data.users[m.sender].centaur += 1
                        db.data.users[m.sender].anakcentaur -= (centaur * 10000)
    ...
    case 'phonix':
        ...
        let __waktux = (new Date - db.data.users[m.sender].ramuanphonixlast)
        let _waktux = (600000 - __waktux)
        let waktux = clockString(_waktux)
        if (new Date - db.data.users[m.sender].ramuanphonixlast > 600000) {
            if (db.data.users[m.sender].ramuan > 0) {
                db.data.users[m.sender].ramuan -= 1
                db.data.users[m.sender].anakphonix += 200
                db.data.users[m.sender].ramuanphonixlast = new Date * 1
                conn.reply(m.chat, `Berhasil memberi ramuan pet ${type}`, m)
                setTimeout(() => {
                ...
                if (phonix > 0) {
                    ...
                    if (db.data.users[m.sender].anakphonix > naiklvl) {
                        db.data.users[m.sender].phonix += 1
                        db.data.users[m.sender].anakphonix -= (phonix * 10000)
    ...
    case 'griffin':
        ...
        let __waktufin = (new Date - db.data.users[m.sender].ramuangriffinlast)
        let _waktufin = (600000 - __waktufin)
        let waktufin = clockString(_waktufin)
        if (new Date - db.data.users[m.sender].ramuangriffinlast > 600000) {
            if (db.data.users[m.sender].ramuan > 0) {
                db.data.users[m.sender].ramuan -= 1
                db.data.users[m.sender].anakgriffin += 200
                db.data.users[m.sender].ramuangriffinlast = new Date * 1
                conn.reply(m.chat, `Berhasil memberi ramuan pet ${type}`, m)
                setTimeout(() => {
                ...
                if (griffin > 0) {
                    ...
                    if (db.data.users[m.sender].anakgriffin > naiklvl) {
                        db.data.users[m.sender].griffin += 1
                        db.data.users[m.sender].anakgriffin -= (griffin * 10000)
    ...
    case 'kucing':
        ...
        let __waktu = (new Date - db.data.users[m.sender].ramuankucinglast)
        let _waktu = (600000 - __waktu)
        let waktu = clockString(_waktu)
        if (new Date - db.data.users[m.sender].ramuankucinglast > 600000) {
            if (db.data.users[m.sender].ramuan > 0) {
                db.data.users[m.sender].ramuan -= 1
                db.data.users[m.sender].anakkucing += 200
                db.data.users[m.sender].ramuankucinglast = new Date * 1
                conn.reply(m.chat, `Berhasil memberi ramuan pet ${type}`, m)
                setTimeout(() => {
                ...
                if (kucing > 0) {
                    ...
                    if (db.data.users[m.sender].anakkucing > naiklvl) {
                        ...
                        db.data.users[m.sender].anakkucing -= (kucing * 1000)
    ...
    case 'hero':
        ...
        let __waktuher = (new Date - db.data.users[m.sender].ramuanherolast)
        let _waktuher = (600000 - __waktuher)
        let waktuher = clockString(_waktuher)
        if (new Date - db.data.users[m.sender].ramuanherolast > 600000) {
            if (db.data.users[m.sender].ramuan > 0) {
                db.data.users[m.sender].ramuan -= 1
                db.data.users[m.sender].exphero += 100
                db.data.users[m.sender].ramuanherolast = new Date * 1
                ...
                if (hero > 0) {
                    ...
                    if (db.data.users[m.sender].exphero > naiklvl) {
                        db.data.users[m.sender].hero += 1
                        db.data.users[m.sender].exphero -= (kucing * 500)
