          ...
          switch (_type) {
            case 'banteng':
              if (db.data.users[m.sender].banteng >= count * 1) {
                ...
                conn.reply(m.chat, `Sukses Menjual ${count} Banteng Dengan Harga ${Sbanteng * count} Money `.trim(),
                  m)
            ...
            case 'harimau':
              if (db.data.users[m.sender].harimau >= count * 1) {
                ...
                conn.reply(m.chat, `Sukses Menjual ${count} Harimau Dengan Harga ${Sharimau * count} Money `.trim(),
                  m)
            ...
            case 'kambing':
              if (db.data.users[m.sender].kambing >= count * 1) {
                ...
                conn.reply(m.chat, `Sukses Menjual ${count} Kambing Dengan Harga ${Skambing * count} Money `.trim(),
                  m)
            ...
            case 'kerbau':
              if (db.data.users[m.sender].kerbau >= count * 1) {
                ...
                conn.reply(m.chat, `Sukses Menjual ${count} Kerbau Dengan Harga ${Skerbau * count} Money `.trim(),
                  m)
            ...
            case 'monyet':
              if (db.data.users[m.sender].monyet >= count * 1) {
                ...
                conn.reply(m.chat, `Sukses Menjual ${count} Monyet Dengan Harga ${Smonyet * count} Money `.trim(),
                  m)
            ...
            case 'babihutan':
              if (db.data.users[m.sender].babihutan >= count * 1) {
                ...
                conn.reply(m.chat, `Sukses Menjual ${count} Babi Hutan Dengan Harga ${Sbabihutan * count} Money `
                  .trim(), m)
            ...
            case 'kepiting':
              if (db.data.users[m.sender].kepiting >= count * 1) {
                ...
                conn.reply(m.chat, `Sukses Menjual ${count} Kepiting Dengan Harga ${Skepiting * count} Money `
                .trim(), m)
            ...
            case 'dory':
              if (db.data.users[m.sender].dory >= count * 1) {
                ...
                conn.reply(m.chat, `Sukses Menjual ${count} Ikan Dory Dengan Harga ${Sdory * count} Money `.trim(),
                  m)
            ...
            case 'gurita':
              if (db.data.users[m.sender].gurita >= count * 1) {
                ...
                conn.reply(m.chat, `Sukses Menjual ${count} Gurita Dengan Harga ${Sgurita * count} Money `.trim(),
                  m)
            ...
            case 'buntal':
              if (db.data.users[m.sender].buntal >= count * 1) {
                ...
                conn.reply(m.chat, `Sukses Menjual ${count} Ikan Buntal Dengan Harga ${Sbuntal * count} Money `
                  .trim(), m)
            ...
            case 'orca':
              if (db.data.users[m.sender].orca >= count * 1) {
                ...
                conn.reply(m.chat, `Sukses Menjual ${count} Paus Orca Dengan Harga ${Sorca * count} Money `.trim(),
                  m)
            ...
            case 'lumba':
              if (db.data.users[m.sender].lumba >= count * 1) {
                ...
                conn.reply(m.chat, `Sukses Menjual ${count} Lumba Lumba Dengan Harga ${Slumba * count} Money `
                .trim(), m)
            ...
            case 'lobster':
              if (db.data.users[m.sender].lobster >= count * 1) {
                ...
                conn.reply(m.chat, `Sukses Menjual ${count} Lobster Dengan Harga ${Slobster * count} Money `.trim(),
                  m)
      ...
      switch (type) {
        ...
        case 'kepiting':
          if (db.data.users[m.sender].kepiting >= count * 1) {
            db.data.users[m.sender].money += Skepiting * count
            db.data.users[m.sender].kepiting -= count * 1
            conn.reply(m.chat, `Sukses Menjual ${count} Kepiting Dengan Harga ${Skepiting * count} Money `.trim(),
              m)
          } else conn.reply(m.chat, `Kepiting Kamu Tidak Cukup`.trim(), m)
          break
        case 'ikan':
        ...
        case 'buntal':
          if (db.data.users[m.sender].buntal >= count * 1) {
            db.data.users[m.sender].money += Sbuntal * count
            db.data.users[m.sender].buntal -= count * 1
            conn.reply(m.chat, `Sukses Menjual ${count} Ikan Buntal Dengan Harga ${Sbuntal * count} Money `.trim(),
              m)
          } else conn.reply(m.chat, `Ikan Buntal Kamu Tidak Cukup`.trim(), m)
          break
        case 'hiu':
        ...
        case 'lumba':
          if (db.data.users[m.sender].lumba >= count * 1) {
            db.data.users[m.sender].money += Skepiting * count
            db.data.users[m.sender].lumba -= count * 1
            conn.reply(m.chat, `Sukses Menjual ${count} Lumba Lumba Dengan Harga ${Slumba * count} Money `.trim(),
              m)
          } else conn.reply(m.chat, `Lumba Lumba Kamu Tidak Cukup`.trim(), m)
          break
        case 'paus':
