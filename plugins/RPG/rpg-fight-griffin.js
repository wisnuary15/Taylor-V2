const handler = async (m, {
  ...
  if (typeof conn.fightnaga[m.sender] != "undefined" && conn.fightnaga[m.sender] === true) return m.reply(
  ...
  m.reply(
    `*Pet Kamu* (🦚griffin ${db.data.users[m.sender].griffin}) ⚔️menantang 🦚griffinnya *${conn.getName(lawan)}* (🦚griffin ${db.data.users[lawan].griffin}) lagi berkelahi.\n\nTunggu ${lamaPertarungan} menit lagi dan lihat siapa yg menang🎮.`
    )
