const handler = async (m, {
  ...
  const pengocok = conn.getName(m.sender);
  ...
  const [rndm1, rndm2, rndm3, rndm4, rndm5, rndm6, rndm7, rndm8, rndm9] = Array(9).fill().map(() => Math.floor(Math
    .random() * 10));
  const [ran1, ran2, ran3, ran4, ran5, ran6, ran7, ran8, ran9] = [rndm1, rndm2, rndm3, rndm4, rndm5, rndm6, rndm7,
    rndm8, rndm9
  ].map(v => v * 10);
  const [hmsil1, hmsil2, hmsil3, hmsil4, hmsil5, hmsil6, hmsil7, hmsil8, hmsil9] = [ran1, ran2, ran3, ran4, ran5,
    ran6, ran7, ran8, ran9
  ];
