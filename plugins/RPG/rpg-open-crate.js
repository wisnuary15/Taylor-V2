  ...
  switch (type) {
    case 'common':
      switch (jumlah) {
        case '1':
        case 'crate':
          let __lastime = (new Date - db.data.users[m.sender].lastopen)
          let _lastime = (30000 - __lastime)
          let lastime = clockString(_lastime)
          if (new Date - db.data.users[m.sender].lastopen > 30000) {
...
`.trim()
            if (db.data.users[m.sender].common >= 1) {
              db.data.users[m.sender].common -= 1
              db.data.users[m.sender].money += cm * 1
              db.data.users[m.sender].exp += ce * 1
              db.data.users[m.sender].potion += cp * 1
              db.data.users[m.sender].uncommon += cu * 1
              db.data.users[m.sender].common += cc * 1
              db.data.users[m.sender].lastopen = new Date * 1
          ...
          break
        case '10':
          let __lastimeq = (new Date - db.data.users[m.sender].lastopen)
...
`.trim()
            if (db.data.users[m.sender].common >= 10) {
              db.data.users[m.sender].common -= 10
              db.data.users[m.sender].money += cm1 * 1
              db.data.users[m.sender].exp += ce1 * 1
              db.data.users[m.sender].potion += cp1 * 1
              db.data.users[m.sender].uncommon += cu1 * 1
              db.data.users[m.sender].common += cc1 * 1
              db.data.users[m.sender].lastopen = new Date * 1
          ...
          break
        case '100':
          let __lastimeqq = (new Date - db.data.users[m.sender].lastopen)
...
`.trim()
            if (db.data.users[m.sender].common >= 100) {
              db.data.users[m.sender].common -= 100
              db.data.users[m.sender].money += cm2 * 1
              db.data.users[m.sender].exp += ce2 * 1
              db.data.users[m.sender].potion += cp2 * 1
              db.data.users[m.sender].uncommon += cu2 * 1
              db.data.users[m.sender].common += cc2 * 1
              db.data.users[m.sender].lastopen = new Date * 1
          ...
          break
        case '1000':
          let __lastimeqqq = (new Date - db.data.users[m.sender].lastopen)
...
`.trim()
            if (db.data.users[m.sender].common >= 1000) {
              db.data.users[m.sender].common -= 1000
              db.data.users[m.sender].money += cm3 * 1
              db.data.users[m.sender].exp += ce3 * 1
              db.data.users[m.sender].potion += cp3 * 1
              db.data.users[m.sender].uncommon += cu3 * 1
              db.data.users[m.sender].common += cc3 * 1
              db.data.users[m.sender].lastopen = new Date * 1
    ...
    case 'uncommon':
      switch (jumlah) {
        case '1':
        case 'crate':
          let __lastimew = (new Date - db.data.users[m.sender].lastopen)
...
`.trim()
            if (db.data.users[m.sender].uncommon >= 1) {
              db.data.users[m.sender].uncommon -= 1
              db.data.users[m.sender].money += um * 1
              db.data.users[m.sender].diamond += ud * 1
              db.data.users[m.sender].exp += ue * 1
              db.data.users[m.sender].potion += up * 1
              db.data.users[m.sender].common += uc * 1
              db.data.users[m.sender].uncommon += uu * 1
              db.data.users[m.sender].lastopen = new Date * 1
              conn.reply(m.chat, Hun, m)
              if (umc > 0) {
                conn.reply(m.chat, `*Selamat anda mendapatkan item Rare yaitu*\n${umc} Mythic Crate`, m)
                db.data.users[m.sender].mythic += umc * 1
              }
          ...
          break
        case '10':
          let __lastimewe = (new Date - db.data.users[m.sender].lastopen)
...
`.trim()
            if (db.data.users[m.sender].uncommon >= 10) {
              db.data.users[m.sender].uncommon -= 10
              db.data.users[m.sender].money += um1 * 1
              db.data.users[m.sender].diamond += ud1 * 1
              db.data.users[m.sender].exp += ue1 * 1
              db.data.users[m.sender].potion += up1 * 1
              db.data.users[m.sender].common += uc1 * 1
              db.data.users[m.sender].uncommon += uu1 * 1
              db.data.users[m.sender].lastopen = new Date * 1
              conn.reply(m.chat, Hun1, m)
              if (umc1 > 0) {
                conn.reply(m.chat, `*Selamat anda mendapatkan item Rare yaitu*\n${umc1} Mythic Crate`, m)
                db.data.users[m.sender].mythic += umc1 * 1
              }
            } else conn.reply(m.chat, 'Uncommon crate anda tidak cukup', m)
          } else conn.reply(m.chat, `Mohon tunggu ${lastimewe} lagi untuk bisa membuka fitur open`, m)
          break
        case '100':
          let __lastimewee = (new Date - db.data.users[m.sender].lastopen)
...
`.trim()
            if (db.data.users[m.sender].uncommon >= 100) {
              db.data.users[m.sender].uncommon -= 100
              db.data.users[m.sender].money += um2 * 1
              db.data.users[m.sender].diamond += ud2 * 1
              db.data.users[m.sender].exp += ue2 * 1
              db.data.users[m.sender].potion += up2 * 1
              db.data.users[m.sender].common += uc2 * 1
              db.data.users[m.sender].uncommon += uu2 * 1
              db.data.users[m.sender].lastopen = new Date * 1
              conn.reply(m.chat, Hun2, m)
              if (umc2 > 0) {
                conn.reply(m.chat, `*Selamat anda mendapatkan item Rare yaitu*\n${umc2} Mythic Crate`, m)
                db.data.users[m.sender].mythic += umc2 * 1
              }
            } else conn.reply(m.chat, 'Uncommon crate anda tidak cukup', m)
          } else conn.reply(m.chat, `Mohon tunggu ${lastimewee} lagi untuk bisa membuka fitur open`, m)
          break
        case '1000':
          let __lastimeweee = (new Date - db.data.users[m.sender].lastopen)
...
`.trim()
            if (db.data.users[m.sender].uncommon >= 1000) {
              db.data.users[m.sender].uncommon -= 1000
              db.data.users[m.sender].money += um3 * 1
              db.data.users[m.sender].diamond += ud3 * 1
              db.data.users[m.sender].exp += ue3 * 1
              db.data.users[m.sender].potion += up3 * 1
              db.data.users[m.sender].common += uc3 * 1
              db.data.users[m.sender].uncommon += uu3 * 1
              db.data.users[m.sender].lastopen = new Date * 1
              conn.reply(m.chat, Hun3, m)
              if (umc3 > 0) {
                conn.reply(m.chat, `*Selamat anda mendapatkan item Rare yaitu*\n${umc3} Mythic Crate`, m)
                db.data.users[m.sender].mythic += umc3 * 1
              }
            } else conn.reply(m.chat, 'Uncommon crate anda tidak cukup', m)
    ...
    case 'mythic':
      switch (jumlah) {
        case '1':
        case 'crate':
          let __lastimep = (new Date - db.data.users[m.sender].lastopen)
...
`.trim()
            if (db.data.users[m.sender].mythic >= 1) {
              db.data.users[m.sender].mythic -= 1
              db.data.users[m.sender].money += mm * 1
              db.data.users[m.sender].diamond += md * 1
              db.data.users[m.sender].exp += me * 1
              db.data.users[m.sender].potion += mp * 1
              db.data.users[m.sender].common += mc * 1
              db.data.users[m.sender].uncommon += mu * 1
              db.data.users[m.sender].lastopen = new Date * 1
              conn.reply(m.chat, Mychat, m)
              if (mmm > 0) {
                conn.reply(m.chat, `*Selamat anda mendapatkan item Rare yaitu*\n${mmm} Mythic Crate`, m)
                db.data.users[m.sender].mythic += mmm * 1
              }
              if (ml > 0) {
                conn.reply(m.chat, `*Selamat anda mendapatkan item Epic yaitu*\n${ml} Legendary Crate`, m)
                db.data.users[m.sender].legendary += ml * 1
              }
          ...
          break
        case '10':
          let __lastimepa = (new Date - db.data.users[m.sender].lastopen)
...
`.trim()
            if (db.data.users[m.sender].mythic >= 10) {
              db.data.users[m.sender].mythic -= 10
              db.data.users[m.sender].money += mm1 * 1
              db.data.users[m.sender].diamond += md1 * 1
              db.data.users[m.sender].exp += me1 * 1
              db.data.users[m.sender].potion += mp1 * 1
              db.data.users[m.sender].common += mc1 * 1
              db.data.users[m.sender].uncommon += mu1 * 1
              db.data.users[m.sender].lastopen = new Date * 1
              conn.reply(m.chat, Mychat1, m)
              if (mmm1 > 0) {
                conn.reply(m.chat, `*Selamat anda mendapatkan item Rare yaitu*\n${mmm1} Mythic Crate`, m)
                db.data.users[m.sender].mythic += mmm1 * 1
              }
              if (ml1 > 0) {
                conn.reply(m.chat, `*Selamat anda mendapatkan item Epic yaitu*\n${ml1} Legendary Crate`, m)
                db.data.users[m.sender].legendary += ml1 * 1
              }
            } else conn.reply(m.chat, 'Mythic crate anda tidak cukup', m)
          } else conn.reply(m.chat, `Mohon tunggu ${lastimepa} lagi untuk bisa membuka fitur open`, m)
          break
        case '100':
          let __lastimepaa = (new Date - db.data.users[m.sender].lastopen)
...
`.trim()
            if (db.data.users[m.sender].mythic >= 100) {
              db.data.users[m.sender].mythic -= 100
              db.data.users[m.sender].money += mm2 * 1
              db.data.users[m.sender].diamond += md2 * 1
              db.data.users[m.sender].exp += me2 * 1
              db.data.users[m.sender].potion += mp2 * 1
              db.data.users[m.sender].common += mc2 * 1
              db.data.users[m.sender].uncommon += mu2 * 1
              db.data.users[m.sender].lastopen = new Date * 1
          ...
          break
        case '1000':
          let __lastimepaaa = (new Date - db.data.users[m.sender].lastopen)
...
`.trim()
            if (db.data.users[m.sender].mythic >= 1000) {
              db.data.users[m.sender].mythic -= 1000
              db.data.users[m.sender].money += mm3 * 1
              db.data.users[m.sender].diamond += md3 * 1
              db.data.users[m.sender].exp += me3 * 1
              db.data.users[m.sender].potion += mp3 * 1
              db.data.users[m.sender].common += mc3 * 1
              db.data.users[m.sender].uncommon += mu3 * 1
              db.data.users[m.sender].lastopen = new Date * 1
              conn.reply(m.chat, Mychat3, m)
              if (mmm3 > 0) {
                conn.reply(m.chat, `*Selamat anda mendapatkan item Rare yaitu*\n${mmm3} Mythic Crate`, m)
                db.data.users[m.sender].mythic += mmm3 * 1
              }
              if (ml3 > 0) {
                conn.reply(m.chat, `*Selamat anda mendapatkan item Epic yaitu*\n${ml3} Legendary Crate`, m)
                db.data.users[m.sender].legendary += ml3 * 1
              }
            } else conn.reply(m.chat, 'Mythic crate anda tidak cukup', m)
    ...
    case 'boxs':
      switch (jumlah) {
        case '1':
        case 'crate':
          let __lastimed = (new Date - db.data.users[m.sender].lastopen)
...
`.trim()
            if (db.data.users[m.sender].boxs >= 1) {
              db.data.users[m.sender].boxs -= 1
              db.data.users[m.sender].money += mmz * 1
              db.data.users[m.sender].emasbiasa += ebz * 1
              db.data.users[m.sender].exp += mez * 1
              db.data.users[m.sender].potion += mpz * 1
              db.data.users[m.sender].healtmonster += hmz * 1
              db.data.users[m.sender].makananpet += lmz * 1
              db.data.users[m.sender].lastopen = new Date * 1
              conn.reply(m.chat, Mychatz, m)
              if (bbbz > 0) {
                conn.reply(m.chat, `*Selamat anda mendapatkan item Rare yaitu*\n${bbbz} Boxs Crate`, m)
                db.data.users[m.sender].boxs += bbbz * 1
              }
              if (mlz > 0) {
                conn.reply(m.chat, `*Selamat anda mendapatkan item Epic yaitu*\n${mlz} Legendary Crate`, m)
                db.data.users[m.sender].legendary += mlz * 1
              }
          ...
          break
        case '10':
          let __lastimedo = (new Date - db.data.users[m.sender].lastopen)
...
`.trim()
            if (db.data.users[m.sender].boxs >= 10) {
              db.data.users[m.sender].boxs -= 10
              db.data.users[m.sender].money += mme * 1
              db.data.users[m.sender].emasbiasa += ebe * 1
              db.data.users[m.sender].exp += mee * 1
              db.data.users[m.sender].potion += mpe * 1
              db.data.users[m.sender].healtmonster += hme * 1
              db.data.users[m.sender].makananpet += lme * 1
              db.data.users[m.sender].lastopen = new Date * 1
              conn.reply(m.chat, Mychate, m)
              if (bbbe > 0) {
                conn.reply(m.chat, `*Selamat anda mendapatkan item Rare yaitu*\n${bbbe} Boxs Crate`, m)
                db.data.users[m.sender].boxs += bbbe * 1
              }
              if (mle > 0) {
                conn.reply(m.chat, `*Selamat anda mendapatkan item Epic yaitu*\n${mle} Legendary Crate`, m)
                db.data.users[m.sender].legendary += mle * 1
              }
            } else conn.reply(m.chat, 'Boxs crate anda tidak cukup', m)
          } else conn.reply(m.chat, `Mohon tunggu ${lastimedo} lagi untuk bisa membuka fitur open`, m)
          break
        case '100':
          let __lastimedoo = (new Date - db.data.users[m.sender].lastopen)
...
`.trim()
            if (db.data.users[m.sender].boxs >= 100) {
              db.data.users[m.sender].boxs -= 100
              db.data.users[m.sender].money += mmk * 1
              db.data.users[m.sender].emasbiasa += ebk * 1
              db.data.users[m.sender].exp += mek * 1
              db.data.users[m.sender].potion += mpk * 1
              db.data.users[m.sender].healtmonster += hmk * 1
              db.data.users[m.sender].makananpet += lmk * 1
              db.data.users[m.sender].lastopen = new Date * 1
              conn.reply(m.chat, Mychatp, m)
              if (bbbk > 0) {
                conn.reply(m.chat, `*Selamat anda mendapatkan item Rare yaitu*\n${bbbk} Boxs Crate`, m)
                db.data.users[m.sender].boxs += bbbk * 1
              }
              if (mlk > 0) {
                conn.reply(m.chat, `*Selamat anda mendapatkan item Epic yaitu*\n${mlk} Legendary Crate`, m)
                db.data.users[m.sender].legendary += mlk * 1
              }
            } else conn.reply(m.chat, 'Boxs crate anda tidak cukup', m)
          } else conn.reply(m.chat, `Mohon tunggu ${lastimedoo} lagi untuk bisa membuka fitur open`, m)
          break
        case '1000':
          let __lastimedooo = (new Date - db.data.users[m.sender].lastopen)
...
`.trim()
            if (db.data.users[m.sender].boxs >= 1000) {
              db.data.users[m.sender].boxs -= 1000
              db.data.users[m.sender].money += mmo * 1
              db.data.users[m.sender].emasbiasa += ebo * 1
              db.data.users[m.sender].exp += meo * 1
              db.data.users[m.sender].potion += mpo * 1
              db.data.users[m.sender].healtmonster += hmo * 1
              db.data.users[m.sender].makananpet += lmo * 1
              db.data.users[m.sender].lastopen = new Date * 1
              conn.reply(m.chat, Mychatk, m)
              if (bbbo > 0) {
                conn.reply(m.chat, `*Selamat anda mendapatkan item Rare yaitu*\n${bbbo} Boxs Crate`, m)
                db.data.users[m.sender].boxs += bbbo * 1
              }
              if (mlo > 0) {
                conn.reply(m.chat, `*Selamat anda mendapatkan item Epic yaitu*\n${mlo} Legendary Crate`, m)
                db.data.users[m.sender].legendary += mlo * 1
              }
            } else conn.reply(m.chat, 'Boxs crate anda tidak cukup', m)
    ...
    case 'gardenboxs':
      switch (jumlah) {
        case '1':
        case 'crate':
          let __lastimedz = (new Date - db.data.users[m.sender].lastopen)
...
`.trim()
            if (db.data.users[m.sender].gardenboxs >= 0) {
              db.data.users[m.sender].gardenboxs -= 1
              db.data.users[m.sender].bibitmangga += alp * 1
              db.data.users[m.sender].bibitpisang += dlp * 1
              db.data.users[m.sender].bibitjeruk += clp * 1
              db.data.users[m.sender].bibitapel += blp * 1
              db.data.users[m.sender].bibitanggur += elp * 1
              db.data.users[m.sender].lastopen = new Date * 1
        ...
        case '10':
        case 'crate':
          let __lastimedzx = (new Date - db.data.users[m.sender].lastopen)
...
`.trim()
            if (db.data.users[m.sender].gardenboxs >= 9) {
              db.data.users[m.sender].gardenboxs -= 10
              db.data.users[m.sender].bibitmangga += lks * 1
              db.data.users[m.sender].bibitpisang += lkr * 1
              db.data.users[m.sender].bibitjeruk += lke * 1
              db.data.users[m.sender].bibitapel += lkd * 1
              db.data.users[m.sender].bibitanggur += lky * 1
              db.data.users[m.sender].lastopen = new Date * 1
        ...
        case '100':
        case 'crate':
          let __lastimedzxy = (new Date - db.data.users[m.sender].lastopen)
...
`.trim()
            if (db.data.users[m.sender].gardenboxs >= 99) {
              db.data.users[m.sender].gardenboxs -= 100
              db.data.users[m.sender].bibitmangga += lksb * 1
              db.data.users[m.sender].bibitpisang += lkrb * 1
              db.data.users[m.sender].bibitjeruk += lkeb * 1
              db.data.users[m.sender].bibitapel += lkdb * 1
              db.data.users[m.sender].bibitanggur += lkyb * 1
              db.data.users[m.sender].lastopen = new Date * 1
        ...
        case '1000':
        case 'crate':
          let __lastimedzxk = (new Date - db.data.users[m.sender].lastopen)
...
`.trim()
            if (db.data.users[m.sender].gardenboxs >= 999) {
              db.data.users[m.sender].gardenboxs -= 1000
              db.data.users[m.sender].bibitmangga += lksk * 1
              db.data.users[m.sender].bibitpisang += lkrk * 1
              db.data.users[m.sender].bibitjeruk += lkek * 1
              db.data.users[m.sender].bibitapel += lkdk * 1
              db.data.users[m.sender].bibitanggur += lkyk * 1
              db.data.users[m.sender].lastopen = new Date * 1
    ...
    case 'cupon':
      switch (jumlah) {
        case '1':
        case 'crate':
          let __lastimeki = (new Date - db.data.users[m.sender].lastopen)
...
`.trim()*/
            if (db.data.users[m.sender].cupon >= 1) {
              db.data.users[m.sender].cupon -= 1
              db.data.users[m.sender].money += mm * 1
              db.data.users[m.sender].exp += me * 1
              db.data.users[m.sender].limit += mp * 1
              // db.data.users[m.sender].nabung += mc * 1
              db.data.users[m.sender].bank += mci * 1
              db.data.users[m.sender].lastopen = new Date * 1
          ...
          break
        case '10':
          let __lastimekise = (new Date - db.data.users[m.sender].lastopen)
...
`.trim()*/
            if (db.data.users[m.sender].cupon >= 10) {
              db.data.users[m.sender].cupon -= 10
              db.data.users[m.sender].money += mmse * 1
              db.data.users[m.sender].exp += mese * 1
              db.data.users[m.sender].limit += mpse * 1
              //    db.data.users[m.sender].nabung += mcse * 1
              db.data.users[m.sender].bank += mcise * 1
              db.data.users[m.sender].lastopen = new Date * 1
    ...
    case 'legendary':
      switch (jumlah) {
        case '1':
        case 'crate':
          let __lastimel = (new Date - db.data.users[m.sender].lastopen)
...
`.trim()
            if (db.data.users[m.sender].legendary >= 1) {
              db.data.users[m.sender].legendary -= 1
              db.data.users[m.sender].money += lm * 1
              db.data.users[m.sender].diamond += ld * 1
              db.data.users[m.sender].exp += le * 1
              db.data.users[m.sender].potion += lp * 1
              db.data.users[m.sender].common += lc * 1
              db.data.users[m.sender].uncommon += lu * 1
              db.data.users[m.sender].lastopen = new Date * 1
              conn.reply(m.chat, Lechat, m)
              if (lmm > 0) {
                conn.reply(m.chat, `*Selamat anda mendapatkan item Rare yaitu*\n${lmm} Mythic Crate`, m)
                db.data.users[m.sender].mythic += lmm * 1
              }
              if (ll > 0 || lpp > 0) {
                conn.reply(m.chat,
                  `*Selamat anda mendapatkan item Epic yaitu*${ll > 0 ? `\n${ll} Legendary Crate` : ''}${lpp > 0 ? `\n${lpp} Pet Crate` : ''}`,
                  m)
                db.data.users[m.sender].legendary += ll * 1
                db.data.users[m.sender].pet += lpp * 1
              }
          ...
          break
        case '10':
          let __lastimele = (new Date - db.data.users[m.sender].lastopen)
...
`.trim()
            if (db.data.users[m.sender].legendary >= 10) {
              db.data.users[m.sender].legendary -= 10
              db.data.users[m.sender].money += lm1 * 1
              db.data.users[m.sender].diamond += ld1 * 1
              db.data.users[m.sender].exp += le1 * 1
              db.data.users[m.sender].potion += lp1 * 1
              db.data.users[m.sender].common += lc1 * 1
              db.data.users[m.sender].uncommon += lu1 * 1
              db.data.users[m.sender].lastopen = new Date * 1
              conn.reply(m.chat, Lechat1, m)
              if (lmm1 > 0) {
                conn.reply(m.chat, `*Selamat anda mendapatkan item Rare yaitu*\n${lmm1} Mythic Crate`, m)
                db.data.users[m.sender].mythic += lmm1 * 1
              }
              if (ll1 > 0 || lpp1 > 0) {
                conn.reply(m.chat,
                  `*Selamat anda mendapatkan item Epic yaitu*${ll1 > 0 ? `\n${ll1} Legendary Crate` : ''}${lpp1 > 0 ? `\n${lpp1} Pet Crate` : ''}`,
                  m)
                db.data.users[m.sender].legendary += ll1 * 1
                db.data.users[m.sender].pet += lpp1 * 1
              }
            } else conn.reply(m.chat, 'Legendary crate anda tidak cukup', m)
          } else conn.reply(m.chat, `Mohon tunggu ${lastimele} lagi untuk bisa membuka fitur open`, m)
          break
        case '100':
          let __lastimelee = (new Date - db.data.users[m.sender].lastopen)
...
`.trim()
            if (db.data.users[m.sender].legendary >= 100) {
              db.data.users[m.sender].legendary -= 100
              db.data.users[m.sender].money += lm2 * 1
              db.data.users[m.sender].diamond += ld2 * 1
              db.data.users[m.sender].exp += le2 * 1
              db.data.users[m.sender].potion += lp2 * 1
              db.data.users[m.sender].common += lc2 * 1
              db.data.users[m.sender].uncommon += lu2 * 1
              db.data.users[m.sender].lastopen = new Date * 1
              conn.reply(m.chat, Lechat2, m)
              if (lmm2 > 0) {
                conn.reply(m.chat, `*Selamat anda mendapatkan item Rare yaitu*\n${lmm2} Mythic Crate`, m)
                db.data.users[m.sender].mythic += lmm2 * 1
              }
              if (ll2 > 0 || lpp2 > 0) {
                conn.reply(m.chat,
                  `*Selamat anda mendapatkan item Epic yaitu*${ll2 > 0 ? `\n${ll2} Legendary Crate` : ''}${lpp2 > 0 ? `\n${lpp2} Pet Crate` : ''}`,
                  m)
                db.data.users[m.sender].legendary += ll2 * 1
                db.data.users[m.sender].pet += lpp2 * 1
              }
            } else conn.reply(m.chat, 'Legendary crate anda tidak cukup', m)
          } else conn.reply(m.chat, `Mohon tunggu ${lastimelee} lagi untuk bisa membuka fitur open`, m)
          break
        case '1000':
          let __lastimeleee = (new Date - db.data.users[m.sender].lastopen)
...
`.trim()
            if (db.data.users[m.sender].legendary >= 1000) {
              db.data.users[m.sender].legendary -= 1000
              db.data.users[m.sender].money += lm3 * 1
              db.data.users[m.sender].diamond += ld3 * 1
              db.data.users[m.sender].exp += le3 * 1
              db.data.users[m.sender].potion += lp3 * 1
              db.data.users[m.sender].common += lc3 * 1
              db.data.users[m.sender].uncommon += lu3 * 1
              db.data.users[m.sender].lastopen = new Date * 1
              conn.reply(m.chat, Lechat3, m)
              if (lmm3 > 0) {
                conn.reply(m.chat, `*Selamat anda mendapatkan item Rare yaitu*\n${lmm3} Mythic Crate`, m)
                db.data.users[m.sender].mythic += lmm3 * 1
              }
              if (ll3 > 0 || lpp3 > 0) {
                conn.reply(m.chat,
                  `*Selamat anda mendapatkan item Epic yaitu*${ll3 > 0 ? `\n${ll3} Legendary Crate` : ''}${lpp3 > 0 ? `\n${lpp3} Pet Crate` : ''}`,
                  m)
                db.data.users[m.sender].legendary += ll3 * 1
                db.data.users[m.sender].pet += lpp3 * 1
              }
            } else conn.reply(m.chat, 'Legendary crate anda tidak cukup', m)
    ...
    case 'pet':
      ...
      let _pet = `${pickRandom(['kucing', 'rubah','serigala','naga','centaur','phonix','kuda','griffin','kyubi'])}`
        .trim()
      let randpet =
        `${pickRandom(['Anda kurang beruntung', 'Coba buka lagi lain kali, karena gk dapet pet', 'kasian gk dapet pet', 'Mungkin lagi gk hoki dan gk dapet pet', 'wkwkkwkwke'])}`
        .trim()
      let __lastimepet = (new Date - db.data.users[m.sender].lastopen)
      let _lastimepet = (30000 - __lastimepet)
      let lastimepet = clockString(_lastimepet)
      if (new Date - db.data.users[m.sender].lastopen > 30000) {
        db.data.users[m.sender].lastopen = new Date * 1
        if (db.data.users[m.sender].pet > 0) {
          db.data.users[m.sender].pet -= 1
          if (_pet === 'kucing' && kucing > 0) {
            db.data.users[m.sender].potion += 2
            db.data.users[m.sender].makananpet += mknp * 1
            conn.reply(m.chat,
            ...
            db.data.users[m.sender].makananpet += mknp * 1
            conn.reply(m.chat,
              `*Selamat Anda mendapatkan pet ${_pet} ${mknp > 0 ? ` Dan ${mknp} Makanan Pet*` : '*'}`, m)
            ...
            db.data.users[m.sender].potion += 2
            db.data.users[m.sender].makanankyubi += mknp * 1
            conn.reply(m.chat,
              `Anda sudah memiliki pet ${_pet}, Hadiahmu diganti dengan 2 potion ${mknp > 0 ? `Dan ${mknp} Makanan Pet` : ''}`,
              m)
          } else if (_pet === 'kyubi' && kyubi === 0) {
            ...
            db.data.users[m.sender].potion += 2
            db.data.users[m.sender].makanancentaur += mknp * 1
            conn.reply(m.chat,
              `Anda sudah memiliki pet ${_pet}, Hadiahmu diganti dengan 2 potion ${mknp > 0 ? `Dan ${mknp} Makanan Pet` : ''}`,
              m)
          } else if (_pet === 'centaur' && centaur === 0) {
            ...
            db.data.users[m.sender].potion += 2
            db.data.users[m.sender].makanangriffin += mknp * 1
            conn.reply(m.chat,
              `Anda sudah memiliki pet ${_pet}, Hadiahmu diganti dengan 2 potion ${mknp > 0 ? `Dan ${mknp} Makanan Pet` : ''}`,
              m)
          } else if (_pet === 'griffin' && griffin === 0) {
            ...
            db.data.users[m.sender].serigala += 1
            db.data.users[m.sender].makananpet += mknp * 1
            conn.reply(m.chat,
              `*Selamat Anda mendapatkan pet ${_pet}${mknp > 0 ? ` Dan ${mknp} Makanan Pet*` : '*'}`, m)
