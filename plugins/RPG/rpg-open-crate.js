const handler = async (m, {
  ...
  switch (type) {
    ...
    case "pet":
      ...
      new Date() - db.data.users[m.sender].lastopen > 3e4 ? (db.data.users[m.sender].lastopen = 1 * new Date(), db.data.users[m.sender].pet > 0 ? (db.data.users[m.sender].pet -= 1, "kucing" === _pet && kucing > 0 ? (db.data.users[m.sender].potion += 2, db.data.users[m.sender].makananpet += 1 * mknp, await conn.reply(m.chat, `Anda sudah memiliki pet ${_pet}, Hadiahmu diganti dengan 2 potion${mknp > 0 ? ` Dan ${mknp} Makanan Pet` : ""}`, m)) : "kucing" === _pet && 0 === kucing ? (db.data.users[m.sender].kucing += 1, db.data.users[m.sender].makananpet += 1 * mknp, await conn.reply(m.chat, `*Selamat Anda mendapatkan pet ${_pet} ${mknp > 0 ? ` Dan ${mknp} Makanan Pet*` : "*"}`, m)) : "rubah" === _pet && rubah > 0 ? (db.data.users[m.sender].potion += 2, db.data.users[m.sender].makananpet += 1 * mknp, await conn.reply(m.chat, `Anda sudah memiliki pet ${_pet}, Hadiahmu diganti dengan 2 potion ${mknp > 0 ? `Dan ${mknp} Makanan Pet` : ""}`, m)) : "rubah" === _pet && 0 === rubah ? (db.data
          .users[m.sender].rubah += 1, db.data.users[m.sender].makananpet += 1 * mknp, await conn.reply(m.chat, `*Selamat Anda mendapatkan pet ${_pet}${mknp > 0 ? ` Dan ${mknp} Makanan Pet*` : "*"}`, m)) : "naga" === _pet && naga > 0 ? (db.data.users[m.sender].potion += 2, db.data.users[m.sender].makananpet += 1 * mknp, await conn.reply(m.chat, `Anda sudah memiliki pet ${_pet}, Hadiahmu diganti dengan 2 potion ${mknp > 0 ? `Dan ${mknp} Makanan Pet` : ""}`, m)) : "naga" === _pet && 0 === naga ? (db.data.users[m.sender].naga += 1, db.data.users[m.sender].makananpet += 1 * mknp, await conn.reply(m.chat, `*Selamat Anda mendapatkan pet ${_pet}${mknp > 0 ? ` Dan ${mknp} Makanan Pet*` : "*"}`, m)) : "phonix" === _pet && phonix > 0 ? (db.data.users[m.sender].potion += 2, db.data.users[m.sender].makananpet += 1 * mknp, await conn.reply(m.chat, `Anda sudah memiliki pet ${_pet}, Hadiahmu diganti dengan 2 potion ${mknp > 0 ? `Dan ${mknp} Makanan Pet` : ""}`, m)) : "phonix" === _pet &&
        0 === phonix ? (db.data.users[m.sender].phonix += 1, db.data.users[m.sender].makananpet += 1 * mknp, await conn.reply(m.chat, `*Selamat Anda mendapatkan pet ${_pet}${mknp > 0 ? ` Dan ${mknp} Makanan Pet*` : "*"}`, m)) : "kyubi" === _pet && kyubi > 0 ? (db.data.users[m.sender].potion += 2, db.data.users[m.sender].makanankyubi += 1 * mknp, await conn.reply(m.chat, `Anda sudah memiliki pet ${_pet}, Hadiahmu diganti dengan 2 potion ${mknp > 0 ? `Dan ${mknp} Makanan Pet` : ""}`, m)) : "kyubi" === _pet && 0 === kyubi ? (db.data.users[m.sender].kyubi += 1, db.data.users[m.sender].makanankyubi += 1 * mknp, await conn.reply(m.chat, `*Selamat Anda mendapatkan pet ${_pet}${mknp > 0 ? ` Dan ${mknp} Makanan Pet*` : "*"}`, m)) : "centaur" === _pet && centaur > 0 ? (db.data.users[m.sender].potion += 2, db.data.users[m.sender].makanancentaur += 1 * mknp, await conn.reply(m.chat,
          `Anda sudah memiliki pet ${_pet}, Hadiahmu diganti dengan 2 potion ${mknp > 0 ? `Dan ${mknp} Makanan Pet` : ""}`, m)) : "centaur" === _pet && 0 === centaur ? (db.data.users[m.sender].centaur += 1, db.data.users[m.sender].makanancentaur += 1 * mknp, await conn.reply(m.chat, `*Selamat Anda mendapatkan pet ${_pet}${mknp > 0 ? ` Dan ${mknp} Makanan Pet*` : "*"}`, m)) : "griffin" === _pet && griffin > 0 ? (db.data.users[m.sender].potion += 2, db.data.users[m.sender].makanangriffin += 1 * mknp, await conn.reply(m.chat, `Anda sudah memiliki pet ${_pet}, Hadiahmu diganti dengan 2 potion ${mknp > 0 ? `Dan ${mknp} Makanan Pet` : ""}`, m)) : "griffin" === _pet && 0 === griffin ? (db.data.users[m.sender].griffin += 1, db.data.users[m.sender].makanangriffin += 1 * mknp, await conn.reply(m.chat, `*Selamat Anda mendapatkan pet ${_pet}${mknp > 0 ? ` Dan ${mknp} Makanan Pet*` : "*"}`, m)) : "serigala" === _pet && serigala > 0 ? (db.data.users[m.sender].potion += 2, db.data.users[m
          .sender].makananpet += 1 * mknp, await conn.reply(m.chat, `Anda sudah memiliki pet ${_pet}, Hadiahmu diganti dengan 2 potion ${mknp > 0 ? `Dan ${mknp} Makanan Pet` : ""}`, m)) : "serigala" === _pet && 0 === serigala ? (db.data.users[m.sender].serigala += 1, db.data.users[m.sender].makananpet += 1 * mknp, await conn.reply(m.chat, `*Selamat Anda mendapatkan pet ${_pet}${mknp > 0 ? ` Dan ${mknp} Makanan Pet*` : "*"}`, m)) : "kuda" === _pet && kuda > 0 ? (db.data.users[m.sender].potion += 2, db.data.users[m.sender].makananpet += 1 * mknp, await conn.reply(m.chat, `Anda sudah memiliki pet ${_pet}, Hadiahmu diganti dengan 2 potion${mknp > 0 ? ` Dan ${mknp} Makanan Pet` : ""}`, m)) : "kuda" === _pet && 0 === kuda ? (db.data.users[m.sender].kuda += 1, db.data.users[m.sender].makananpet += 1 * mknp, await conn.reply(m.chat, `*Selamat Anda mendapatkan pet ${_pet}${mknp > 0 ? ` Dan ${mknp} Makanan Pet*` : "*"}`, m)) : (db.data.users[m.sender].makananpet += 1 * mknp, await conn
          .reply(m.chat, randpet + "Anda hanya mendapatkan *" + mknp + "* makanan pet", m))) : await conn.reply("Pet Crate kamu tidak cukup")) : await conn.reply(m.chat, `Mohon tunggu ${lastimepet} lagi untuk bisa membuka fitur open`, m);
      break;
    default:
