        ...
        if (/toko|buy/i.test(command)) {
            ...
            case 'buy':
                ...
                case 'fox':
                    ...
                    break
                case 'serigala':
                    if (db.data.users[m.sender].serigala === 1) return conn.reply(m.chat, 'Kamu sudah memiliki pet ini', m)
                ...
                case 'armor':
                    ...
                    break
                case 'fishingrod':
                    if (db.data.users[m.sender].pancing === 1) return conn.reply(m.chat, 'Kamu sudah memiliki pancingan', m)
                    if (db.data.users[m.sender].money > armor) {
            ...
            case 'upgrade':
                ...
                case 'armor':
                    ...
                    break
                case 'fishingrod':
                    if (db.data.users[m.sender].fishingrod === 4) return conn.reply(m.chat, 'Pancingan mu udah *Level Max*', m)
                    if (db.data.users[m.sender].fishingrod === 0) return conn.reply(m.chat, 'Kamu belum mempunyai Pancingan', m)
                ...
                case 'pickaxe':
                    ...
                    if (db.data.users[m.sender].pickaxe === 0) return conn.reply(m.chat, 'Kamu belum mempunyai Pickaxe', m)
            ...
            case 'repair':
                switch (_type) {
                case 'fishingrod':
                    if (db.data.users[m.sender].fishingroddurability === 80) return conn.reply(m.chat, 'Pancingan mu belum ada kerusakan', m)
                    if (db.data.users[m.sender].fishingrod === 0) return conn.reply(m.chat, 'Kamu belum mempunyai Pancingan', m)
                    ...
                    break
                case 'pickaxe':
                    if (db.data.users[m.sender].pickaxedurability === 80) return conn.reply(m.chat, 'Pickaxe mu belum ada kerusakan', m)
                    if (db.data.users[m.sender].pickaxe === 0) return conn.reply(m.chat, 'Kamu belum mempunyai Pickaxe', m)
                    ...
                    break
                case 'sword':
                    if (db.data.users[m.sender].sworddurability === 80) return conn.reply(m.chat, 'Sword mu belum ada kerusakan', m)
                    if (db.data.users[m.sender].sword === 0) return conn.reply(m.chat, 'Kamu belum mempunyai Sword', m)
