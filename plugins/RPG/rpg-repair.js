    ...
    if (/repair/i.test(command)) {
      ...
      switch (type) {
        case "pickaxe":
          ...
          user.rock -= 3, user.wood -= 5, user.iron -= 3, user.diamond -= 1,
            user.pickaxedurability = 100, m.reply("Sukses memperbaiki!");
          break;
        case "sword":
          ...
          user.wood -= 5, user.iron -= 9, user.diamond -= 1, user.sworddurability = 100,
        ...
        case "armor":
          ...
          user.iron -= 15, user.diamond -= 3, user.armordurability = 100,
            m.reply("Sukses memperbaiki!");
          break;
        default:
