const handler = async (m, { conn: conn }) => {
  let { lasthourly: lasthourly, lastberburu: lastberburu, lastbansos: lastbansos, lastadventure: lastadventure, lastfishing: lastfishing, lastwar: lastwar, lastduel: lastduel, lastmining: lastmining, lastdungeon: lastdungeon, lastclaim: lastclaim, lastweekly: lastweekly, lastmonthly: lastmonthly } = db.data.users[m.sender], warn = db.data.users[m.sender].warn, bann = db.data.users[m.sender].banned, str =
