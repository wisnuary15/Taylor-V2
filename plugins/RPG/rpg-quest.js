...
function createQuests() {
  let quests = [{
    ...
    pertanyaan: ["Siapa presiden pertama Indonesia?", "Apa simbol kimia untuk air?",
    ...
    pertanyaan: ["Apa nama tokoh fiksi paling terkenal dari Jepang?", "Apa simbol kimia untuk emas?",
    ...
    pertanyaan: ["Apa warna bendera Indonesia?", "Apa nama planet terbesar di tata surya?",
    ...
    pertanyaan: ["Apa nama tokoh kartun yang memakai baju bergaris merah putih?",
      "Apa simbol kimia untuk nitrogen?", "Berapakah 10 + 15?"
    ],
    ...
    pertanyaan: ["Apa nama alat musik gesek yang memiliki empat senar?", "Apa simbol kimia untuk belerang?",
      "Berapakah 7 x 7?"
    ],
    jawaban: ["biola", "s", "49"],
    reward: {
    ...
    pertanyaan: ["Apa warna daun saat musim semi?", "Apa nama planet terbesar kedelapan di tata surya?",
    ...
    pertanyaan: ["Siapa tokoh kartun anjing yang berwarna hitam dan putih?", "Apa simbol kimia untuk tembaga?",
      "Berapakah 16 ÷ 4?"
    ],
    jawaban: ["goofy", "cu", "4"],
    reward: {
    ...
    pertanyaan: ["Apa nama binatang yang berbisa dan melata?", "Apa bahasa resmi di Korea Utara?",
      "Berapakah 36 - 18?"
    ],
    ...
    pertanyaan: ["Siapa penulis novel 'Pride and Prejudice'?", "Apa simbol kimia untuk kalium?",
      "Berapakah 80 ÷ 10?"
    ],
    ...
    pertanyaan: ["Apa warna langit saat malam hari?", "Apa nama planet terbesar keenam di tata surya?",
    ...
    pertanyaan: ["Apa nama film trilogi 'The Lord of the Rings'?", "Apa simbol kimia untuk oksigen?",
      "Berapakah 100 - 25?"
    ],
    ...
    pertanyaan: ["Apa nama alat musik tiup yang terbuat dari logam?", "Apa simbol kimia untuk air raksa?",
      "Berapakah 18 x 4?"
    ],
    ...
    pertanyaan: ["Apa warna daun saat musim gugur?", "Apa nama planet terdekat dengan Matahari?",
      "Apa bahasa resmi di Korea Selatan?"
    ],
    ...
    pertanyaan: ["Siapa tokoh kartun yang tinggal di rumah nanas di dasar laut?", "Apa simbol kimia untuk perak?",
      "Berapakah 30 - 12?"
    ],
    ...
    pertanyaan: ["Siapa penulis novel 'To Kill a Mockingbird'?", "Apa simbol kimia untuk karbon?",
      "Berapakah 50 + 25?"
    ],
    ...
    pertanyaan: ["Apa warna langit saat siang hari?", "Apa nama planet terbesar kelima di tata surya?",
    ...
    pertanyaan: ["Apa nama tokoh kartun yang menggunakan topi merah dengan kacamata?",
      "Apa simbol kimia untuk besi?", "Berapakah akar kuadrat dari 144?"
    ],
    ...
    pertanyaan: ["Siapa presiden pertama Amerika Serikat?", "Apa nama planet terdekat dengan Bumi?",
    ...
    pertanyaan: ["Apa nama binatang karnivora terbesar di dunia?", "Apa simbol kimia untuk kalsium?",
      "Berapakah 20 + 30?"
    ],
    jawaban: ["singa", "ca", "50"],
    reward: {
    ...
    pertanyaan: ["Apa warna matahari saat terbenam?", "Apa nama planet terkecil di tata surya?",
...
async function handler(m, {
  ...
  if (m.sender in conn.quest) {
    ...
    if (text === 'start') {
      ...
      if (user.health === 0 || user.stamina === 0 || user.mana === 0) return m.reply(
        "❗ Stamina/health/mana Anda kurang dari 100.");
      if (typeof user.exp !== "number") db.data.users[m.sender].exp = 0;
      if (typeof user.crystal !== "number") db.data.users[m.sender].crystal = 0;
      if (typeof user.lastGameTime !== "number") db.data.users[m.sender].lastGameTime = 0;
