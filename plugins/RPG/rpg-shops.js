...
`.trim()
  try {
    if (/shop|toko/i.test(command)) {
      const count = args[2] && args[2].length > 0 ? Math.min(999999999999999, Math.max(parseInt(args[2]), 1)) : !
        args[2] || args.length < 4 ? 1 : Math.min(1, count)
          ...
          switch (_type) {
            case 'potion':
              if (db.data.users[m.sender].money >= potion * count) {
                ...
                conn.reply(m.chat,
                  `Succes membeli ${count} Potion dengan harga ${potion * count} money\n\nGunakan potion dengan ketik: *${usedPrefix}use potion <jumlah>*`,
                  m)
            ...
            case 'uncommon':
              if (db.data.users[m.sender].money >= Buncommon * count) {
                ...
                conn.reply(m.chat, `Succes membeli ${count} Uncommon crate dengan harga ${Buncommon * count} money`,
                  m)
              } else conn.reply(m.chat,
            ...
            case 'legendary':
              if (db.data.users[m.sender].money >= Blegendary * count) {
                ...
                conn.reply(m.chat,
                  `Succes membeli ${count} Legendary crate dengan harga ${Blegendary * count} money`, m)
              } else conn.reply(m.chat,
            ...
            case 'sampah':
              if (db.data.users[m.sender].money >= Bsampah * count) {
                ...
                `Uang anda tidak cukup untuk membeli ${count} Sampah dengan harga ${Bsampah * count} money`
              .trim(), m)
              break
            case 'kaleng':
              if (db.data.users[m.sender].money >= Bkaleng * count) {
                ...
                `Uang anda tidak cukup untuk membeli ${count} Kaleng dengan harga ${Bkaleng * count} money`
              .trim(), m)
              break
            case 'kardus':
              if (db.data.users[m.sender].money >= Bkardus * count) {
                ...
                `Uang anda tidak cukup untuk membeli ${count} Kardus dengan harga ${Bkardus * count} money`
              .trim(), m)
              break
            case 'botol':
              if (db.data.users[m.sender].money >= Bbotol * count) {
                ...
                `Uang anda tidak cukup untuk membeli ${count} botol dengan harga ${Bbotol * count} money`.trim(),
                m)
              break
            case 'kayu':
              if (db.data.users[m.sender].money >= Bkayu * count) {
                ...
                `Uang anda tidak cukup untuk membeli ${count} kayu dengan harga ${Bkayu * count} money`.trim(), m)
              break
            case 'pisang':
              if (db.data.users[m.sender].money >= Bpisang * count) {
                ...
                `Uang anda tidak cukup untuk membeli ${count} pisang dengan harga ${Bpisang * count} money`
              .trim(), m)
              break
            case 'anggur':
              if (db.data.users[m.sender].money >= Banggur * count) {
                ...
                `Uang anda tidak cukup untuk membeli ${count} anggur dengan harga ${Banggur * count} money`
              .trim(), m)
              break
            case 'mangga':
              if (db.data.users[m.sender].money >= Bmangga * count) {
                ...
                `Uang anda tidak cukup untuk membeli ${count} mangga dengan harga ${Bmangga * count} money`
              .trim(), m)
              break
            case 'jeruk':
              if (db.data.users[m.sender].money >= Bjeruk * count) {
                ...
                `Uang anda tidak cukup untuk membeli ${count} jeruk dengan harga ${Bjeruk * count} money`.trim(),
                m)
              break
            case 'apel':
              if (db.data.users[m.sender].money >= Bapel * count) {
                ...
                `Uang anda tidak cukup untuk membeli ${count} apel dengan harga ${Bapel * count} money`.trim(), m)
              break
            case 'bibitpisang':
              if (db.data.users[m.sender].money >= Bbibitpisang * count) {
                ...
                conn.reply(m.chat,
                  `Succes membeli ${count} Bibit Pisang dengan harga ${Bbibitpisang * count} money`, m)
              } else conn.reply(m.chat,
                `Uang anda tidak cukup untuk membeli ${count} bibit pisang dengan harga ${Bbibitpisang * count} money`
                .trim(), m)
              break
            case 'bibitanggur':
              if (db.data.users[m.sender].money >= Bbibitanggur * count) {
                ...
                conn.reply(m.chat,
                  `Succes membeli ${count} Bibit Anggur dengan harga ${Bbibitanggur * count} money`, m)
              } else conn.reply(m.chat,
                `Uang anda tidak cukup untuk membeli ${count} bibit anggur dengan harga ${Bbibitanggur * count} money`
                .trim(), m)
              break
            case 'bibitmangga':
              if (db.data.users[m.sender].money >= Bbibitmangga * count) {
                ...
                conn.reply(m.chat,
                  `Succes membeli ${count} Bibit Mangga dengan harga ${Bbibitmangga * count} money`, m)
              } else conn.reply(m.chat,
                `Uang anda tidak cukup untuk membeli ${count} bibit mangga dengan harga ${Bbibitmangga * count} money`
                .trim(), m)
              break
            case 'bibitjeruk':
              if (db.data.users[m.sender].money >= Bbibitjeruk * count) {
                ...
                conn.reply(m.chat, `Succes membeli ${count} Bibit Jeruk dengan harga ${Bbibitjeruk * count} money`,
                  m)
              } else conn.reply(m.chat,
                `Uang anda tidak cukup untuk membeli ${count} bibit jeruk dengan harga ${Bbibitjeruk * count} money`
                .trim(), m)
              break
            case 'bibitapel':
              if (db.data.users[m.sender].money >= Bbibitapel * count) {
                ...
                `Uang anda tidak cukup untuk membeli ${count} bibit apel dengan harga ${Bbibitapel * count} money`
                .trim(), m)
              break
            case 'gardenboxs':
              if (db.data.users[m.sender].money >= Bgardenboxs * count) {
                ...
                conn.reply(m.chat, `Succes membeli ${count} Gardenboxs dengan harga ${Bgardenboxs * count} money`,
                  m)
              } else conn.reply(m.chat,
                `Uang anda tidak cukup untuk membeli ${count} gardenboxs dengan harga ${Bgardenboxs * count} money`
                .trim(), m)
              break
            case 'berlian':
              if (db.data.users[m.sender].money >= Bberlian * count) {
                ...
                `Uang anda tidak cukup untuk membeli ${count} berlian dengan harga ${Bberlian * count} money`
                .trim(), m)
              break
            case 'emas':
              if (db.data.users[m.sender].money >= Bemasbiasa * count) {
                ...
                `Uang anda tidak cukup untuk membeli ${count} emas dengan harga ${Bemasbiasa * count} money`
                .trim(), m)
              break
            case 'pet':
              if (db.data.users[m.sender].money >= Bpet * count) {
                ...
                `Uang anda tidak cukup untuk membeli ${count} pet random dengan harga ${Bpet * count} money`
                .trim(), m)
              break
            case 'limit':
              if (db.data.users[m.sender].money >= Blimit * count) {
                ...
                `Uang anda tidak cukup untuk membeli ${count} limit dengan harga ${Blimit * count} money`.trim(),
                m)
              break
              /*case 'exp':
            ...
            case 'cupon':
              if (db.data.users[m.sender].tiketcoin >= Btiketcoin * count) {
                ...
                `Tiketcoin anda tidak cukup untuk membeli ${count} cupon dengan harga ${Btiketcoin * count} Tiketcoin\n\nCara mendapatkan tiketcoin, anda harus memainkan semua fitur game..`
                .trim(), m)
              break
            case 'makananpet':
              if (db.data.users[m.sender].money >= Bmakananpet * count) {
                ...
                conn.reply(m.chat, `Succes membeli ${count} Makanan Pet dengan harga ${Bmakananpet * count} money`,
                  m)
              } else conn.reply(m.chat,
                `Uang anda tidak cukup untuk membeli ${count} makanan pet dengan harga ${Bmakananpet * count} money`
                .trim(), m)
              break
            case 'makanannaga':
              if (db.data.users[m.sender].money >= Bmakanannaga * count) {
                ...
                conn.reply(m.chat,
                  `Succes membeli ${count} Makanan Naga dengan harga ${Bmakanannaga * count} money`, m)
              } else conn.reply(m.chat,
                `Uang anda tidak cukup untuk membeli ${count} makanan naga dengan harga ${Bmakanannaga * count} money`
                .trim(), m)
              break
            case 'makananphonix':
              if (db.data.users[m.sender].money >= Bmakananphonix * count) {
                ...
                conn.reply(m.chat,
                  `Succes membeli ${count} Makanan Phonix dengan harga ${Bmakananphonix * count} money`, m)
              } else conn.reply(m.chat,
                `Uang anda tidak cukup untuk membeli ${count} makanan phonix dengan harga ${Bmakananphonix * count} money`
                .trim(), m)
              break
            case 'makanankyubi':
              if (db.data.users[m.sender].money >= Bmakanankyubi * count) {
                ...
                conn.reply(m.chat,
                  `Succes membeli ${count} Makanan Kyubi dengan harga ${Bmakanankyubi * count} money`, m)
              } else conn.reply(m.chat,
                `Uang anda tidak cukup untuk membeli ${count} makanan kyubi dengan harga ${Bmakanankyubi * count} money`
                .trim(), m)
              break
            case 'makanangriffin':
              if (db.data.users[m.sender].money >= Bmakanangriffin * count) {
                ...
                conn.reply(m.chat,
                  `Succes membeli ${count} Makanan Griffin dengan harga ${Bmakanangriffin * count} money`, m)
              } else conn.reply(m.chat,
                `Uang anda tidak cukup untuk membeli ${count} makanan griffin dengan harga ${Bmakanangriffin * count} money`
                .trim(), m)
              break
            case 'makanancentaur':
              if (db.data.users[m.sender].money >= Bmakanancentaur * count) {
                ...
                conn.reply(m.chat,
                  `Succes membeli ${count} Makanan Centaur dengan harga ${Bmakanancentaur * count} money`, m)
              } else conn.reply(m.chat,
                `Uang anda tidak cukup untuk membeli ${count} makanan centaur dengan harga ${Bmakanancentaur * count} money`
                .trim(), m)
              break
            case 'tiketm':
              if (db.data.users[m.sender].money >= Bhealtmonster * count) {
                ...
                `Uang anda tidak cukup untuk membeli ${count} tiketm dengan harga ${Bhealtmonster * count} money`
                .trim(), m)
              break
            case 'aqua':
              if (db.data.users[m.sender].money >= Baqua * count) {
                ...
                `Uang anda tidak cukup untuk membeli ${count} aqua dengan harga ${Baqua * count} money`.trim(), m)
              break
            case 'iron':
              if (db.data.users[m.sender].money >= Biron * count) {
                ...
                `Uang anda tidak cukup untuk membeli ${count} iron dengan harga ${Biron * count} money`.trim(), m)
              break
            case 'string':
              if (db.data.users[m.sender].money >= Bstring * count) {
                ...
                `Uang anda tidak cukup untuk membeli ${count} string dengan harga ${Bstring * count} money`
              .trim(), m)
              break
            case 'sword':
              if (db.data.users[m.sender].money >= Bsword * count) {
                ...
                `Uang anda tidak cukup untuk membeli ${count} sword dengan harga ${Bsword * count} money`.trim(),
                m)
              break
            case 'batu':
              if (db.data.users[m.sender].money >= Bbatu * count) {
                ...
                `Uang anda tidak cukup untuk membeli ${count} batu dengan harga ${Bbatu * count} money`.trim(), m)
              break
            case 'umpan':
              if (db.data.users[m.sender].money >= Bumpan * count) {
                ...
                `Uang anda tidak cukup untuk membeli ${count} umpan dengan harga ${Bumpan * count} money`.trim(),
                m)
              break
            case 'pancingan':
              if (db.data.users[m.sender].money >= Bpancingan * count) {
                ...
                `Uang anda tidak cukup untuk membeli ${count} pancingan dengan harga ${Bpancingan * count} money`
                .trim(), m)
              break
            case 'armor':
          ...
          switch (_type) {
            ...
            case 'common':
              if (db.data.users[m.sender].common >= count * 1) {
                ...
                db.data.users[m.sender].common -= count * 1
                conn.reply(m.chat, `Succes menjual ${count} Common Crate dengan harga ${Scommon * count} money`
                  .trim(), m)
            ...
            case 'uncommon':
              if (db.data.users[m.sender].uncommon >= count * 1) {
                ...
                db.data.users[m.sender].uncommon -= count * 1
                conn.reply(m.chat, `Succes menjual ${count} Uncommon Crate dengan harga ${Suncommon * count} money`
                  .trim(), m)
            ...
            case 'mythic':
              if (db.data.users[m.sender].mythic >= count * 1) {
                ...
                db.data.users[m.sender].mythic -= count * 1
                conn.reply(m.chat, `Succes menjual ${count} Mythic Crate dengan harga ${Smythic * count} money`
                  .trim(), m)
            ...
            case 'legendary':
              if (db.data.users[m.sender].legendary >= count * 1) {
                ...
                db.data.users[m.sender].legendary -= count * 1
                conn.reply(m.chat,
                  `Succes menjual ${count} Legendary Crate dengan harga ${Slegendary * count} money`.trim(), m)
            ...
            case 'sampah':
              if (db.data.users[m.sender].sampah >= count * 1) {
                ...
                conn.reply(m.chat, `Succes menjual ${count} sampah, dan anda mendapatkan ${Ssampah * count} money`,
                  m)
            ...
            case 'kaleng':
              if (db.data.users[m.sender].kaleng >= count * 1) {
                ...
                conn.reply(m.chat, `Succes menjual ${count} kaleng, dan anda mendapatkan ${Skaleng * count} money`,
                  m)
            ...
            case 'kardus':
              if (db.data.users[m.sender].kardus >= count * 1) {
                ...
                conn.reply(m.chat, `Succes menjual ${count} kardus, dan anda mendapatkan ${Skardus * count} money`,
                  m)
            ...
            case 'pisang':
              if (db.data.users[m.sender].pisang >= count * 1) {
                ...
                conn.reply(m.chat, `Succes menjual ${count} pisang, dan anda mendapatkan ${Spisang * count} money`,
                  m)
            ...
            case 'anggur':
              if (db.data.users[m.sender].anggur >= count * 1) {
                ...
                conn.reply(m.chat, `Succes menjual ${count} anggur, dan anda mendapatkan ${Sanggur * count} money`,
                  m)
            ...
            case 'mangga':
              if (db.data.users[m.sender].mangga >= count * 1) {
                ...
                conn.reply(m.chat, `Succes menjual ${count} mangga, dan anda mendapatkan ${Smangga * count} money`,
                  m)
            ...
            case 'berlian':
              if (db.data.users[m.sender].berlian >= count * 1) {
                ...
                conn.reply(m.chat,
                  `Succes menjual ${count} berlian, dan anda mendapatkan ${Sberlian * count} money`, m)
            ...
            case 'emas':
              if (db.data.users[m.sender].emas >= count * 1) {
                ...
                conn.reply(m.chat,
                  `Succes menjual ${count} emas , dan anda mendapatkan ${Semasbiasa * count} money`, m)
            ...
            case 'pet':
              if (db.data.users[m.sender].pet >= count * 1) {
                ...
                conn.reply(m.chat, `Succes menjual ${count} pet random, dan anda mendapatkan ${Spet * count} money`,
                  m)
            ...
            case 'makananpet':
              if (db.data.users[m.sender].makananpet >= count * 1) {
                ...
                conn.reply(m.chat,
                  `Succes menjual ${count} makanan pet, dan anda mendapatkan ${Smakananpet * count} money`, m)
            ...
            case 'makananphonix':
              if (db.data.users[m.sender].makananphonix >= count * 1) {
                ...
                conn.reply(m.chat,
                  `Succes menjual ${count} makanan phonix, dan anda mendapatkan ${Smakananphonix * count} money`,
                  m)
            ...
            case 'makanannaga':
              if (db.data.users[m.sender].makanannaga >= count * 1) {
                ...
                conn.reply(m.chat,
                  `Succes menjual ${count} makanan naga, dan anda mendapatkan ${Smakanannaga * count} money`, m)
            ...
            case 'makanankyubi':
              if (db.data.users[m.sender].makanankyuni >= count * 1) {
                ...
                conn.reply(m.chat,
                  `Succes menjual ${count} makanan kyubi, dan anda mendapatkan ${Smakanankyubi* count} money`, m)
            ...
            case 'makanangriffin':
              if (db.data.users[m.sender].makanangriffin >= count * 1) {
                ...
                conn.reply(m.chat,
                  `Succes menjual ${count} makanan griffin, dan anda mendapatkan ${Smakanangriffin * count} money`,
                  m)
            ...
            case 'makanancentaur':
              if (db.data.users[m.sender].makanancentaur >= count * 1) {
                ...
                conn.reply(m.chat,
                  `Succes menjual ${count} makanan centaur, dan anda mendapatkan ${Smakanancentaur * count} money`,
                  m)
            ...
            case 'pancingan':
              if (db.data.users[m.sender].pancingan >= count * 1) {
                ...
                conn.reply(m.chat,
                  `Succes menjual ${count} pancingan, dan anda mendapatkan ${Spancingan * count} money`, m)
            ...
            case 'iron':
              if (db.data.users[m.sender].iron >= count * 1) {
                ...
                conn.reply(m.chat, `Succes menjual ${count} pancingan, dan anda mendapatkan ${Siron * count} money`,
                  m)
            ...
            case 'string':
              if (db.data.users[m.sender].string >= count * 1) {
                ...
                conn.reply(m.chat, `Succes menjual ${count} string, dan anda mendapatkan ${Sstring * count} money`,
                  m)
            ...
            case 'diamond':
              if (db.data.users[m.sender].diamond >= count * 1) {
                ...
                conn.reply(m.chat,
                  `Succes menjual ${count} Diamond, dan anda mendapatkan ${Sdiamond * count} money`, m)
      ...
      const count = args[1] && args[1].length > 0 ? Math.min(999999999999999, Math.max(parseInt(args[1]), 1)) : !
        args[1] || args.length < 3 ? 1 : Math.min(1, count)
      switch (type) {
        case 'potion':
          if (db.data.users[m.sender].money >= potion * count) {
            db.data.users[m.sender].money -= potion * count
        ...
        case 'legendary':
          if (db.data.users[m.sender].money >= Blegendary * count) {
            db.data.users[m.sender].legendary += count * 1
            db.data.users[m.sender].money -= Blegendary * count
            conn.reply(m.chat, `Succes membeli ${count} Legendary crate dengan harga ${Blegendary * count} money`,
              m)
          } else conn.reply(m.chat,
            `Uang anda tidak cukup untuk membeli ${count} Legendary crate dengan harga ${Blegendary * count} money\n\nBuka crate dengan ketik: *${usedPrefix}open legendary*`,
            m)
        ...
        case 'kaleng':
          if (db.data.users[m.sender].money >= Bkaleng * count) {
            ...
            `Uang anda tidak cukup untuk membeli ${count} Kaleng dengan harga ${Bkaleng * count} money`.trim(), m)
          break
        case 'kardus':
          if (db.data.users[m.sender].money >= Bkardus * count) {
            db.data.users[m.sender].kardus += count * 1
            ...
            `Uang anda tidak cukup untuk membeli ${count} Kardus dengan harga ${Bkardus * count} money`.trim(), m)
          break
        case 'botol':
          if (db.data.users[m.sender].money >= Bbotol * count) {
            db.data.users[m.sender].botol += count * 1
            ...
            `Uang anda tidak cukup untuk membeli ${count} botol dengan harga ${Bbotol * count} money`.trim(), m)
          break
        case 'kayu':
          if (db.data.users[m.sender].money >= Bkayu * count) {
            db.data.users[m.sender].kayu += count * 1
        ...
        case 'pisang':
          if (db.data.users[m.sender].money >= Bpisang * count) {
            ...
            `Uang anda tidak cukup untuk membeli ${count} pisang dengan harga ${Bpisang * count} money`.trim(), m)
          break
        case 'anggur':
          if (db.data.users[m.sender].money >= Banggur * count) {
            db.data.users[m.sender].anggur += count * 1
            ...
            `Uang anda tidak cukup untuk membeli ${count} anggur dengan harga ${Banggur * count} money`.trim(), m)
          break
        case 'mangga':
          if (db.data.users[m.sender].money >= Bmangga * count) {
            db.data.users[m.sender].mangga += count * 1
            ...
            `Uang anda tidak cukup untuk membeli ${count} mangga dengan harga ${Bmangga * count} money`.trim(), m)
          break
        case 'jeruk':
          if (db.data.users[m.sender].money >= Bjeruk * count) {
            db.data.users[m.sender].jeruk += count * 1
            ...
            `Uang anda tidak cukup untuk membeli ${count} jeruk dengan harga ${Bjeruk * count} money`.trim(), m)
          break
        case 'apel':
          if (db.data.users[m.sender].money >= Bapel * count) {
            db.data.users[m.sender].apel += count * 1
        ...
        case 'berlian':
          if (db.data.users[m.sender].money >= Bberlian * count) {
            ...
            `Uang anda tidak cukup untuk membeli ${count} berlian dengan harga ${Bberlian * count} money`.trim(),
            m)
          break
        case 'emas':
          if (db.data.users[m.sender].money >= Bemasbiasa * count) {
            ...
            `Uang anda tidak cukup untuk membeli ${count} emas dengan harga ${Bemasbiasa * count} money`.trim(), m
            )
          break
        case 'pet':
          if (db.data.users[m.sender].money >= Bpet * count) {
            ...
            `Uang anda tidak cukup untuk membeli ${count} pet random dengan harga ${Bpet * count} money`.trim(), m
            )
          break
        case 'limit':
          if (db.data.users[m.sender].money >= Blimit * count) {
            ...
            `Uang anda tidak cukup untuk membeli ${count} limit dengan harga ${Blimit * count} money`.trim(), m)
          break
          /*case 'exp':
                   if (db.data.users[m.sender].money >= Bexp * count) {
                       db.data.users[m.sender].exp += count * 1
        ...
        case 'makanannaga':
          if (db.data.users[m.sender].money >= Bmakanannaga * count) {
            ...
            `Uang anda tidak cukup untuk membeli ${count} makanan pet dengan harga ${Bmakanannaga * count} money`
            .trim(), m)
          break
        case 'makananphonix':
          if (db.data.users[m.sender].money >= Bmakananphonix * count) {
            ...
            `Uang anda tidak cukup untuk membeli ${count} makanan pet dengan harga ${Bmakananphonix * count} money`
            .trim(), m)
          break
        case 'makanankyubi':
          if (db.data.users[m.sender].money >= Bmakanankyubi * count) {
            db.data.users[m.sender].makanankyubi += count * 1
            db.data.users[m.sender].money -= Bmakanankyubi * count
            conn.reply(m.chat, `Succes membeli ${count} Makanan Kyubi dengan harga ${Bmakanankyubi * count} money`,
              m)
          } else conn.reply(m.chat,
            `Uang anda tidak cukup untuk membeli ${count} makanan kyubi dengan harga ${Bmakanankyubi * count} money`
            .trim(), m)
        ...
        case 'string':
          if (db.data.users[m.sender].money >= Bstring * count) {
            ...
            `Uang anda tidak cukup untuk membeli ${count} string dengan harga ${Bstring * count} money`.trim(), m)
          break
        case 'sword':
          if (db.data.users[m.sender].money >= Bsword * count) {
            db.data.users[m.sender].sword += count * 1
            ...
            `Uang anda tidak cukup untuk membeli ${count} sword dengan harga ${Bsword * count} money`.trim(), m)
          break
        case 'batu':
          if (db.data.users[m.sender].money >= Bbatu * count) {
            db.data.users[m.sender].batu += count * 1
        ...
        case 'umpan':
          if (db.data.users[m.sender].money >= Bumpan * count) {
            ...
            `Uang anda tidak cukup untuk membeli ${count} umpan dengan harga ${Bumpan * count} money`.trim(), m)
          break
        case 'pancingan':
          if (db.data.users[m.sender].money >= Bpancingan * count) {
            db.data.users[m.sender].pancingan += count * 1
      ...
      switch (type) {
        ...
        case 'common':
          if (db.data.users[m.sender].common >= count * 1) {
            db.data.users[m.sender].money += Scommon * count
            db.data.users[m.sender].common -= count * 1
            conn.reply(m.chat, `Succes menjual ${count} Common Crate dengan harga ${Scommon * count} money`.trim(),
              m)
          } else conn.reply(m.chat, `Common Crate kamu tidak cukup`.trim(), m)
          break
        case 'uncommon':
        ...
        case 'mythic':
          if (db.data.users[m.sender].mythic >= count * 1) {
            db.data.users[m.sender].money += Smythic * count
            db.data.users[m.sender].mythic -= count * 1
            conn.reply(m.chat, `Succes menjual ${count} Mythic Crate dengan harga ${Smythic * count} money`.trim(),
              m)
          } else conn.reply(m.chat, `Mythic Crate kamu tidak cukup`.trim(), m)
          break
        case 'legendary':
          if (db.data.users[m.sender].legendary >= count * 1) {
            db.data.users[m.sender].money += Slegendary * count
            db.data.users[m.sender].legendary -= count * 1
            conn.reply(m.chat, `Succes menjual ${count} Legendary Crate dengan harga ${Slegendary * count} money`
              .trim(), m)
          } else conn.reply(m.chat, `Legendary Crate kamu tidak cukup`.trim(), m)
          break
        case 'sampah':
        ...
        case 'makananphonix':
          if (db.data.users[m.sender].makananphonix >= count * 1) {
            ...
            db.data.users[m.sender].money += Smakananphonix * count
            conn.reply(m.chat,
              `Succes menjual ${count} makanan phonix, dan anda mendapatkan ${Smakananphonix * count} money`, m)
          } else conn.reply(m.chat, `Makanan phonix anda tidak cukup`, m)
          break
        case 'makanankyubi':
          if (db.data.users[m.sender].makanankyuni >= count * 1) {
        ...
        case 'makanangriffin':
          if (db.data.users[m.sender].makanangriffin >= count * 1) {
            ...
            db.data.users[m.sender].money += Smakanangriffin * count
            conn.reply(m.chat,
              `Succes menjual ${count} makanan griffin, dan anda mendapatkan ${Smakanangriffin * count} money`, m)
          } else conn.reply(m.chat, `Makanan griffin anda tidak cukup`, m)
          break
        case 'makanancentaur':
          if (db.data.users[m.sender].makanancentaur >= count * 1) {
            ...
            db.data.users[m.sender].money += Smakanancentaur * count
            conn.reply(m.chat,
              `Succes menjual ${count} makanan centaur, dan anda mendapatkan ${Smakanancentaur * count} money`, m)
          } else conn.reply(m.chat, `Makanan centaur anda tidak cukup`, m)
          break
        case 'aqua':
          if (db.data.users[m.sender].aqua >= count * 1) {
