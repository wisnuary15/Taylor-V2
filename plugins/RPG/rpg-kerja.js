...
const taskInformation = {
  '🌾 Menanam dan memanen tanaman': ['Telah menanam jagung sebanyak 100 batang.',
    'Berhasil memanen 50 kg tomat dengan hasil bagus.',
    'Menanggulangi hama dan penyakit pada tanaman dengan sukses.', 'Menciptakan varietas baru tanaman yang unggul.',
    'Mengikuti pelatihan pertanian terkemuka untuk meningkatkan keterampilan.'
  ],
  '🛒 Mencari pembeli': ['Mendapatkan pelanggan setia yang selalu membeli produk.',
  ...
  '💉 Merawat pasien': ['Menyembuhkan penyakit langka yang tidak bisa disembuhkan sebelumnya.',
  ...
  '🔧 Memperbaiki kendaraan': ['Berhasil memperbaiki mobil mewah milik selebriti terkenal.',
  ...
  '🛵 Mengantarkan penumpang': ['Menyelesaikan banyak perjalanan dalam waktu singkat.',
    'Membawa penumpang ke tujuan dengan aman dan tepat waktu.', 'Mendapat review positif dari banyak penumpang.',
  ...
  '🏋️ Membantu proyek konstruksi': ['Berpartisipasi dalam proyek konstruksi terbesar di kota.',
  ...
  '🎮 Main game dan streaming': ['Mencapai prestasi tertinggi di dalam game populer.',
  ...
  '👩‍🏫 Mengajar dan memberi pembelajaran': ['Meningkatkan hasil belajar siswa secara signifikan.',
  ...
  '🎨 Membuat desain grafis': ['Menghasilkan desain logo yang menarik untuk perusahaan ternama.',
...
const handler = async (m, {
  ...
  if (/kerja|work/i.test(command)) {
    ...
    if (!jobData)
    throw '😅 Pekerjaan tidak ditemukan. Silakan pilih bidang pekerjaan yang sesuai dari daftar berikut:\n' +
    ...
    const earnedMoney = jobData.money * (jobData.difficulty === 'Extreme' ? 3 : jobData.difficulty === 'Hard' ? 2 :
      1) * 10;
