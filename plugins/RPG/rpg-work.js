const handler = async (m, {
  ...
  try {
    ...
    user.healt -= health, user.exp += exp, user.money += money, user.potion += potion,
      user.diamond += diamond, user.common += common, user.uncommon += uncommon,
      user.sampah += sampah, user.iron += iron, user.batu += batu, user.kayu += kayu,
      user.string += string, user.lastadventure = currentTime;
