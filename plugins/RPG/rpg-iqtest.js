let soal = [{
  ...
  pertanyaan: ["Apa nama tokoh kartun yang memakai baju bergaris merah putih?", "Apa simbol kimia untuk nitrogen?",
    "Berapakah 10 + 15?"
  ],
  ...
  pertanyaan: ["Apa nama tokoh kartun yang menggunakan topi merah dengan kacamata?", "Apa simbol kimia untuk besi?",
...
handler.before = async (m, {
  ...
  const scoreMessage = isCorrect ? `🎉 Anda mendapatkan ${reward.iq} poin IQ.` :
  ...
  if (nextQuestionIndex < soal.length) {
    ...
    message +=
      `🔔 Pertanyaan ${nextQuestionIndex + 1} dari ${totalQuestions}: ${currentQuestion}\n\nKetik jawaban Anda (ketik "stop" untuk menghentikan permainan):`;
    conn.iqtest[m.chat].currentAnswer = currentAnswer;
