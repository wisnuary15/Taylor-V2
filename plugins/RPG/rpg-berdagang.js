...
const cooldown = 288e5,
  handler = async (m, {
    ...
    {
      if ((Math.random() * 5001 + 5e3 | 0) > user.money) throw "Target tidak memiliki modal harap masukkan modal 5000";
      if ((Math.random() * 5001 + 5e3 | 0) > user.money) throw "kamu tidak memiliki modal harap masukkan modal 5000";
