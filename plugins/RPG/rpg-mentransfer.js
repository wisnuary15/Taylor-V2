const handler = async (m, { conn: conn, args: args, usedPrefix: usedPrefix, DevMode: DevMode }) => {
    ...
    switch (type) {
      case "money":
        if (db.data.users[m.sender].money >= 1 * count) try {
          ...
          if (db.data.users[m.sender].money += 1 * count, m.reply("Gagal Menstransfer"), console.log(e),
            DevMode)
      ...
      case "tabungan":
        if (db.data.users[m.sender].atm >= 1 * count) try {
          ...
          if (db.data.users[m.sender].atm += 1 * count, m.reply("Gagal Menstransfer"), console.log(e),
            DevMode)
            for (let jid of owner.map((v => v.replace(/[^0-9]/g, "") + "@s.whatsapp.net")).filter((v => v != conn.user.jid))) await conn.reply(jid, "Transfer.js error\nNo: *" + m.sender.split("@")[0] + "*\nCommand: *" + m.text + "*\n\n*" + e + "*", m);
      ...
      case "limit":
        if (db.data.users[m.sender].limit >= 1 * count) try {
          ...
          if (db.data.users[m.sender].limit += 1 * count, m.reply("Gagal Menstransfer"), console.log(e),
            DevMode)
            for (let jid of owner.map((v => v.replace(/[^0-9]/g, "") + "@s.whatsapp.net")).filter((v => v != conn.user.jid))) await conn.reply(jid, "Transfer.js error\nNo: *" + m.sender.split("@")[0] + "*\nCommand: *" + m.text + "*\n\n*" + e + "*", m);
      ...
      case "potion":
        if (db.data.users[m.sender].potion >= 1 * count) try {
          ...
          if (db.data.users[m.sender].potion += 1 * count, m.reply("Gagal Menstransfer"),
      ...
      case "sampah":
        if (db.data.users[m.sender].sampah >= 1 * count) try {
          ...
          if (db.data.users[m.sender].sampah += 1 * count, m.reply("Gagal Menstransfer"),
            console.log(e), DevMode)
            for (let jid of owner.map((v => v.replace(/[^0-9]/g, "") + "@s.whatsapp.net")).filter((v => v != conn.user.jid))) await conn.reply(jid, "Transfer.js error\nNo: *" + m.sender.split("@")[0] + "*\nCommand: *" + m.text + "*\n\n*" + e + "*", m);
      ...
      case "diamond":
        if (db.data.users[m.sender].diamond >= 1 * count) try {
          ...
          if (db.data.users[m.sender].diamond += 1 * count, m.reply("Gagal Menstransfer"),
            console.log(e), DevMode)
            for (let jid of owner.map((v => v.replace(/[^0-9]/g, "") + "@s.whatsapp.net")).filter((v => v != conn.user.jid))) await conn.reply(jid, "Transfer.js error\nNo: *" + m.sender.split("@")[0] + "*\nCommand: *" + m.text + "*\n\n*" + e + "*", m);
      ...
      case "common":
        if (db.data.users[m.sender].common >= 1 * count) try {
          ...
          if (db.data.users[m.sender].common += 1 * count, m.reply("Gagal Menstransfer"),
            console.log(e), DevMode)
            for (let jid of owner.map((v => v.replace(/[^0-9]/g, "") + "@s.whatsapp.net")).filter((v => v != conn.user.jid))) await conn.reply(jid, "Transfer.js error\nNo: *" + m.sender.split("@")[0] + "*\nCommand: *" + m.text + "*\n\n*" + e + "*", m);
      ...
      case "uncommon":
        if (db.data.users[m.sender].uncommon >= 1 * count) try {
          ...
          if (db.data.users[m.sender].uncommon += 1 * count, m.reply("Gagal Menstransfer"),
            console.log(e), DevMode)
            for (let jid of owner.map((v => v.replace(/[^0-9]/g, "") + "@s.whatsapp.net")).filter((v => v != conn.user.jid))) await conn.reply(jid, "Transfer.js error\nNo: *" + m.sender.split("@")[0] + "*\nCommand: *" + m.text + "*\n\n*" + e + "*", m);
      ...
      case "mythic":
        if (db.data.users[m.sender].mythic >= 1 * count) try {
          ...
          if (db.data.users[m.sender].mythic += 1 * count, m.reply("Gagal Menstransfer"),
            console.log(e), DevMode)
            for (let jid of owner.map((v => v.replace(/[^0-9]/g, "") + "@s.whatsapp.net")).filter((v => v != conn.user.jid))) await conn.reply(jid, "Transfer.js error\nNo: *" + m.sender.split("@")[0] + "*\nCommand: *" + m.text + "*\n\n*" + e + "*", m);
      ...
      case "legendary":
        if (db.data.users[m.sender].legendary >= 1 * count) try {
          ...
          if (db.data.users[m.sender].legendary += 1 * count, m.reply("Gagal Menstransfer"),
            console.log(e), DevMode)
            for (let jid of owner.map((v => v.replace(/[^0-9]/g, "") + "@s.whatsapp.net")).filter((v => v != conn.user.jid))) await conn.reply(jid, "Transfer.js error\nNo: *" + m.sender.split("@")[0] + "*\nCommand: *" + m.text + "*\n\n*" + e + "*", m);
      ...
      case "string":
        if (db.data.users[m.sender].string >= 1 * count) try {
          ...
          if (db.data.users[m.sender].string += 1 * count, m.reply("Gagal Menstransfer"),
            console.log(e), DevMode)
            for (let jid of owner.map((v => v.replace(/[^0-9]/g, "") + "@s.whatsapp.net")).filter((v => v != conn.user.jid))) await conn.reply(jid, "Transfer.js error\nNo: *" + m.sender.split("@")[0] + "*\nCommand: *" + m.text + "*\n\n*" + e + "*", m);
      ...
      case "batu":
        if (db.data.users[m.sender].batu >= 1 * count) try {
          ...
          if (db.data.users[m.sender].batu += 1 * count, m.reply("Gagal Menstransfer"), console.log(e),
            DevMode)
            for (let jid of owner.map((v => v.replace(/[^0-9]/g, "") + "@s.whatsapp.net")).filter((v => v != conn.user.jid))) await conn.reply(jid, "Transfer.js error\nNo: *" + m.sender.split("@")[0] + "*\nCommand: *" + m.text + "*\n\n*" + e + "*", m);
      ...
      case "kayu":
        if (db.data.users[m.sender].kayu >= 1 * count) try {
          ...
          if (db.data.users[m.sender].kayu += 1 * count, m.reply("Gagal Menstransfer"), console.log(e),
            DevMode)
            for (let jid of owner.map((v => v.replace(/[^0-9]/g, "") + "@s.whatsapp.net")).filter((v => v != conn.user.jid))) await conn.reply(jid, "Transfer.js error\nNo: *" + m.sender.split("@")[0] + "*\nCommand: *" + m.text + "*\n\n*" + e + "*", m);
      ...
      case "iron":
        if (db.data.users[m.sender].iron >= 1 * count) try {
          ...
          if (db.data.users[m.sender].iron += 1 * count, m.reply("Gagal Menstransfer"), console.log(e),
            DevMode)
            for (let jid of owner.map((v => v.replace(/[^0-9]/g, "") + "@s.whatsapp.net")).filter((v => v != conn.user.jid))) await conn.reply(jid, "Transfer.js error\nNo: *" + m.sender.split("@")[0] + "*\nCommand: *" + m.text + "*\n\n*" + e + "*", m);
