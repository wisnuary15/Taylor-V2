...
const handler = async (m, {
  ...
  let kodes = args[0] === '085213' || args[0] === '443321' || args[0] === '662522' || args[0] === '322929' || args[
      0] === '562622' || args[0] === '432282' || args[0] === '002819' || args[0] === '715611' || args[0] ===
    '882910' || args[0] === '882010' || args[0] === '937100' || args[0] === '736390' || args[0] === '762837' ||
    args[0] === '028393' || args[0] === '625529' || args[0] === '727638' || args[0] === '992719' || args[0] ===
    '092739' || args[0] === '727269' || args[0] === '629461' || args[0] === '239210'
  if (kodes) {
