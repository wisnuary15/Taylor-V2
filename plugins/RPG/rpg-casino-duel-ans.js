export async function before(m) {
  if (db.data.rpg.casinomulti = db.data.rpg.casinomulti ? db.data.rpg.casinomulti : {}, m.isGroup && m.chat in db.data.rpg.casinomulti && m.sender === db.data.rpg.casinomulti[m.chat].player_2 && /^(acc(ept)?|terima|gas|oke?|tolak|gamau|nanti|ga(k.)?bisa|y)/i.test(m.text)) {
    if (/^(tolak|gamau|nanti|n|ga(k.)?bisa)/i.test(m.text)) return this.sendMessage(m.chat, {
      ...
      quoted: m
    }), delete db.data.rpg.casinomulti[m.chat], !0;
    db.data.users[db.data.rpg.casinomulti[m.chat].player_1].money -= 1 * db.data.rpg.casinomulti[m.chat].count,
      db.data.users[db.data.rpg.casinomulti[m.chat].player_2].money -= 1 * db.data.rpg.casinomulti[m.chat].count;
    ...
    if (randomplayer_1 > randomplayer_2) {
      ...
      await conn.reply(m.chat, caption, m, {
        ...
        }), db.data.users[db.data.rpg.casinomulti[m.chat].player_1].money += 2 * db.data.rpg.casinomulti[m.chat].count,
      ...
      await conn.reply(m.chat, caption, m, {
          mentions: this.parseMention(caption)
        }), db.data.users[db.data.rpg.casinomulti[m.chat].player_2].money += 2 * db.data.rpg.casinomulti[m.chat].count,
        delete db.data.rpg.casinomulti[m.chat];
    } else {
      let caption = `💰 *C A S I N O - D U E L* 💰\n\n${htjava} @${db.data.rpg.casinomulti[m.chat].player_1.split("@")[0]} - [${sya}]\n┗┅⭑ \n${randomplayer_1} Point\n${htjava} @${db.data.rpg.casinomulti[m.chat].player_2.split("@")[0]} - [${lwn}]\n┗┅⭑ ${randomplayer_2} Point\n\nKalian berdua seri dan ${db.data.rpg.casinomulti[m.chat].count} Money dikembalikan`.trim();
      await conn.reply(m.chat, caption, m, {
          mentions: this.parseMention(caption)
        }), db.data.users[db.data.rpg.casinomulti[m.chat].player_1].money, db.data.rpg.casinomulti[m.chat].count,
        db.data.users[db.data.rpg.casinomulti[m.chat].player_2].money, db.data.rpg.casinomulti[m.chat].count,
        delete db.data.rpg.casinomulti[m.chat];
    }
  }
}