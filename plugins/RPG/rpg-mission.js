    ...
    if (/^accept?$/i.test(txt)) {
      if (Aku > Kamu) {
        ...
        m.reply("" + (json.title ? `You got a title ${json.title}` : "")),
          m.reply(cpt), user.exp += json.exp, user.crystal += json.crystal,
          user.title += json.title, user.misi += json.misii;
      } else if (Aku < Kamu) {
        ...
        m.reply("" + (json.title ? `You got a title ${json.title}` : "")),
          m.reply(cpe), user.exp += json.exp, user.crystal += json.crystal,
          user.title += json.title, user.misi += json.misii;
      }
