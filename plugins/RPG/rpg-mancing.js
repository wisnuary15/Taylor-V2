const handler = async (m, {
  ...
  let pemancing = conn.getName(m.sender)
    ...
    if (/fishing|mancing/i.test(command)) {
      switch (type) {
        case 'emosi':
          ...
          if (pengguna.stamina < 20) return m.reply(
...
${ usedPrefix }cook`
        ...
        case 'easy':
          ...
          if (pancingan === 0 || umpan === 0) return conn.reply(m.chat,
            `*[❗] kamu tidak punya kail pancingan dan umpan 100 🎣*`, m)
...
`.trim()
                ...
                setTimeout(() => {
                  conn.reply(m.chat, `${pemancing} Yuk mancing mania level easy lagi`, null)
                }, 28800000)
                setTimeout(() => {
...
`.trim()
                ...
                setTimeout(() => {
                  conn.reply(m.chat, `${pemancing} Yuk mancing mania level normal lagi`, null)
                }, 28800000)
                setTimeout(() => {
...
`.trim()
                ...
                setTimeout(() => {
                  conn.reply(m.chat, `${pemancing} Yuk mancing mania level hard lagi`, null)
                }, 28800000)
                setTimeout(() => {
...
`.trim()
                ...
                setTimeout(() => {
                  conn.reply(m.chat, `${pemancing} Yuk mancing mania level extreme lagi`, null)
                }, 28800000)
                setTimeout(() => {
