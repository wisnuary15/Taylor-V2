    ...
    if (/fishing|mancing/i.test(command)) switch (type) {
      case "emosi":
        ...
        if (new Date() - pengguna.lastfishing > 24e4) {
          ...
          setTimeout(async () => {
              await conn.reply(m.chat, mcng, null), psepick > 0 && (pengguna.psepick += 1 * psepick, await conn.reply(m.chat, `You Get 🎁chest weapons epic ${psepick} item`, m)),
                psenjata > 0 && (pengguna.psenjata += 1 * psenjata, await conn.reply(m.chat, `You Get 🎁chest weapons ${psenjata} item`, m));
        ...
        if (new Date() - pengguna.lastmancingeasy > 288e5)
          if (pengguna.pancingan > 1)
            if (pengguna.umpan > 99) {
              ...
              pengguna.paus += rbrb1, pengguna.kepiting += rbrb2, pengguna.gurita += rbrb3,
                pengguna.cumi += rbrb4, pengguna.buntal += rbrb5, pengguna.dory += rbrb6,
                pengguna.lumba += rbrb7, pengguna.lobster += rbrb8, pengguna.hiu += rbrb9,
                pengguna.udang += rbrb10, pengguna.ikan += rbrb11, pengguna.orca += rbrb12,
          ...
          if (pengguna.pancingan > 2)
            if (pengguna.umpan > 149) {
              let mcingd1 = `${Math.floor(50 * Math.random())}`,
                ...
                aine12 = `${mcg12}`,
                hsls = `\n*${htjava} Hasil Memancing ${pemancing} ${htjava}*\n *🦀 = [ ${aine2} ]*\t\t\t*🐠 = [ ${aine6} ]*\n *🦞 = [ ${aine8} ]*\t\t\t *🐟 = [ ${aine11} ]*\n *🦐 = [ ${aine10} ]*\t\t\t *🐬 = [ ${aine7} ]*\n *🦑 = [ ${aine4} ]*\t\t\t *🐳 = [ ${aine12} ]*\n *🐙 = [ ${aine3} ]*\t\t\t *🦈 = [ ${aine9} ]*\n  *🐡 = [ ${aine5} ]*\t\t\t*🐋 = [ ${aine1} ]*\n  \n+1 Tiketcoin\n`.trim();
              pengguna.paus += mcg1, pengguna.kepiting += mcg2, pengguna.gurita += mcg3,
                pengguna.cumi += mcg4, pengguna.buntal += mcg5, pengguna.dory += mcg6,
                pengguna.lumba += mcg7, pengguna.lobster += mcg8, pengguna.hiu += mcg9,
                pengguna.udang += mcg10, pengguna.ikan += mcg11, pengguna.orca += mcg12,
          ...
          if (pengguna.pancingan > 3)
            if (pengguna.umpan > 199) {
              let mcingr1 = `${Math.floor(100 * Math.random())}`,
                ...
                aines12 = `${mcgh12}`,
                hslsh = `\n*${htjava} Hasil Memancing ${pemancing} ${htjava}*\n *🦀 = [ ${aines2} ]*\t\t\t*🐠 = [ ${aines6} ]*\n *🦞 = [ ${aines8} ]*\t\t\t *🐟 = [ ${aines11} ]*\n *🦐 = [ ${aines10} ]*\t\t\t *🐬 = [ ${aines7} ]*\n *🦑 = [ ${aines4} ]*\t\t\t *🐳 = [ ${aines12} ]*\n *🐙 = [ ${aines3} ]*\t\t\t *🦈 = [ ${aines9} ]*\n  *🐡 = [ ${aines5} ]*\t\t\t*🐋 = [ ${aines1} ]*\n  \n+1 Tiketcoin\n`.trim();
              pengguna.paus += mcgh1, pengguna.kepiting += mcgh2, pengguna.gurita += mcgh3,
                pengguna.cumi += mcgh4, pengguna.buntal += mcgh5, pengguna.dory += mcgh6,
                pengguna.lumba += mcgh7, pengguna.lobster += mcgh8, pengguna.hiu += mcgh9,
                pengguna.udang += mcgh10, pengguna.ikan += mcgh11, pengguna.orca += mcgh12,
          ...
          if (pengguna.pancingan > 4)
            if (pengguna.umpan > 249) {
              ...
              pengguna.paus += mcghe1, pengguna.kepiting += mcghe2, pengguna.gurita += mcghe3,
                pengguna.cumi += mcghe4, pengguna.buntal += mcghe5, pengguna.dory += mcghe6,
                pengguna.lumba += mcghe7, pengguna.lobster += mcghe8, pengguna.hiu += mcghe9,
                pengguna.udang += mcghe10, pengguna.ikan += mcghe11, pengguna.orca += mcghe12,
                pengguna.tiketcoin += 1, pengguna.umpan -= mcghe13, setTimeout(async () => {
