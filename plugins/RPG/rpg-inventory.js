      ...
      if (void 0 === db.data.users[who] && (db.data.users[who] = {
        ...
        let {
          ...
          lastmonthly
            ...
            .users[m.sender].apel), ayamg = db.data.users[m.sender].ayamg, ayamb = db.data.users[m.sender].ayamb, sapir = db.data.users[m.sender].sapir, ssapi = db.data.users[m.sender].ssapi, kayu = db.data.users[m.sender].kayu, string = db.data.users[m.sender].string, emas = db.data.users[m.sender].emas, besi = db.data.users[m.sender].iron, batu = db.data.users[m.sender].batu, sapi = db.data.users[m.sender].sapi, ayam = db.data.users[m.sender].ayam, babi = db.data.users[m.sender].babi, banteng = db.data.users[m.sender].banteng, pet = db.data.users[m.sender].pet, kucing = db.data.users[m.sender].kucing, _kucing = db.data.users[m.sender].anakkucing, rubah = db.data.users[m.sender].rubah, _rubah = db.data.users[m.sender].anakrubah, kuda = db.data.users[m.sender].kuda, _kuda = db.data.users[m.sender].anakkuda, serigala = db.data.users[m.sender].serigala, _serigala = db.data.users[m.sender].anakserigala, phonix = db.data.users[m.sender].phonix, _phonix = db.data.users[m.sender]
          .anakphonix, griffin = db.data.users[m.sender].griffin, _griffin = db.data.users[m.sender].anakgriffin, centaur = (db.data.users[m.sender].kyubi, db.data.users[m.sender].anakkyubi, db.data.users[m.sender].centaur), _centaur = db.data.users[m.sender].anakcentaur, naga = db.data.users[m.sender].naga, _naga = db.data.users[m.sender].anaknaga, diamond = db.data.users[m.sender].diamond, potion = db.data.users[m.sender].potion, common = db.data.users[m.sender].common, makananpet = db.data.users[m.sender].makananpet, uncommon = (db.data.users[m.sender].makanannaga, db.data.users[m.sender].makananphonix, db.data.users[m.sender].makanangriffin, db.data.users[m.sender].makanankyubi, db.data.users[m.sender].makanancentaur, db.data.users[m.sender].uncommon), mythic = db.data.users[m.sender].mythic, legendary = db.data.users[m.sender].legendary, level = db.data.users[m.sender].level, money = db.data.users[m.sender].money, exp = db.data.users[m.sender].exp, atm = db.data.users[m.sender]
          .atm, aqua = db.data.users[m.sender].aqua, pasangan = db.data.users[m.sender].pasangan, ramuan = db.data.users[m.sender].ramuan, kaleng = db.data.users[m.sender].kaleng, kardus = db.data.users[m.sender].kardus, arlok = (db.data.users[m.sender].botol, db.data.users[m.sender].arlok), limit = db.data.users[m.sender].limit, sampah = (db.data.users[m.sender].glimit, db.data.users[m.sender].sampah), anggur = db.data.users[m.sender].anggur, jeruk = db.data.users[m.sender].jeruk, mangga = db.data.users[m.sender].mangga, pisang = db.data.users[m.sender].pisang, bibitanggur = db.data.users[m.sender].bibitanggur, bibitjeruk = db.data.users[m.sender].bibitjeruk, bibitapel = db.data.users[m.sender].bibitapel, bibitmangga = db.data.users[m.sender].bibitmangga, bibitpisang = db.data.users[m.sender].bibitpisang, {
            max
          } = xpRange(level, exp, multiplier), sortedmoney = Object.entries(db.data.users).sort((a, b) => b[1].money - a[1].money), sortedgold = Object.entries(db.data.users).sort((a, b) => b[1].gold - a[1].gold), sortedarlok = Object.entries(db.data.users).sort((a, b) => b[1].arlok - a[1].arlok), sortedlevel = Object.entries(db.data.users).sort((a, b) => b[1].level - a[1].level), sorteddiamond = Object.entries(db.data.users).sort((a, b) => b[1].diamond - a[1].diamond), sortedpotion = Object.entries(db.data.users).sort((a, b) => b[1].potion - a[1].potion), sortedsampah = Object.entries(db.data.users).sort((a, b) => b[1].sampah - a[1].sampah), sortedcommon = Object.entries(db.data.users).sort((a, b) => b[1].common - a[1].common), sorteduncommon = Object.entries(db.data.users).sort((a, b) => b[1].uncommon - a[1].uncommon), sortedmythic = Object.entries(db.data.users).sort((a, b) => b[1].mythic - a[1].mythic), sortedlegendary = Object.entries(db.data.users).sort((a, b) => b[1]
            .legendary - a[1].legendary), usersmoney = sortedmoney.map(v => v[0]), usersgold = sortedgold.map(v => v[0]), usersarlok = sortedarlok.map(v => v[0]), usersdiamond = sorteddiamond.map(v => v[0]), userspotion = sortedpotion.map(v => v[0]), userssampah = sortedsampah.map(v => v[0]), userslevel = sortedlevel.map(v => v[0]), userscommon = sortedcommon.map(v => v[0]), usersuncommon = sorteduncommon.map(v => v[0]), usersmythic = sortedmythic.map(v => v[0]), userslegendary = sortedlegendary.map(v => v[0]), kambing = db.data.users[m.sender].kambing, kerbau = db.data.users[m.sender].kerbau, harimau = db.data.users[m.sender].harimau, monyet = db.data.users[m.sender].monyet, babihutan = db.data.users[m.sender].babihutan, panda = db.data.users[m.sender].panda, gajah = db.data.users[m.sender].gajah, buaya = db.data.users[m.sender].buaya, paus = db.data.users[m.sender].paus, kepiting = db.data.users[m.sender].kepiting, gurita = db.data.users[m.sender].gurita, cumi = db.data.users[m
            .sender].cumi, lumba = db.data.users[m.sender].lumba, lobster = db.data.users[m.sender].lobster, hiu = db.data.users[m.sender].hiu, udang = db.data.users[m.sender].udang, orca = db.data.users[m.sender].orca, str = (PhoneNumber("+" + pasangan.replace("@s.whatsapp.net", "")).getNumber("international"),
