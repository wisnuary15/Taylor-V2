    ...
    if (/craft|Crafting/i.test(command)) {
      ...
      switch (type) {
        case "pickaxe":
          ...
          user.wood -= 10, user.iron -= 5, user.rock -= 5, user.string -= 20,
            user.pickaxe += 1, user.pickaxedurability = 40, m.reply("Sukses membuat 1 pickaxe 🔨");
          break;
        case "sword":
          ...
          user.wood -= 10, user.iron -= 15, user.sword += 1, user.sworddurability = 40,
        ...
        case "fishingrod":
          ...
          user.wood -= 10, user.iron -= 2, user.string -= 20, user.fishingrod += 1,
            user.fishingroddurability = 40, m.reply("Sukses membuat 1 Pancingan 🎣");
          break;
        case "armor":
          ...
          user.emerald -= 1, user.iron -= 30, user.diamond -= 5, user.armor += 1,
            user.armordurability = 50, m.reply("Sukses membuat 1 Armor 🛡️");
          break;
        case "atm":
          ...
          user.emerald -= 3, user.money -= 1e4, user.diamond -= 6, user.atm += 1,
            user.fullatm = 5e6, m.reply("Sukses membuat 1 Atm 💳");
          break;
        case "robo":
          if (user.atm > 0) return m.reply("Kamu sudah memilik ini");
          if (user.emerald < 6 || user.money < 1e5 || user.diamond < 12) return m.reply("Barang tidak cukup!\nUntuk membuat atm. Kamu memerlukan :\n100k Money 💹\n6 Emerald ❇️\n12 Diamond 💎");
          user.emerald -= 6, user.money -= 1e5, user.diamond -= 12, user.robo += 1,
            user.roboxp = 5, m.reply("Sukses membuat 1 Robo 🤖");
          break;
        default:
