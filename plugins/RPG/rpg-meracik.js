        ...
        if (db.data.users[m.sender].kayu > 499)
          if (db.data.users[m.sender].string > 4)
            if (db.data.users[m.sender].batu > 9) {
              db.data.users[m.sender].kayu -= 500, db.data.users[m.sender].string -= 5,
                db.data.users[m.sender].batu -= 10, db.data.users[m.sender].anakpancingan += 150,
                db.data.users[m.sender].lastsmancingclaim = 1 * new Date();
