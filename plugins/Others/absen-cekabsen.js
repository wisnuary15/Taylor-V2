const handler = async (m, {
  ...
  let id = m.chat;
  db.data.database.absen = db.data.database.absen ? db.data.database.absen : {}, id in db.data.database.absen || await conn.sendButton(m.chat, `_*Tidak ada absen berlangsung digrup ini!*_\n\n*${usedPrefix}mulaiabsen* - untuk memulai absen`, author, null, [
  ...
  let date = new Date().toLocaleDateString("id", {
    ...
    absen = db.data.database.absen[id][1],
