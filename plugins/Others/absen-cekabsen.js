const handler = async (m, {
  ...
  try {
    ...
    if (!(id in absenData)) {
      return await conn.sendButton(m.chat, `_*Tidak ada absen berlangsung di grup ini!*_\n\n*${usedPrefix}mulaiabsen* - untuk memulai absen`, author, null, [
    ...
    console.error(error);
    await conn.sendButton(m.chat, `_*Terjadi kesalahan saat memproses absen.*_`, author, null, [
