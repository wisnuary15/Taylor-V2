const handler = async (m, {
  ...
  try {
    ...
    db.data.database.afk[m.chat] = db.data.database.afk[m.chat] ? db.data.database.afk[m.chat].some(user => user.id === id) ? db.data.database.afk[m.chat] : [...db.data.database.afk[m.chat], {
      username: username,
      id: id
    }] : [{
      username: username,
