...
const handler = async (m, {
  ...
  if ("towebp" === command) {
    ...
    let img = await q?.download(),
      ...
      res = `https://api.lolhuman.xyz/api/convert/towebp?apikey=${lolkey}&img=${url}`;
  ...
  if ("towebpr" === command) {
    ...
    let img = await q?.download(),
      url = await uploadImage(img),
      res = `https://api.lolhuman.xyz/api/convert/towebpwround?apikey=${lolkey}&img=${url}`;
    await conn.sendFile(m.chat, res, "out.webp", m, !1, {
      mimetype: "image/webp",
      thumbnail: Buffer.alloc(0)
    });
  ...
  if ("webptogif" === command) {
    ...
    if (!((q.msg || q).mimetype || "")) throw `balas gambar dengan perintah\n\n${usedPrefix + command}`;
    let img = await q?.download(),
      res = `https://api.lolhuman.xyz/api/convert/webptogif?apikey=${lolkey}&img=${img}`;
  ...
  if ("webptomp4" === command) {
    ...
    if (!((q.msg || q).mimetype || "")) throw `balas gambar dengan perintah\n\n${usedPrefix + command}`;
    let img = await q?.download(),
      res = `https://api.lolhuman.xyz/api/convert/webptomp4?apikey=${lolkey}&img=${img}`;
  ...
  if ("topng" === command) {
    ...
    if (!((q.msg || q).mimetype || "")) throw `balas gambar dengan perintah\n\n${usedPrefix + command}`;
    let img = await q?.download(),
      res = `https://api.lolhuman.xyz/api/convert/topng?apikey=${lolkey}&img=${img}`;
  ...
  if ("tobase64" === command) {
    ...
    if (!((q.msg || q).mimetype || "")) throw `balas gambar dengan perintah\n\n${usedPrefix + command}`;
    let img = await q?.download(),
      res = `https://api.lolhuman.xyz/api/filetobase64?apikey=${lolkey}&file=${img}`;
  ...
  if ("filetourl" === command) {
    ...
    if (!((q.msg || q).mimetype || "")) throw `balas gambar dengan perintah\n\n${usedPrefix + command}`;
    let img = await q?.download(),
      res = await fetch(`https://api.lolhuman.xyz/api/filetourl?apikey=${lolkey}&file=${img}`),
  ...
  if ("emojimix3" === command) {
    ...
    let urut = text.split`+`,
      res = `https://api.lolhuman.xyz/api/emojimix/${urut[0]}+${urut[1]}?apikey=${lolkey}`,
