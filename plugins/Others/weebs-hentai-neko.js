...
const handler = async (m, { conn: conn, command: command, args: args, usedPrefix: usedPrefix, DevMode: DevMode }) => {
  ...
  let type = (args[0] || "").toLowerCase(),
    ...
    apil = `?apikey=${lolkey}`,
    xres = "https://api.xteam.xyz/randomimage/",
    xapi = "?APIKEY=NezukoTachibana281207",
    ass = !0 !== ch,
    blowjob = !0 !== ch,
    cums = !0 !== ch,
    ecchi = !0 !== ch,
  ...
  try {
    if (/(nsfw)/i.test(command)) {
      ...
      switch (type) {
        case "ahegao":
          0, await conn.sendFile(m.chat, await (await fetch(xres + "ahegao" + xapi)).arrayBuffer(), m);
          break;
        case "anal":
          0, await conn.sendFile(m.chat, await (await fetch(resl + "anal" + apil)).arrayBuffer(), m);
          break;
        case "ass":
          if (!0 === ass && db.data.users[m.sender].premiumTime < 1) return await conn.reply(m.chat, txtprem, m);
          await conn.sendFile(m.chat, await (await fetch(xres + "ass" + xapi)).arrayBuffer(), m);
          break;
        case "blowjob":
        ...
        case "ecchi":
          ...
          break;
        case "ero":
          0, await conn.sendFile(m.chat, await (await fetch(xres + "ero" + xapi)).arrayBuffer(), m);
          break;
        case "erofeet":
        ...
        case "girlsolo":
          ...
          break;
        case "hentai":
          if (!0 === hentai && db.data.users[m.sender].premiumTime < 1) return await conn.reply(m.chat, txtprem, m);
          await conn.sendFile(m.chat, await (await fetch(xres + "hentai" + xapi)).arrayBuffer(), m);
          break;
        case "holo":
          0, await conn.sendFile(m.chat, await (await fetch(res + "hololewd" + api)).arrayBuffer(), m);
          break;
        case "jahy":
          if (!0 === jahy && db.data.users[m.sender].premiumTime < 1) return await conn.reply(m.chat, txtprem, m);
          await conn.sendFile(m.chat, await (await fetch(xres + "jahy" + xapi)).arrayBuffer(), m);
          break;
        case "kitsune":
        ...
        case "loli":
          ...
          break;
        case "manga":
          if (!0 === manga && db.data.users[m.sender].premiumTime < 1) return await conn.reply(m.chat, txtprem, m);
          await conn.sendFile(m.chat, await (await fetch(xres + "manga" + xapi)).arrayBuffer(), m);
          break;
        case "milf":
          0, await conn.sendFile(m.chat, await (await fetch(res + "milf" + api)).arrayBuffer(), m);
          break;
        case "mstrb":
          0, await conn.sendFile(m.chat, await (await fetch(xres + "mstrb" + xapi)).arrayBuffer(), m);
          break;
        case "neko":
          0, await conn.sendFile(m.chat, await (await fetch(xres + "nsfwneko" + xapi)).arrayBuffer(), m);
          break;
        case "oppai":
          ...
          break;
        case "panties":
          0, await conn.sendFile(m.chat, await (await fetch(xres + "panties" + xapi)).arrayBuffer(), m);
          break;
        case "pussy":
          if (!0 === pussy && db.data.users[m.sender].premiumTime < 1) return await conn.reply(m.chat, txtprem, m);
          await conn.sendFile(m.chat, await (await fetch(xres + "pussy" + xapi)).arrayBuffer(), m);
          break;
        case "spank":
          ...
          break;
        case "tentacles":
          0, await conn.sendFile(m.chat, await (await fetch(xres + "tentacles" + xapi)).arrayBuffer(), m);
          break;
        case "tits":
          ...
          break;
        case "thighs":
          0, await conn.sendFile(m.chat, await (await fetch(xres + "thighs" + xapi)).arrayBuffer(), m);
          break;
        case "trap":
          ...
          break;
        case "uniform":
          0, await conn.sendFile(m.chat, await (await fetch(xres + "uniform" + xapi)).arrayBuffer(), m);
          break;
        case "waifu":
