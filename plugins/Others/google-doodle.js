...
const fetchDoodles = async (month, year) => (await fetch(`https://www.google.com/doodles/json/${year}/${month}`)).json(), handler = async (m, { conn: conn, usedPrefix: usedPrefix, args: args }) => {
