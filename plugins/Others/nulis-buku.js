  ...
  try {
    ...
    for (let i = 0; i < pages.length; i++) {
      ...
      const ffmpegArgs = [
        ...
        inputPath,
        '-vf',
        `drawtext=${drawtextDayArgs}:line_spacing=${lineSpacing},drawtext=${drawtextDateArgs}:line_spacing=${lineSpacing},drawtext=${drawtextPageArgs}:line_spacing=${lineSpacing},drawtext=${drawtextContentArgs}:line_spacing=${lineSpacing}`,
        '-q:v',
        '2',
        '-f',
        'image2pipe',
