...
💚️ *Direct URL:* ${preview_mp3}`
    conn.sendFile(m.chat, thumbnail, '', spotifyinfo, m)
    conn.sendFile(m.chat, preview_mp3, 'spotify.mp3', spotifyinfo, m)
  } catch (e) {
    try {
...
💚️ *Direct URL:* ${audio}`
      conn.sendFile(m.chat, thumbnail, '', spotifyinfo, m)
      conn.sendFile(m.chat, audio, 'spotify.mp3', spotifyinfo, m)
    } catch (e) {
      m.react(eror)
    }
  }
