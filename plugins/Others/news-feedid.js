...
`.trim()
        ...
        conn.sendFile(m.chat, news.thumbnail, 'antaranews.png', `${news.title}\n\nDeskripsi :\n${news.description}\n\nSelengkapnya :\n${news.link}`, m)
    }
    if (command === 'cnbc') {
...
`.trim()
        ...
        let news = Array[Math.floor(Math.random() * Array.length)]
        if (!news.thumbnail) throw `ERROR\nGagal Mengambil Berita`
        conn.sendFile(m.chat, news.thumbnail, 'cnbc.png', `${news.title}\n\nDeskripsi :\n${news.description}\n\nSelengkapnya :\n${news.link}`, m)
    }
    if (command === 'cnn') {
...
`.trim()
        ...
        let news = Array[Math.floor(Math.random() * Array.length)]
        if (!news.thumbnail) throw `ERROR\nGagal Mengambil Berita`
        conn.sendFile(m.chat, news.thumbnail, 'cnn.png', `${news.title}\n\nDeskripsi :\n${news.description}\n\nSelengkapnya :\n${news.link}`, m)
    }
    if (command === 'jpnn') {
        ...
        let news = Array[Math.floor(Math.random() * Array.length)]
        if (!news.thumbnail) throw `ERROR\nGagal Mengambil Berita`
        conn.sendFile(m.chat, news.thumbnail, 'JPNN.png', `${news.title}\n\nDeskripsi :\n${news.description}\n\nSelengkapnya :\n${news.link}`, m)
    }
    if (command === 'kumparan') {
        ...
        let news = Array[Math.floor(Math.random() * Array.length)]
        if (!news.thumbnail) throw `ERROR\nGagal Mengambil Berita`
        conn.sendFile(m.chat, news.thumbnail, 'kumparan.png', `${news.title}\n\nDeskripsi :\n${news.description}\n\nSelengkapnya :\n${news.link}`, m)
    }
    if (command === 'merdeka') {
...
`.trim()
        ...
        let news = Array[Math.floor(Math.random() * Array.length)]
        if (!news.thumbnail) throw `ERROR\nGagal Mengambil Berita`
        conn.sendFile(m.chat, news.thumbnail, 'merdekadotcom.png', `${news.title}\n\nDeskripsi :\n${news.description}\n\nSelengkapnya :\n${news.link}`, m)
    }
    if (command === 'okezone') {
...
`.trim()
        ...
        let news = Array[Math.floor(Math.random() * Array.length)]
        if (!news.thumbnail) throw `ERROR\nGagal Mengambil Berita`
        conn.sendFile(m.chat, news.thumbnail, 'okezonedotcom.png', `${news.title}\n\nDeskripsi :\n${news.description}\n\nSelengkapnya :\n${news.link}`, m)
    }
...
`.trim()
        ...
        let news = Array[Math.floor(Math.random() * Array.length)]
        if (!news.thumbnail) throw `ERROR\nGagal Mengambil Berita`
        conn.sendFile(m.chat, news.thumbnail, 'republikadotcom.png', `${news.title}\n\nDeskripsi :\n${news.description}\n\nSelengkapnya :\n${news.link}`, m)
    }
    if (command === 'sindo') {
...
`.trim()
        ...
        let news = Array[Math.floor(Math.random() * Array.length)]
        if (!news.thumbnail) throw `ERROR\nGagal Mengambil Berita`
        conn.sendFile(m.chat, news.thumbnail, 'sindonews.png', `${news.title}\n\nDeskripsi :\n${news.description}\n\nSelengkapnya :\n${news.link}`, m)
    }
    if (command === 'suara') {
...
`.trim()
        ...
        let news = Array[Math.floor(Math.random() * Array.length)]
        if (!news.thumbnail) throw `ERROR\nGagal Mengambil Berita`
        conn.sendFile(m.chat, news.thumbnail, 'suaradotcom.png', `${news.title}\n\nDeskripsi :\n${news.description}\n\nSelengkapnya :\n${news.link}`, m)
    }
...
`.trim()
        ...
        let news = Array[Math.floor(Math.random() * Array.length)]
        if (!news.thumbnail) throw `ERROR\nGagal Mengambil Berita`
        conn.sendFile(m.chat, news.thumbnail, 'tempo.png', `${news.title}\n\nDeskripsi :\n${news.description}\n\nSelengkapnya :\n${news.link}`, m)
    }
...
`.trim()
        ...
        let news = Array[Math.floor(Math.random() * Array.length)]
        if (!news.thumbnail) throw `ERROR\nGagal Mengambil Berita`
        conn.sendFile(m.chat, news.thumbnail, 'tribun.png', `${news.title}\n\nDeskripsi :\n${news.description}\n\nSelengkapnya :\n${news.link}`, m)
    }
}
handler.tags = ['news']
