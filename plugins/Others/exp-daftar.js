...
const handler = async (m, {
  ...
  if (conn.registrasi[m.chat]) return conn.reply(m.chat, 'Anda masih berada dalam sesi Registrasi', conn.registrasi[
    m.chat].msg);
  ...
  try {
    ...
    let who = m.mentionedJid && m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted?.sender : m.fromMe ?
