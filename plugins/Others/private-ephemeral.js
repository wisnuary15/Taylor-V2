...
const { WA_DEFAULT_EPHEMERAL: WA_DEFAULT_EPHEMERAL } = pkg, options = {
...
function formatJid(input) {
  return (input = input.replace(/[^0-9]/g, "")).startsWith("0") ? "62" + input.substring(1) + "@s.whatsapp.net" : input.startsWith("+62") ? "62" + input.substring(3) + "@s.whatsapp.net" : (input.startsWith("62"),
