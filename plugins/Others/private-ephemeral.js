...
const handler = async (m, {
  ...
  if (selectedOption !== undefined) {
    ...
    const response = selectedOption === 0 ? 'dimatikan' : selectedOption === WA_DEFAULT_EPHEMERAL ? 'diaktifkan' :
      `disetel untuk *${lowercaseText}*`;
