...
const handler = async (m, {
  ...
  let manga = ["managreader", "mangadex", "mangahere", "mangakakalot", "mangapark", "mangapill", "mangasee123"]
  let meta = ["anilist-manga", "anilist", "mal", "tmdb"]
  let movies = ["dramacool", "flixhq", "viewasian"]
  let urut = text.split('|')
  let one = urut[0]
  let two = urut[1]
  let three = urut[2]
