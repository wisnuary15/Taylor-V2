...
const handler = async (m, {
  ...
  let stiker = await sticker(null, API(`${pickRandom(stikerhuuu)}`), packname, author)
  if (stiker) return conn.sendFile(m.chat, stiker, 'sticker.webp', '', m, null, {
    fileLength: fsizedoc,
    contextInfo: {
      externalAdReply: {
...
let stikerhuuu = ["https://telegra.ph/file/fa2bbea0f7de2575cf027.png", //patrick huu
