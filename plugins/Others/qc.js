...
const handler = async (m, { conn, text }) => {
    try {
        ...
        const mediaUrl = mime && allowed.includes(mime.split('/')[0]) 
        ...
        const replyMessage = q ? {
            ...
            photo: { url: await conn.profilePictureUrl(q.sender, 'image').catch(() => logo) },
        ...
        const message = {
            ...
            ...(mediaUrl && { media: { url: `https://wsrv.nl/?url=${mediaUrl}&output=png` } })
        };
