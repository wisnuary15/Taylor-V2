const handler = async (m, {
  ...
  try {
    ...
    if (!text) throw `Uhm... teksnya mana? Gunakan: ${usedPrefix + command} test`;
    ...
    let _m = conn.serializeM(JSON.parse(JSON.stringify(msgs[text]), (_, v) => v !== null && typeof v === "object" && "type" in v && v.type === "Buffer" && "data" in v && Array.isArray(v.data) ? Buffer.from(v.data) : v));
...
handler.help = ["vn", "msg", "store", "video", "gif", "audio", "img", "sticker"].map(v => "get" + v + " <teks>");
