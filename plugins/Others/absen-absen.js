const handler = async (m, {
  ...
  let id = m.chat;
  if (db.data.database.absen = db.data.database.absen ? db.data.database.absen : {}, !(id in db.data.database.absen)) return await conn.sendButton(m.chat, "Tidak ada absen berlangsung!", author, null, [
