const handler = async (m, {
  ...
  switch (command = command.toLowerCase(), conn.menfes = conn.menfes ? conn.menfes : {}, command) {
    case "menfesleave": {
      ...
      if (other && await conn.reply(other, room.b + " *Meninggalkan chat*", null), delete conn.menfes[room.id], "menfesleave" === command) break;
    }
    case "menfesstart": {
