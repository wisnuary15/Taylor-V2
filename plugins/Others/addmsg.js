...
const handler = async (m, {
  ...
  try {
    ...
    let quotedMsg = await m.getQuotedObj() || await m.getQuotedMessage() || m.quoted?.vM;
    if (!quotedMsg.message) return m.reply("Pesan yang dibalas tidak memiliki konten yang bisa disimpan.");
