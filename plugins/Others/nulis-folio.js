...
const settings = {
  bl: {
    date: { x: '(w-text_w-180)', y: 88, lineSpacing: 6, fontSize: 25 },
    day: { x: '(w-text_w-180)', y: 60, lineSpacing: 6, fontSize: 25 },
    page: { x: 70, y: 120, lineSpacing: 6, fontSize: 25 },
    content: { x: 155, y: 172, lineSpacing: 6, fontSize: 23, maxCharsPerLine: 85, maxLines: 40 }
  },
  br: {
    date: { x: '(w-text_w-155)', y: 88, lineSpacing: 6, fontSize: 25 },
    day: { x: '(w-text_w-155)', y: 60, lineSpacing: 6, fontSize: 25 },
    page: { x: 90, y: 120, lineSpacing: 6, fontSize: 25 },
    content: { x: 155, y: 172, lineSpacing: 6, fontSize: 23, maxCharsPerLine: 78, maxLines: 40 }
  }
};
