const handler = async (m, { args: args, usedPrefix: usedPrefix, text: text, command: command }) => {
  ...
  try {
    let { total: total, success: success, last: last, lastSuccess: lastSuccess } = db.data.stats[text + ".js"];
