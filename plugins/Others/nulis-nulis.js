...
const inputPathL = path.resolve('src/kertas/buku/bl.jpg');
const inputPathR = path.resolve('src/kertas/buku/br.jpg');

const settings = {
  bl: {
    date: { x: '(w-text_w-180)', y: 68, lineSpacing: 3, fontSize: 25 },
    day: { x: '(w-text_w-180)', y: 40, lineSpacing: 3, fontSize: 25 },
    page: { x: 40, y: 88, lineSpacing: 3, fontSize: 25 },
    content: { x: 147, y: 133, lineSpacing: 3, fontSize: 23, maxCharsPerLine: 68, maxLines: 31 }
  },
  br: {
    date: { x: '(w-text_w-155)', y: 42, lineSpacing: 3, fontSize: 25 },
    day: { x: '(w-text_w-155)', y: 12, lineSpacing: 3, fontSize: 25 },
    page: { x: 60, y: 70, lineSpacing: 3, fontSize: 25 },
    content: { x: 140, y: 105, lineSpacing: 5, fontSize: 23, maxCharsPerLine: 68, maxLines: 31 }
  }
};
