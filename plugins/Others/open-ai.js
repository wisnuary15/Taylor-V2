...
const handler = async (m, {
  ...
  try {
    ...
    const result = await Widipe(encodedText) || await AryaGpt(encodedText) || await RnsChat(encodedText) || await CleanDx(encodedText) || await GoodyApi(encodedText) || await RapidGpt(encodedText);
