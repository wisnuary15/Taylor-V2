...
const handler = async (m, { text: text }) => {
...
export async function chord(query) {
  return new Promise((async (resolve, reject) => {
    ...
    let { data: data } = await axios.get("http://app.chordindonesia.com/?json=get_search_results&exclude=date,modified,attachments,comment_count,comment_status,thumbnail,thumbnail_images,author,excerpt,content,categories,tags,comments,custom_fields&search=" + query, {
      headers: head
    });
