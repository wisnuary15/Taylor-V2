...
${usedPrefix + command} black cover`;
        ...
        const vn = await fetch(global.API('btchx', '/api/search/ringtone', {
            text: text
        }, 'apikey'));
        ...
        conn.sendMessage(m.chat, `📺 Ringtone Search 🔎\n⚡ Silakan pilih Ringtone Search di bawah ini...\n\n*Teks yang anda kirim:* ${text}\n\nKetik ulang *${usedPrefix + command}* teks anda untuk mengubah teks lagi`, 'conversation', {
            contextInfo: {
                mentionedJid: await conn.parseMention(listSections)
            },
            quoted: m
        });
