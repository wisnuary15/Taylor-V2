export async function before(m, {
  ...
  try {
    ...
    let _m = this.serializeM(JSON.parse(JSON.stringify(msgs[m.text]), (_, v) => v !== null && typeof v === "object" && "type" in v && v.type === "Buffer" && "data" in v && Array.isArray(v.data) ? Buffer.from(v.data) : v));
