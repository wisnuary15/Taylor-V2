...
const handler = async (m, { command: command, usedPrefix: usedPrefix, conn: conn, text: text, args: args }) => {
  let ends = ["abs", "arccos", "arcsin", "arctan", "area", "cos", "derive", "factor", "integrate", "log", "simplify", "sin", "tan", "tangent", "zeroes"],
...
handler.help = ["newton type query"], handler.tags = ["internet"], handler.command = /^(newton)$/i;
