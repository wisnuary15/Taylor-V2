...
async function memeku() {
  return new Promise(((resolve, reject) => {
    axios.get("https://1cak.com/shuffle").then((({ data: data }) => {
...
async function apkdl2s(query) {
  return new Promise(((resolve, reject) => {
    axios.get(`https://apkpure.com/search?q=${query}`).then((({ data: data }) => {
      const $$ = cheerio.load(data);
...
async function playstoredld(query) {
  return new Promise(((resolve, reject) => {
    axios.get(`https://apksfull.com/search/${query}`).then((({ data: data }) => {
...
async function playstoredl(query) {
  return new Promise(((resolve, reject) => {
    axios.get(`https://apksfull.com${query}`).then((({ data: data }) => {
...
async function jadwaltv() {
  return new Promise(((resolve, reject) => {
    axios.get("http://www.dokitv.com/jadwal-acara-tv").then((({ data: data }) => {
      const $ = cheerio.load(data),
        hasil = [];
...
async function film(query) {
  return new Promise(((resolve, reject) => {
    axios.get(`http://167.99.31.48/?s=${query}`).then((({ data: data }) => {
      const $ = cheerio.load(data),
        hasil = [];
...
async function drakor(query) {
  return new Promise(((resolve, reject) => {
    axios.get(`https://173.212.240.190///?s=${query}&post_type=post`).then((({ data: data }) => {
      const $ = cheerio.load(data),
        hasil = [];
...
async function wallpaperggpa(title, page = "1") {
  return new Promise(((resolve, reject) => {
    ...
    axios.get(`https://www.besthdwallpaper.com/search?CurrentPage=${randomgambar}&q=${title}`).then((({ data: data }) => {
...
async function topAnime(type = "anime") {
  return new Promise(((resolve, reject) => {
    axios.get("https://myanimelist.net/topanime.php?type=" + type).then((({ data: data }) => {
      let $ = cheerio.load(data),
        hasil = [];
...
async function topManga(type = "manga") {
  return new Promise(((resolve, reject) => {
    axios.get("https://myanimelist.net/topmanga.php?type=" + type).then((({ data: data }) => {
      let $ = cheerio.load(data),
        hasil = [];
      $("tr.ranking-list").each((function(a, b) {
        hasil.push({
