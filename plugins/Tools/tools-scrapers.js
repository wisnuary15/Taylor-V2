    ...
    return sc.contents.twoColumnSearchResultsRenderer.primaryContents.sectionListRenderer.contents[0]?.itemSectionRenderer.contents.forEach((v => {
      ...
      if ("videoRenderer" === typeName) {
        ...
        null === (_h = (null == duration ? void 0 : duration.split(".").length) && -1 === duration.indexOf(":") ? duration.split(".") : null == duration ? void 0 : duration.split(":")) || void 0 === _h || _h.forEach(((v, i, arr) => durationS += durationMultipliers[arr.length]["" + i] * parseInt(v))),
          results.video.push({
            ...
            authorAvatar: null === (_p = null === (_o = null === (_m = result.channelThumbnailSupportedRenderers) || void 0 === _m ? void 0 : _m.channelThumbnailWithLinkRenderer.thumbnail.thumbnails) || void 0 === _o ? void 0 : _o.filter((({ url: url }) => url))) || void 0 === _p ? void 0 : _p.pop().url,
            videoId: videoId,
            ...
            description: null === (_y = null === (_x = null === (_w = null === (_v = null === (_u = result.detailedMetadataSnippets) || void 0 === _u ? void 0 : _u[0]) || void 0 === _v ? void 0 : _v.snippetText.runs) || void 0 === _w ? void 0 : _w.filter((({ text: text }) => text))) || void 0 === _x ? void 0 : _x.map((({ text: text }) => text))) || void 0 === _y ? void 0 : _y.join(""),
      ...
      if (isChannel) {
        ...
        results.channel.push({
          ...
          avatar: "https:" + (null === (_6 = result.thumbnail.thumbnails.filter((({ url: url }) => url))) || void 0 === _6 ? void 0 : _6.pop().url),
          isVerified: "BADGE_STYLE_TYPE_VERIFIED" === (null === (_7 = result.ownerBadges) || void 0 === _7 ? void 0 : _7.pop().metadataBadgeRenderer.style),
          description: null === (_13 = null === (_12 = null === (_11 = null === (_10 = result.descriptionSnippet) || void 0 === _10 ? void 0 : _10.runs) || void 0 === _11 ? void 0 : _11.filter((({ text: text }) => text))) || void 0 === _12 ? void 0 : _12.map((({ text: text }) => text))) || void 0 === _13 ? void 0 : _13.join(""),
          type: typeName.replace(/Renderer/i, "")
        });
      }
      isMix && results.playlist.push({
        ...
        thumbnail: result.thumbnail.thumbnails.pop().url,
        video: result.videos.map((({ childVideoRenderer: childVideoRenderer }) => ({
...
async function googleImage(query) {
  try {
    ...
    return {
      status: !0,
      result: [...matches].map((({ groups: groups }) => decodeUrl(null == groups ? void 0 : groups.url))).filter((v => /.*\.jpe?g|png$/gi.test(v)))
    };
  } catch (e) {
    return {
      status: !1,
...
async function artiNama(nama) {
  return new Promise(((resolve, reject) => {
    axios.get(`https://www.primbon.com/arti_nama.php?nama1=${nama}&proses=+Submit%21+`).then((({ data: data }) => {
...
async function tafsirMimpi(mimpi) {
  return new Promise(((resolve, reject) => {
    axios.get(`https://www.primbon.com/tafsir_mimpi.php?mimpi=${mimpi}&submit=+Submit+`).then((({ data: data }) => {
...
async function Jodoh(nama1, nama2) {
  return new Promise(((resolve, reject) => {
    axios.get(`https://www.primbon.com/kecocokan_nama_pasangan.php?nama1=${nama1}&nama2=${nama2}&proses=+Submit%21+`).then((({ data: data }) => {
      const $ = cheerio.load(data),
...
async function tanggaljadi(tanggal) {
  return new Promise(((resolve, reject) => {
    ...
    axios.get(`https://www.primbon.com/tanggal_jadian_pernikahan.php?tgl=${tgl}&bln=${bln}&thn=${thn}&proses=+Submit%21+`).then((({ data: data }) => {
...
async function watakartis(nama, tanggal) {
  return new Promise(((resolve, reject) => {
    const tgl = Tanggal(tanggal).tanggal,
      bln = Tanggal(tanggal).bulan,
      thn = Tanggal(tanggal).tahun;
    axios.get(`https://www.primbon.com/selebriti.php?nama=${nama}&tgl=${tgl}&bln=${bln}&thn=${thn}&submit=submit#`).then((({ data: data }) => {
