...
const { js: js, css: css, html: html, js_beautify: js_beautify, css_beautify: css_beautify, html_beautify: html_beautify } = jsbeautify, handler = async (m, { args: args, command: command, usedPrefix: usedPrefix }) => {
