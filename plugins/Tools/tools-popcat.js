...
const handler = async (m, {
  ...
  try {
    let mediaUrl = "";
    let mime = "";
    if (["ad", "popblur", "clown", "colorify", "communism", "drip", "greyscale", "gun", "invert", "jail", "jokeoverhead", "mnm", "nokia", "opinion", "poppet", "popquote", "uncover", "wanted"].includes(command)) {
      const q = m.quoted || m;
      mime = q.mimetype || "";
      if (!/image/.test(mime)) {
        return conn.reply(m.chat, `🚫 *Invalid Input* \nPlease send or reply with an image and use the command *.${command}*`, m);
      }
    ...
    console.error(e);
    conn.reply(m.chat, "⚠️ *Error* \nAn unexpected error occurred. Please try again later.", m);
  }
};
handler.tags = ["tools"];
handler.command = handler.help = ["ad", "alert", "biden", "popblur", "car", "caution", "chatbot", "clown", "color", "colorify", "communism", "decode", "doublestruck", "drake", "drip", "eightball", "encode", "popfact", "popfacts", "popgithub", "greyscale", "gun", "hue", "imdb", "invert", "popitunes", "jail", "popjoke", "jokeoverhead", "lulcat", "poplyrics", "popmeme", "mnm", "mock", "nokia", "popnpm", "oogway", "opinion", "periodic", "periodicElement", "poppet", "pickuplines", "pikachu", "pooh", "popquote", "randomcolor", "popreverse", "sadcat", "popscreenshot", "ship", "showerthoughts", "popsteam", "popsubreddit", "texttomorse", "translate", "uncover", "unforgivable", "wanted", "weather", "welcomecard", "whowouldwin", "wyr"];
