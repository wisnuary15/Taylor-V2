...
const handler = async (m, {
  ...
  if (!text) return await conn.reply(m.chat, "Masukkan key yang ingin di-check, pisahkan dengan koma.", m);
  ...
  const message = results.length > 0 ? `Hasil warp:\n\n${formattedResults}` : "Tidak ada data yang ditemukan untuk key yang diberikan.";
