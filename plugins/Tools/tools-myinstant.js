...
const handler = async (m, {
  ...
  try {
    ...
    const results = await (text.toLowerCase() === "home" ? myInstant.home() : text.toLowerCase() === "best" ? myInstant.best() : text.toLowerCase() === "recent" ? myInstant.recent() : text.toLowerCase() === "category" ? myInstant.category(args[1]) : text.toLowerCase() === "new" ? myInstant.new() : text.toLowerCase() === "fav" ? myInstant.fav() : myInstant.search(text));
