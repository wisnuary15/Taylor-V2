...
const handler = async (m, {
  ...
  try {
    ...
    switch (feature) {
      case "v1":
        res =
          `https://shot.screenshotapi.net/screenshot?token=WCCYKR0-X5CMMV0-JB4G5Z5-P6SPC8R&url=${LinkReg}&full_page=true&fresh=true&output=image&file_type=jpg`;
        break;
      case "v2":
      ...
      case "v3":
        res =
          `https://api.apiflash.com/v1/urltoimage?access_key=7eea5c14db5041ecb528f68062a7ab5d&wait_until=page_loaded&url=${LinkReg}`;
        break;
      case "v4":
