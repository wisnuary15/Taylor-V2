...
const handler = async (m, {
  ...
  const service = services.find(s => s.key.toLowerCase() === version.toLowerCase());
  ...
  try {
    ...
    const isBase64 = typeof imgResult === "string" && imgResult.startsWith("data:image");
    if (isBuffer) {
