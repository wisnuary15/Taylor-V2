...
const handler = async (m, {
  ...
  if (!/image\/(jpe?g|png)/.test(mime)) return conn.reply(m.chat, 'Mohon kirim gambar dengan format JPEG atau PNG.',
    m);
  ...
  try {
    ...
    conn.reply(m.chat, 'Terjadi kesalahan dalam membaca QR code', m);
  }
};
