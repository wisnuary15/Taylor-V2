...
const handler = async (m, {
  ...
  try {
    ...
    const selectedVoice = selectedVoiceIndex !== null && !isNaN(selectedVoiceIndex) && [...VOICES.keys()][selectedVoiceIndex] ? [...VOICES.keys()][selectedVoiceIndex] : "id-ID-ArdiNeural";
    ...
    if (/image/.test(mime)) {
      ...
      const text = cleanText || m.quoted?.text || m.quoted?.caption || m.quoted?.description || null;
      if (!text) {
