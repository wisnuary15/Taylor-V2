...
const handler = async (m, { command: command, text: text }) => {
  try {
    const url = {
...
handler.help = ["npmsearch"], handler.tags = ["tools"], handler.command = /^(npmjs|cdnjs|jsdelivr|unpkg|jsdelivrcdn|cloudflare|rawgit|bootstrapcdn|google|jquerycdn|fontawesome|fontcdn)$/i;
